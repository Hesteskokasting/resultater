...
think in "runder" (rounds) of 5 omganger each — e.g. Minimatch's 15 omganger are 3 runder of 5. The UI needs a per-round breakdown: `PlayerName · r1 · r2 · r3 · total`.
...
blocks of 5 (only the _number_ of rounds varies: 3/5/10). A stored column that must always
