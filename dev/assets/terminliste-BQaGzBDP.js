import{t as e}from"./logError-DFCPgUum.js";import{r as t}from"./authService-BZ3tHKr-.js";import{$ as n,L as r,O as i,Q as a,et as o,i as s,n as c,nt as l,ot as u,z as d}from"./index-DUX4qgVd.js";import{t as f}from"./LoadingState-Ps7fTB_T.js";import{t as p}from"./buildDropdownOptions-3fHJtLsX.js";var m={column:`dato`,direction:`asc`};function h(e,t){switch(t){case`navn`:return e.navn??``;case`dato`:return e.dato??``;case`sted`:return e.sted??``;case`metode`:return[e.innledende?.navn,e.avsluttende?.navn].filter(e=>!!e).join(` `);case`organizer`:return e.klubb?.navn??``;case`type`:return e.stevnetype?.navn??``;case`klassifisering`:return e.kategori?.navn??``;default:return``}}function g(e){return[...e].sort((e,t)=>{let n=h(e,m.column),r=h(t,m.column),i=n.localeCompare(r,`nb`);return m.direction===`asc`?i:-i})}var _={year:new Date().getFullYear(),text:``,tournamentTypeId:``,throwingMethodId:``,clubId:``,categoryId:``},v=[],y=null,b=new Map;function x(e){return e.filter(e=>{if(_.text){let t=_.text.toLowerCase();if(![e.navn,e.sted,e.klubb?.navn,e.stevnetype?.navn,e.kategori?.navn,e.innledende?.navn,e.avsluttende?.navn].some(e=>e?.toLowerCase().includes(t)))return!1}if(_.tournamentTypeId&&String(e.stevnetype?.id)!==_.tournamentTypeId)return!1;if(_.throwingMethodId){let t=_.throwingMethodId;if(!(String(e.innledende?.id)===t||String(e.avsluttende?.id)===t))return!1}return!(_.clubId&&String(e.klubb?.id)!==_.clubId||_.categoryId&&String(e.kategori?.id)!==_.categoryId)})}async function S(e){await o(e.map(e=>({Dato:e.dato?new Date(e.dato).toLocaleDateString(`nb-NO`):``,Navn:e.navn??``,Sted:e.sted??``,Arrangør:e.klubb?.navn??``,Stevnetype:e.stevnetype?.navn??``,"Kastemetode (innledende)":e.innledende?.navn??``,"Kastemetode (avsluttende)":e.avsluttende?.navn??``,Kategori:e.kategori?.navn??``,NM:e.ernm?`Ja`:`Nei`,InnbydelseUrl:e.innbydelseurl??``})),`terminliste-${_.year}.xlsx`,`Terminliste`)}var C=[{id:`navn`,label:`Stevne`},{id:`dato`,label:`Dato`},{id:`sted`,label:`Sted`},{id:`metode`,label:`Metode`},{id:`organizer`,label:`Arrangør`},{id:`type`,label:`Type`},{id:`klassifisering`,label:`Klassifisering`}];function w(e){return m.column===e?m.direction===`asc`?`<span class="tl-sort-icon active">↑</span>`:`<span class="tl-sort-icon active">↓</span>`:`<span class="tl-sort-icon">↕</span>`}function T(e){let t=e.dato?new Date(e.dato+`T12:00:00`).toLocaleDateString(`nb-NO`):``,n=[e.innledende?.navn,e.avsluttende?.navn].filter(e=>!!e).join(` \\ `),r=e.ernm?`<span class="tl-nm-merke">NM</span> `:``,i=e.innbydelseurl?`<a href="${a(e.innbydelseurl)}" target="_blank" rel="noopener" class="tl-invitation-icon" title="Innbydelse">📄</a>`:``;return`<tr class="tl-tr">
  ...
  </tr></thead>`}${`<tbody>${g(e).map(T).join(``)}</tbody>`}</table>`}function D(e){return window.innerWidth>600?E(e):k(e)}function O(e){let t=l(e.dato),n=e.sted?`<p class="tl-detail">Sted: ${a(e.sted)}</p>`:``,r=e.klubb?`<p class="tl-detail">Arrangør: ${a(e.klubb.navn??``)}</p>`:``,i=e.stevnetype?`<p class="tl-detail">Type: ${a(e.stevnetype.navn??``)}</p>`:``,o=e.ernm?`<span class="tl-nm-merke">NM</span>`:``,s=e.innbydelseurl?`<a class="tl-invitation-link" href="${a(e.innbydelseurl)}" target="_blank" rel="noopener">Innbydelse 📄</a>`:``,c=e.resultaturl?`<a class="tournament-link" href="#/stevne/${e.id}/resultat">Vis resultat</a>`:``,u=e.dato&&new Date(e.dato+`T12:00:00`)>new Date,d=e.stevne_fase===null||e.stevne_fase===`ikke_startet`,f=y?.profil?.kobling_status===`godkjent`&&u&&d&&!e.erfullfort?`<span data-registration-slot="${e.id}"></span>`:``;return`
    <div class="tournament-card tl-kort">
      <a class="tl-name tl-name-link" href="#/stevne/${e.id}/resultat">${o}${a(e.navn??``)}</a>
      <p class="tournament-date">${t}</p>
      ${n}${r}${i}
      ${s}${c}${f}
    </div>
  `}function k(e){return e.length===0?`<p class="empty-state">Ingen stevner funnet med valgte filtre.</p>`:`<div class="tournament-list">${e.map(O).join(``)}</div>`}async function A(o){c(()=>A(o)),o.replaceChildren(f(`Laster terminliste…`));try{let[{data:c,error:l},{data:h},g]=await Promise.all([d(_.year),i(),t()]);if(y=g,b=g?.profil?.kasterid==null?new Map:await r(g.profil.kasterid),l){e(`terminliste.render`,l),o.replaceChildren(n(`Kunne ikkje laste terminliste.`));return}v=c??[];function C(e){return{year:`<select class="tl-select" id="tl-year${e}">${u(_.year,1983,new Date().getFullYear()+1)}</select>`,tournamentType:`<select class="tl-select" id="tl-tournamenttype${e}">${p(h.stevnetyper,_.tournamentTypeId,`Alle typer`)}</select>`,throwingMethod:`<select class="tl-select" id="tl-throwingmethod${e}">${p(h.kastemetoder,_.throwingMethodId,`Alle metoder`)}</select>`,organizer:`<select class="tl-select" id="tl-organizer${e}">${p(h.klubber,_.clubId,`Alle arrangører`)}</select>`,category:`<select class="tl-select" id="tl-category${e}">${p(h.kategorier,_.categoryId,`Alle kategorier`)}</select>`}}let w=C(``),T=C(`-mobil`);o.innerHTML=`
      <div class="terminliste">
        ...
        <div class="tl-filter-row">
          ${w.year}
          <input class="tl-input" id="tl-text" type="search" placeholder="Søk..." value="${a(_.text)}">
          ${w.tournamentType}
          ${w.throwingMethod}
          ${w.organizer}
          ${w.category}
        ...
        <div class="tl-mobile-row">
          <input class="tl-input" id="tl-text-mobile" type="search" placeholder="Søk..." value="${a(_.text)}">
    ...
    `;function E(){let e=x(v),t=o.querySelector(`.tl-list-container`);if(!t)return e;t.innerHTML=D(e);let n=o.querySelector(`.tl-count`);n&&(n.textContent=`${e.length} stevner`);let r=y?.profil?.kasterid,i=y?.user.id;return r!=null&&i&&s(t,r,i,b),e}if(E(),g?.profil&&(g.profil.role===`admin`||g.profil.role===`klubbadmin`)){let e=document.createElement(`div`);e.className=`mb-3 px-2 d-flex gap-2`,e.innerHTML=`<a href="#/stevne/ny" class="btn btn-sm btn-success">+ Nytt stevne</a>`,o.querySelector(`.terminliste`)?.prepend(e)}let O=o.querySelector(`.tl-list-container`),k=o.querySelector(`#tl-year`),A=o.querySelector(`#tl-text`),j=o.querySelector(`#tl-text-mobile`),M=o.querySelector(`#tl-tournamenttype`),N=o.querySelector(`#tl-throwingmethod`),P=o.querySelector(`#tl-organizer`),F=o.querySelector(`#tl-category`),I=o.querySelector(`#tl-excel-desktop`),L=o.querySelector(`#tl-excel-mobile`),R=o.querySelector(`#tl-filter-open`),z=o.querySelector(`#tl-sheet`),B=o.querySelector(`#tl-backdrop`),V=o.querySelector(`#tl-reset`),H=o.querySelector(`#tl-apply`),U=o.querySelector(`#tl-year-mobil`),W=o.querySelector(`#tl-tournamenttype-mobil`),G=o.querySelector(`#tl-throwingmethod-mobil`),K=o.querySelector(`#tl-organizer-mobil`),q=o.querySelector(`#tl-category-mobil`);O.addEventListener(`click`,e=>{let t=e.target.closest(`[data-column]`);if(!t)return;let n=t.dataset.column;m.column===n?m.direction=m.direction===`asc`?`desc`:`asc`:(m.column=n,m.direction=`asc`),E()});let J=null;function Y(){if(!o.querySelector(`.tl-list-container`)){window.removeEventListener(`resize`,Y);return}J!==null&&clearTimeout(J),J=setTimeout(E,200)}window.addEventListener(`resize`,Y);async function X(t){o.querySelector(`.tl-title`).textContent=`Terminliste ${_.year}`,o.querySelector(`.tl-list-container`).replaceChildren(f(`Laster...`));let{data:r,error:i}=await d(_.year);return i?(e(t,i),o.querySelector(`.tl-list-container`).replaceChildren(n(`Feil ved henting.`)),!1):(v=r??[],!0)}k.addEventListener(`change`,async()=>{_.year=Number(k.value),await X(`terminliste.yearChange`)&&E()}),A.addEventListener(`input`,()=>{_.text=A.value,E()}),j.addEventListener(`input`,()=>{_.text=j.value,A.value=j.value,E()}),M.addEventListener(`change`,()=>{_.tournamentTypeId=M.value,E()}),N.addEventListener(`change`,()=>{_.throwingMethodId=N.value,E()}),P.addEventListener(`change`,()=>{_.clubId=P.value,E()}),F.addEventListener(`change`,()=>{_.categoryId=F.value,E()});let Z=()=>S(x(v));I.addEventListener(`click`,Z),L.addEventListener(`click`,Z);function Q(){z.classList.add(`active`),B.classList.add(`active`)}function $(){z.classList.remove(`active`),B.classList.remove(`active`)}R.addEventListener(`click`,Q),B.addEventListener(`click`,$),V.addEventListener(`click`,()=>{_.text=``,_.tournamentTypeId=``,_.throwingMethodId=``,_.clubId=``,_.categoryId=``,W.value=``,G.value=``,K.value=``,q.value=``,j.value=``,A.value=``,E()}),H.addEventListener(`click`,async()=>{let e=Number(U.value),t=e!==_.year;_.year=e,_.tournamentTypeId=W.value,_.throwingMethodId=G.value,_.clubId=K.value,_.categoryId=q.value,$(),!(t&&!await X(`terminliste.applyFilter`))&&E()})}catch(t){e(`terminliste.render`,t),o.replaceChildren(n(`Kunne ikkje laste terminliste.`))}}export{A as render};