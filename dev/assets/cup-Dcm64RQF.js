import{n as e,t}from"./logError-D5z16FyH.js";import{$ as n,C as r,Ct as i,S as a,St as o,_t as s,ft as c,gt as l,p as u,w as d,xt as f,yt as p}from"./index-_Sbv_Pyg.js";import{t as m}from"./LoadingState-BWi0wPLz.js";import{C as h,N as g,O as _,T as v,a as y,c as b,i as x,t as S,v as C,y as w}from"./kampService-CnBu9jM9.js";import{n as T}from"./navigation-BZAaZHac.js";import{b as E,c as D,d as O,g as k,h as A,l as ee,m as j,n as te,p as M,r as ne,s as N,t as P,u as re,v as ie,x as F,y as ae}from"./resultatService-Di3E4RM9.js";import{n as I,t as L}from"./scoreEditor-DoH4azmb.js";function R(e){let t=[...e];for(let e=t.length-1;e>0;e--){let n=Math.floor(Math.random()*(e+1));[t[e],t[n]]=[t[n],t[e]]}return t}function z(e){return e===2||e===4?!0:e<2?!1:e%3==0?z(Math.floor(e/3)*2):e%2==0?z(e/2):!1}function B(e){return e%3==0?{c3:e/3,c2:0}:e%2==0?{c3:0,c2:e/2}:{c3:0,c2:0}}function V(e){if(e<2)return[];let t=[],n=Math.floor(e/2);for(let r=e%3;r<=n&&r<=3&&t.filter(e=>e.c2===0).length<2;r+=3){let n=(e-r)/3;if(n<1)break;z(r+2*n)&&t.push({walkovers:r,c3:n,c2:0})}for(let r=e%2;r<=n&&r<=3&&t.filter(e=>e.c3===0).length<2;r+=2){let n=(e-r)/2;if(n<1)break;let i=r+n;!t.some(e=>e.walkovers===r&&e.c3===0&&e.c2===n)&&z(i)&&t.push({walkovers:r,c3:0,c2:n})}return t.sort((e,t)=>e.walkovers-t.walkovers||t.c3-e.c3),t}function H(e){return e===2?!0:V(e).length>0}function U(e){let t=Math.ceil(e*.5),n=Math.round(e*.8),r=[];for(let i=n;i>=t;i--){let t=e-i;t>=2&&H(i)&&H(t)&&r.push({nA:i,nB:t})}return r}function W(e,{runde1:t=null,walkovers1:n=null}={}){let r=[],i=e,a=1,o=!0;for(;i>2;){let e,s,c;if(o){let r=t;!r&&n!==null&&(r={walkovers:n,c3:Math.floor((i-n)/3),c2:0}),r||=V(i)[0]??{walkovers:i%3,c3:Math.floor(i/3),c2:0},c=r.walkovers,e=r.c3,s=r.c2,o=!1}else{let t=B(i);e=t.c3,s=t.c2,c=0}let l=e*2+s+c;r.push({runde:a,players:i,lanes:e+s,threePlayers:e>0,walkovers:c,advancing:l}),i=l,a++}return r}function G(e,{medSeeding:t=!0,isRunde1:n=!1,walkoverTall:r=null,runde1Oppsett:i=null,shuffleFn:a}={}){let o=a??R,s=[],c=[...e];if(n){let e=i?.walkovers??r??c.length%3;if(e>0){let t=c.slice(0,e);c=c.slice(e);for(let e of t)s.push({players:[e.kasterid],isWalkover:!0,isThreePlayers:!1})}}let l=c.length,u,d;if(i&&n)u=i.c3,d=i.c2;else if(n)u=Math.floor(l/3),d=0;else{let e=B(l);u=e.c3,d=e.c2}let f=u+d;if(t&&f>0){let e=o(c.slice(0,f)),t=o(c.slice(f,2*f)),n=o(c.slice(2*f)),r=0;for(let i=0;i<f;i++){let a=i<u,o=[e[i],t[i]].filter(e=>e!=null),c=a?n[r]:void 0;c&&(o.push(c),r++),s.push({players:o.map(e=>e.kasterid),isWalkover:!1,isThreePlayers:a})}}else{let e=o(c),t=0;for(let n=0;n<u;n++)s.push({players:e.slice(t,t+3).map(e=>e.kasterid),isWalkover:!1,isThreePlayers:!0}),t+=3;for(let n=0;n<d;n++)s.push({players:e.slice(t,t+2).map(e=>e.kasterid),isWalkover:!1,isThreePlayers:!1}),t+=2}return s}function K(e,{showPlayerList:t=!0,initNa:n=null,initFormat:r=null}={}){let i=typeof e==`number`?e:e.length,a=typeof e==`number`?[]:e.map((e,t)=>({...e,cupPlassering:t+1})),o=U(i),s=n===i?i:n!=null&&o.some(e=>e.nA===n)?n:o[0]?.nA??i,c=i-s,l=o.filter(e=>V(e.nA).some(e=>e.c3>0)),u=o.filter(e=>!V(e.nA).some(e=>e.c3>0)),d=V(i).length>0,f=(e,t)=>e.map((e,r)=>{let a=e.nA===s&&n!==i,o=t+r;return`
  ...
  `}function q(e,t,n=0,r=0){let i=e.slice(0,t),a=e.slice(t);function s(e,t=0){return e.map((e,n)=>{let r=n<t;return`
      <tr>
    ...
    `,s.querySelector(`#avbryt-tre-btn`).addEventListener(`click`,()=>s.remove()),s.querySelectorAll(`[data-kasterid]`).forEach(e=>{e.addEventListener(`click`,()=>{let t=Number(e.dataset.kasterid),n=o.indexOf(t);n===-1?o.length<2&&o.push(t):o.splice(n,1),c()})}),s.querySelector(`#bekreft-tre-btn`)?.addEventListener(`click`,async()=>{if(o.length!==2)return;let a=t.find(e=>!o.includes(e.rep.kasterid))??null,c=o.map(e=>t.find(t=>t.rep.kasterid===e)).filter(e=>e!=null).map(e=>e.members.map(e=>e.kasterid)),l=t.flatMap(e=>e.members.map(e=>e.kasterid));s.remove();let{error:u}=await S({kampId:e.id,stevneId:n,roundNumber:e.runde_nummer,roundName:e.runde_navn,allThrowerIds:l,eliminatedIds:a?.members.map(e=>e.kasterid)??[],advancingSides:c});if(u){r(`DB-feil ved bekreft`,`error`);return}await i()})}c()}function he(e){return typeof e!=`object`||!e||Array.isArray(e)?null:e}function ge(e){return e.map(e=>({er_bekreftet:e.er_bekreftet,er_walkover:e.er_walkover,runde_nummer:e.runde_nummer,bane_nummer:e.bane_nummer,spelarar:_e(e.spelarar)}))}function _e(e){return e.map(e=>({kasterid:e.kasterid??0,kamp_poeng:e.kamp_poeng??0,score_poeng:e.score_poeng??0,antall_ringer:e.antall_ringer,omgangar:e.omgangar,kaster:e.kaster}))}function ve(e){let a=null,o=null,l=!1,f=new Set;async function p(e,{id:t,isAdmin:n=!1},r=null){o=r,l=n,a&&=(await T(a),null),e.replaceChildren(m(`Laster…`)),await h(e,t)}async function h(a,p){try{let[{data:t},{data:m},{data:_},{data:v},{count:b}]=await Promise.all([n(p),y(p),ne(p),te([`A`,`B`]),c(p)]);if(!t){a.replaceChildren(i(`Stevne ikkje funne.`));return}let x=_.filter(e=>e.kasterid!=null),S=m.filter(e=>e.fase===`innledende`),C=m.filter(e=>e.fase===`avsluttende`),w={},T={},j=new Map;for(let e of x)e.startnummer!=null&&(w[e.kasterid]=e.startnummer,j.set(e.startnummer,(j.get(e.startnummer)??0)+1)),e.posisjon!=null&&(T[e.kasterid]=e.posisjon);let M=[...j.values()].some(e=>e>1),N={};for(let e of m)for(let t of e.spelarar)t.kasterid&&t.kaster&&!N[t.kasterid]&&(N[t.kasterid]=`${t.kaster.fornavn} ${t.kaster.etternavn}`);let P=ge(S),F=O(P,x,N,w,T),I=S.length>0&&S.every(e=>e.er_bekreftet),L=C.length>0,R=(S.length>0||L)&&S.every(e=>e.er_bekreftet)&&C.every(e=>e.er_bekreftet),z=x.some(e=>e.gruppe!=null),B=Object.fromEntries(v.map(e=>[e.navn,e.id])),V=he(t.runde1_format),H=b??0;if(t.kategori?.erlagbasert){let{data:e}=await u(p);H=e.length}let U={container:a,stevneid:p,stevne:t,standings:F,startNumberMap:w,positionMap:T,isTeam:M,nameMap:N,initialMatches:S,finalMatches:C,results:x,isAdmin:l,hasGroupAssignment:z,allInitialConfirmed:I,hasFinalMatches:L,round1Format:V,unitCount:H,groupNameMap:B,reload:()=>h(a,p)};l&&o&&(o.innerHTML=k(t,{allMatchesConfirmed:R,hasFinalMatches:L,hasGroupAssignment:z,hasPreconfiguredFormat:V!=null&&t.stevne_fase!==`avsluttende`}));let W=A(a);if(z){let t=ae(F,P,w,{tableId:`standing-final`,hasGroups:!0,hasElimination:!0,positionMap:T,unitLabel:M?`par`:`spelarar`});a.innerHTML=ie(e.renderMatchesHtml(U),t),ee(a,`standing-final`,f),re(a),W===`standing`&&E(a,`standing`),e.bindMatchEvents(a,U),g(a,p)}else a.innerHTML=e.renderSetupHtml(U);o?.querySelector(`#complete-tournament-btn`)?.addEventListener(`click`,async()=>{if(!await d({title:`Fullfør turnering`,message:`Vil du fullføre turneringa? Dette kan ikkje angrast.`,danger:!0}))return;let{error:e}=await D(p,[...F.filter(e=>e.gruppe?.navn===`A`),...F.filter(e=>e.gruppe?.navn===`B`),...F.filter(e=>e.gruppe?.navn!==`A`&&e.gruppe?.navn!==`B`)]);if(e){r(`Feil ved lagring av plasseringar`,`error`);return}let{error:t}=await s(p);if(t){r(`Feil ved fullføring av turnering`,`error`);return}await h(a,p)}),e.bindHeaderEvents(o,U)}catch(e){t(`avsluttendeBase.loadAndRender`,e),a.replaceChildren(i(`Kunne ikkje laste avsluttande fase.`))}}function g(t,n){if(a)return;let r=j(n,[`avsluttende`],t,h,()=>{a&&=(T(a),null)});a=w(n,e.channelName(n),r)}return p}function ye(e,t,n){return _(e.spelarar.filter(e=>e.kasterid!=null),t,n)}function $(e){return e?.members.reduce((e,t)=>e+g(t),0)??0}var be=ve({channelName:e=>`stevne-avsl-cup-${e}`,renderMatchesHtml:e=>{let{finalMatches:t,standings:n,startNumberMap:r,positionMap:i,isTeam:a,isAdmin:o}=e;return`<div class="d-flex gap-3 flex-wrap">${[...new Set(n.map(e=>e.gruppe?.navn).filter(e=>e!=null))].sort().map(e=>{let s=t.filter(t=>t.gruppe_navn===e),c=n.filter(t=>t.gruppe?.navn===e),l=c.filter(e=>e.runde_eliminert==null).length,u=c.length,d=s.length?Math.max(...s.map(e=>e.runde_nummer)):0,f=s.filter(e=>e.runde_nummer===d),p=f.length>0&&f.every(e=>e.er_bekreftet||e.er_walkover),m=s.some(e=>e.runde_navn===`Semifinale`),h=o&&(s.length===0||p)&&l>1&&!m,g=f.length>0&&f.every(e=>e.runde_navn===`Semifinale`),_=s.some(e=>e.runde_navn===`Finale`);return Se(e,s,l,u,d,h,o&&g&&p&&!_,r,i,a?`par`:`spelarar`,o)}).join(``)}</div>`},bindMatchEvents:(e,t)=>{!t.isAdmin&&t.finalMatches.length===0||Oe(e,t.stevneid,t.finalMatches,t.isAdmin,t.reload,t.startNumberMap,t.positionMap)},renderSetupHtml:e=>{let{stevne:t,isAdmin:n,round1Format:r,unitCount:i,standings:a}=e,o=r?.nA??null;if(t.stevne_fase===`avsluttende`)return n?K(a,{showPlayerList:!0,initNa:o,initFormat:r}):`<p class="text-muted fst-italic">Gruppefordeling er ikkje klar enno.</p>`;if(!n)return``;if(i<2)return`<p class="text-muted fst-italic">${t.kategori?.erlagbasert?`Minst 2 par må vere oppretta før gruppefordelinga kan setjast.`:`Minst 2 spelarar må vere påmelde før gruppefordelinga kan setjast.`}</p>`;let s=a.length>0;return K(s?a:i,{showPlayerList:s,initNa:o,initFormat:r})},bindHeaderEvents:(e,n)=>{let{container:i,stevneid:o,stevne:s,standings:c,results:u,round1Format:f,allInitialConfirmed:m,hasGroupAssignment:h,groupNameMap:g,reload:_}=n;if(e?.querySelector(`#start-final-btn`)?.addEventListener(`click`,async()=>{if(!m)return;let{error:e}=await p(o,`avsluttende`);if(e){r(`Feil ved oppstart av avsluttande fase`,`error`);return}if(f?.nA!=null){let e=f.nA,{error:t}=await N(o,xe(c,u,e,g.A??null,g.B??null));if(t){r(`Feil ved lagring av gruppefordeling: `+a(t),`error`);return}}await _()}),!h){let e=parseInt(i.querySelector(`#group-assignment-wrapper`)?.dataset.n??`0`)||c.length;function t(e,t){let n=i.querySelector(`input[name="${e}"]:checked`);if(n?.dataset.oppsett)try{return JSON.parse(n.dataset.oppsett)}catch{}return V(t)[0]??null}function n(e,t,n){let r=i.querySelector(`#group-preview`);r&&(r.innerHTML=q(c.map((e,t)=>({...e,cupPlassering:t+1})),e,t?.walkovers??0,n?.walkovers??0))}let d=i.querySelector(`#group-panels`);d&&d.addEventListener(`change`,r=>{let a=r.target;if(!a.matches(`input[name^="round1-format"]`))return;let o=parseInt(i.querySelector(`input[name="group-split"]:checked`)?.value??String(e)),s=e-o,c=t(`round1-format-a`,o),l=t(`round1-format-b`,s);if(a.name===`round1-format-a`){let e=i.querySelector(`#structure-a`);e&&(e.outerHTML=J(o,c,`a`))}else{let e=i.querySelector(`#structure-b`);e&&(e.outerHTML=J(s,l,`b`))}n(o,c,l)}),i.querySelectorAll(`input[name="group-split"]`).forEach(t=>{t.addEventListener(`change`,()=>{let r=parseInt(t.value),i=e-r,a=V(r)[0]??null,o=i>=2?V(i)[0]??null:null;d&&(d.innerHTML=`<div id="group-panel-a" class="final-group-col">
                ${Y(`Gruppe A`,r,`round1-format-a`,a)}
              </div>`+(i>=2?`<div id="group-panel-b" class="final-group-col">
                ${Y(`Gruppe B`,i,`round1-format-b`,o)}
              </div>`:``)),n(r,a,o)})}),i.querySelector(`#confirm-group-btn`)?.addEventListener(`click`,async()=>{let n=i.querySelector(`input[name="group-split"]:checked`);if(!n)return;let d=parseInt(n.value),f=e-d,{error:p}=await l(o,{A:t(`round1-format-a`,d),B:f>=2?t(`round1-format-b`,f):null,nA:d});if(p){r(`Feil ved lagring av format: `+a(p),`error`);return}if(s.stevne_fase===`avsluttende`){let{error:e}=await N(o,xe(c,u,d,g.A??null,g.B??null));if(e){r(`Feil ved lagring av gruppefordeling: `+a(e),`error`);return}}r(`Gruppefordeling lagra`,`success`),await _()})}e?.querySelector(`#edit-group-assignment-btn`)?.addEventListener(`click`,async()=>{await d({title:`Tilbakestill gruppeinndeling`,message:`Gruppefordeling og format vert fjerna.`,danger:!0})&&(await Promise.all([P(o),l(o,null)]),await _())}),h&&(i.querySelectorAll(`[data-generate-group]`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.dataset.generateGroup??``,n=parseInt(e.dataset.runde??`1`);pe(o,t,c.filter(e=>e.gruppe?.navn===t),n,f,_)})}),i.querySelectorAll(`[data-generate-finale-group]`).forEach(e=>{e.addEventListener(`click`,async()=>{let n=e.dataset.generateFinaleGroup??``;e.disabled=!0,e.textContent=`Genererer…`;try{await fe(o,n),await _()}catch(n){t(`cup:genererFinale`,n),r(`Feil ved generering av finale`,`error`),e.disabled=!1,e.textContent=`Generer finale`}})}))}});function xe(e,t,n,r,i){return e.flatMap((e,a)=>{let o=a<n?r:i??r,s=e.startnummer==null?[]:t.filter(t=>t.startnummer===e.startnummer).map(e=>e.kasterid);return(s.length?s:[e.kasterid]).map(e=>({kasterid:e,gruppeid:o}))})}function Se(e,t,n,r,i,a,s,c,l,u,d=!0){let f=new Map;for(let e of t)f.has(e.runde_nummer)||f.set(e.runde_nummer,[]),f.get(e.runde_nummer).push(e);let p=[...f.entries()].reverse().map(([e,t])=>{let n=t[0]?.runde_navn??`Runde ${e}`,r=t.filter(e=>!e.er_walkover);return r.length?`
      <h6 class="fw-bold text-center mb-1">${o(n)}</h6>
      <div class="d-flex flex-wrap gap-2 mb-2">
        ${r.map(e=>De(e,c,l,d)).join(``)}
    ...
    <td class="${u}"${d}>${a}</td>
        ...
        <td colspan="2">${F(t[0]??null,!1)} <span class="badge bg-secondary">Walkover</span></td>
          ...
          </tr>`}function De(e,t,n,r=!0){let i=ye(e,t,n),a=e.er_bekreftet||e.er_walkover,o=e.spelarar.some(e=>(e.omgangar?.length??0)>0),s={isConfirmed:a,hasRounds:o,canEditScore:r&&e.er_bekreftet&&!e.er_tre_spelarar&&!o,isThreeSides:e.er_tre_spelarar},c=r?Ee(e,a,Te(e,i,o,a)):``;return`
    ...
    </div>`}function Oe(e,n,i,a,o,s,c){for(let l of i){let i=ye(l,s,c),u=i[0]??null,d=i[1]??null,f=u?.rep??null,p=d?.rep??null,m=F(u,!1),g=F(d,!1),_=i.flatMap(e=>e.members.map(e=>e.id)),y=async(e,n)=>{let r=[];f?.id&&r.push(h(f.id,e)),p?.id&&r.push(h(p.id,n));for(let e of[u,d])for(let t of e?.members.slice(1)??[])r.push(h(t.id,0));try{return(await Promise.all(r)).find(e=>e.error)??null}catch(e){return t(`cup:writeSideScore`,e),{error:e}}};if(e.querySelector(`#plus-${l.id}`)?.addEventListener(`click`,()=>{L({side1Name:m,side2Name:g,currentS1:$(u),currentS2:$(d),playerIds:_,hasRounds:l.spelarar.some(e=>(e.omgangar?.length??0)>0),logPrefix:`cup`,onSave:y,onSaved:o})}),e.querySelector(`#scoreboard-${l.id}`)?.addEventListener(`click`,()=>{window.open(`#/kamp/${l.id}`,`_blank`)}),e.querySelector(`#bekrft-${l.id}`)?.addEventListener(`click`,async e=>{if(l.er_tre_spelarar)me(l,i,n,o);else{let t=e.currentTarget;t.disabled=!0,t.textContent=`Lagrer…`;try{await ke(n,l,i,o)||(t.disabled=!1,t.textContent=`Bekreft`)}catch{t.disabled=!1,t.textContent=`Bekreft`}}}),a&&l.er_bekreftet&&!l.er_tre_spelarar){let t=i.flatMap(e=>e.members.map(e=>e.kasterid)),a=()=>{I(m,g,$(u),$(d),async(e,i)=>{if(_.length){let{error:e}=await x(_);if(e){r(`DB-feil ved sletting av omgangar`,`error`);return}}if(await y(e,i)){r(`DB-feil ved oppdatering av score`,`error`);return}let a=e>=i?u:d,s=e>=i?d:u,c=a?.members.map(e=>e.kasterid)??[],f=s?.members.map(e=>e.kasterid)??[],p=[...c.map(e=>({kasterid:e,plassering:1})),...f.map(e=>({kasterid:e,plassering:2}))],{error:m}=await C(l.id,p);if(m){r(`DB-feil ved oppdatering av plassering`,`error`);return}await v({stevneId:n,roundNumber:l.runde_nummer,roundName:l.runde_navn,allThrowerIds:t,newWinnerIds:c,newLoserIds:f}),await o()})};e.querySelectorAll(`[data-endre-score="${l.id}"]`).forEach(e=>e.addEventListener(`click`,a))}}}async function ke(e,t,n,i){let a=n[0]??null,o=n[1]??null,{data:s}=await b(t.id),c=e=>e?.members.reduce((e,t)=>e+g(s.find(e=>e.id===t.id)??t),0)??0,l=c(a),u=c(o);if(l===0&&u===0&&!await d({title:`Ingen score registrert`,message:`Vil du bekrefte kampen likevel?`}))return!1;let f=l>=u?a:o,p=l>=u?o:a,m=n.flatMap(e=>e.members.map(e=>e.kasterid)),{error:h}=await S({kampId:t.id,stevneId:e,roundNumber:t.runde_nummer,roundName:t.runde_navn,allThrowerIds:m,eliminatedIds:p?.members.map(e=>e.kasterid)??[],advancingSides:f?[f.members.map(e=>e.kasterid)]:[]});return h?(r(`DB-feil ved bekreft`,`error`),!1):(await i(),!0)}export{be as render};