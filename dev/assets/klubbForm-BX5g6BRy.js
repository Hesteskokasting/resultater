import{F as e,Nt as t,P as n,a as r}from"./index-z7iEevWR.js";import{a as i,i as a,o,r as s,s as c,t as l}from"./_formButtons-CsyWCJCB.js";import{t as u}from"./LoadingState-C6NB62Ct.js";import{i as d,o as f,t as p}from"./klubbService-Haapdsx7.js";async function m(m,h){let{container:g}=m;g.replaceChildren(u());let _=null;if(h){let{data:r,error:i}=await d(h);if(i||!r){g.replaceChildren(t(`Klubb ikkje funne.`));return}if(_=r,!await n()&&!await e(h)){g.replaceChildren(t(`Ingen tilgang til denne klubben.`));return}}else if(!await n()){g.replaceChildren(t(`Ingen tilgang.`));return}let{wrapper:v,headingHtml:y}=s(m);v.innerHTML=`
    ${y}
    <form id="club-form">
