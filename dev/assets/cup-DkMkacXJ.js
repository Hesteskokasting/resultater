import{t as e}from"./supabase-DFblIP9B.js";import{t}from"./logError-DFCPgUum.js";import{$ as n,A as r,C as i,K as a,Q as o,S as s,U as c,Y as l,Z as u,p as d,q as f}from"./index-CpxSVsbW.js";import{t as p}from"./LoadingState-Ps7fTB_T.js";import{C as m,N as h,O as g,T as _,a as v,c as y,i as b,t as x,v as S,y as C}from"./kampService-C-33R_QU.js";import{n as w}from"./navigation-BoLntvrQ.js";import{b as T,c as E,d as D,g as O,h as ee,l as k,m as A,n as te,p as j,r as ne,s as M,t as N,u as re,v as ie,x as P,y as ae}from"./resultatService-Yr3jDgPq.js";import{n as F,t as I}from"./scoreEditor-CKWHHosI.js";function L(e){let t=[...e];for(let e=t.length-1;e>0;e--){let n=Math.floor(Math.random()*(e+1));[t[e],t[n]]=[t[n],t[e]]}return t}function R(e){return e===2||e===4?!0:e<2?!1:e%3==0?R(Math.floor(e/3)*2):e%2==0?R(e/2):!1}function z(e){return e%3==0?{c3:e/3,c2:0}:e%2==0?{c3:0,c2:e/2}:{c3:0,c2:0}}function B(e){if(e<2)return[];let t=[],n=Math.floor(e/2);for(let r=e%3;r<=n&&r<=3&&t.filter(e=>e.c2===0).length<2;r+=3){let n=(e-r)/3;if(n<1)break;R(r+2*n)&&t.push({walkovers:r,c3:n,c2:0})}for(let r=e%2;r<=n&&r<=3&&t.filter(e=>e.c3===0).length<2;r+=2){let n=(e-r)/2;if(n<1)break;let i=r+n;!t.some(e=>e.walkovers===r&&e.c3===0&&e.c2===n)&&R(i)&&t.push({walkovers:r,c3:0,c2:n})}return t.sort((e,t)=>e.walkovers-t.walkovers||t.c3-e.c3),t}function V(e){return e===2?!0:B(e).length>0}function H(e){let t=Math.ceil(e*.5),n=Math.round(e*.8),r=[];for(let i=n;i>=t;i--){let t=e-i;t>=2&&V(i)&&V(t)&&r.push({nA:i,nB:t})}return r}function U(e,{runde1:t=null,walkovers1:n=null}={}){let r=[],i=e,a=1,o=!0;for(;i>2;){let e,s,c;if(o){let r=t;!r&&n!==null&&(r={walkovers:n,c3:Math.floor((i-n)/3),c2:0}),r||=B(i)[0]??{walkovers:i%3,c3:Math.floor(i/3),c2:0},c=r.walkovers,e=r.c3,s=r.c2,o=!1}else{let t=z(i);e=t.c3,s=t.c2,c=0}let l=e*2+s+c;r.push({runde:a,players:i,lanes:e+s,threePlayers:e>0,walkovers:c,advancing:l}),i=l,a++}return r}function W(e,{medSeeding:t=!0,isRunde1:n=!1,walkoverTall:r=null,runde1Oppsett:i=null,shuffleFn:a}={}){let o=a??L,s=[],c=[...e];if(n){let e=i?.walkovers??r??c.length%3;if(e>0){let t=c.slice(0,e);c=c.slice(e);for(let e of t)s.push({players:[e.kasterid],isWalkover:!0,isThreePlayers:!1})}}let l=c.length,u,d;if(i&&n)u=i.c3,d=i.c2;else if(n)u=Math.floor(l/3),d=0;else{let e=z(l);u=e.c3,d=e.c2}let f=u+d;if(t&&f>0){let e=o(c.slice(0,f)),t=o(c.slice(f,2*f)),n=o(c.slice(2*f)),r=0;for(let i=0;i<f;i++){let a=i<u,o=[e[i],t[i]].filter(e=>e!=null),c=a?n[r]:void 0;c&&(o.push(c),r++),s.push({players:o.map(e=>e.kasterid),isWalkover:!1,isThreePlayers:a})}}else{let e=o(c),t=0;for(let n=0;n<u;n++)s.push({players:e.slice(t,t+3).map(e=>e.kasterid),isWalkover:!1,isThreePlayers:!0}),t+=3;for(let n=0;n<d;n++)s.push({players:e.slice(t,t+2).map(e=>e.kasterid),isWalkover:!1,isThreePlayers:!1}),t+=2}return s}function G(e,{showPlayerList:t=!0,initNa:n=null,initFormat:r=null}={}){let i=typeof e==`number`?e:e.length,a=typeof e==`number`?[]:e.map((e,t)=>({...e,cupPlassering:t+1})),o=H(i),s=n===i?i:n!=null&&o.some(e=>e.nA===n)?n:o[0]?.nA??i,c=i-s,l=o.filter(e=>B(e.nA).some(e=>e.c3>0)),u=o.filter(e=>!B(e.nA).some(e=>e.c3>0)),d=B(i).length>0,f=(e,t)=>e.map((e,r)=>{let a=e.nA===s&&n!==i,o=t+r;return`
  ...
  `}function K(e,t,n=0,r=0){let i=e.slice(0,t),a=e.slice(t);function s(e,t=0){return e.map((e,n)=>{let r=n<t;return`
      <tr>
    ...
    <div class="card">
      ...
      <div class="card final-dialog-card-wide">
        <div class="final-dialog-drag-handle">
          ...
          <h5 class="mb-1">Gruppe ${o(n)} — Runde ${i}</h5>
    ...
    `,o.querySelector(`#avbryt-tre-btn`).addEventListener(`click`,()=>o.remove()),o.querySelectorAll(`[data-kasterid]`).forEach(e=>{e.addEventListener(`click`,()=>{let t=Number(e.dataset.kasterid),n=a.indexOf(t);n===-1?a.length<2&&a.push(t):a.splice(n,1),c()})}),o.querySelector(`#bekreft-tre-btn`)?.addEventListener(`click`,async()=>{if(a.length!==2)return;let i=t.find(e=>!a.includes(e.rep.kasterid))??null,c=a.map(e=>t.find(t=>t.rep.kasterid===e)).filter(e=>e!=null).map(e=>e.members.map(e=>e.kasterid)),l=t.flatMap(e=>e.members.map(e=>e.kasterid));o.remove();let{error:u}=await x({kampId:e.id,stevneId:n,roundNumber:e.runde_nummer,roundName:e.runde_navn,allThrowerIds:l,eliminatedIds:i?.members.map(e=>e.kasterid)??[],advancingSides:c});if(u){s(`DB-feil ved bekreft`,`error`);return}await r()})}c()}function me(e){return typeof e!=`object`||!e||Array.isArray(e)?null:e}function he(e){return e.map(e=>({er_bekreftet:e.er_bekreftet,er_walkover:e.er_walkover,runde_nummer:e.runde_nummer,bane_nummer:e.bane_nummer,spelarar:ge(e.spelarar)}))}function ge(e){return e.map(e=>({kasterid:e.kasterid??0,kamp_poeng:e.kamp_poeng??0,score_poeng:e.score_poeng??0,antall_ringer:e.antall_ringer,omgangar:e.omgangar,kaster:e.kaster}))}function _e(e){let a=null,o=null,l=!1,u=new Set;async function m(e,{id:t,isAdmin:n=!1},r=null){o=r,l=n,a&&=(await w(a),null),e.replaceChildren(p(`Laster…`)),await h(e,t)}async function h(a,p){try{let[{data:t},{data:m},{data:_},{data:y},{count:b}]=await Promise.all([r(p),v(p),ne(p),te([`A`,`B`]),c(p)]);if(!t){a.replaceChildren(n(`Stevne ikkje funne.`));return}let x=_.filter(e=>e.kasterid!=null),S=m.filter(e=>e.fase===`innledende`),C=m.filter(e=>e.fase===`avsluttende`),w={},A={},j=new Map;for(let e of x)e.startnummer!=null&&(w[e.kasterid]=e.startnummer,j.set(e.startnummer,(j.get(e.startnummer)??0)+1)),e.posisjon!=null&&(A[e.kasterid]=e.posisjon);let M=[...j.values()].some(e=>e>1),N={};for(let e of m)for(let t of e.spelarar)t.kasterid&&t.kaster&&!N[t.kasterid]&&(N[t.kasterid]=`${t.kaster.fornavn} ${t.kaster.etternavn}`);let P=he(S),F=D(P,x,N,w,A),I=S.length>0&&S.every(e=>e.er_bekreftet),L=C.length>0,R=(S.length>0||L)&&S.every(e=>e.er_bekreftet)&&C.every(e=>e.er_bekreftet),z=x.some(e=>e.gruppe!=null),B=Object.fromEntries(y.map(e=>[e.navn,e.id])),V=me(t.runde1_format),H=b??0;if(t.kategori?.erlagbasert){let{data:e}=await d(p);H=e.length}let U={container:a,stevneid:p,stevne:t,standings:F,startNumberMap:w,positionMap:A,isTeam:M,nameMap:N,initialMatches:S,finalMatches:C,results:x,isAdmin:l,hasGroupAssignment:z,allInitialConfirmed:I,hasFinalMatches:L,round1Format:V,unitCount:H,groupNameMap:B,reload:()=>h(a,p)};l&&o&&(o.innerHTML=O(t,{allMatchesConfirmed:R,hasFinalMatches:L,hasGroupAssignment:z,hasPreconfiguredFormat:V!=null&&t.stevne_fase!==`avsluttende`}));let W=ee(a);if(z){let t=ae(F,P,w,{tableId:`standing-final`,hasGroups:!0,hasElimination:!0,positionMap:A,unitLabel:M?`par`:`spelarar`});a.innerHTML=ie(e.renderMatchesHtml(U),t),k(a,`standing-final`,u),re(a),W===`standing`&&T(a,`standing`),e.bindMatchEvents(a,U),g(a,p)}else a.innerHTML=e.renderSetupHtml(U);o?.querySelector(`#complete-tournament-btn`)?.addEventListener(`click`,async()=>{if(!await i({title:`Fullfør turnering`,message:`Vil du fullføre turneringa? Dette kan ikkje angrast.`,danger:!0}))return;let{error:e}=await E(p,[...F.filter(e=>e.gruppe?.navn===`A`),...F.filter(e=>e.gruppe?.navn===`B`),...F.filter(e=>e.gruppe?.navn!==`A`&&e.gruppe?.navn!==`B`)]);if(e){s(`Feil ved lagring av plasseringar`,`error`);return}let{error:t}=await f(p);if(t){s(`Feil ved fullføring av turnering`,`error`);return}await h(a,p)}),e.bindHeaderEvents(o,U)}catch(e){t(`avsluttendeBase.loadAndRender`,e),a.replaceChildren(n(`Kunne ikkje laste avsluttande fase.`))}}function g(t,n){if(a)return;let r=A(n,[`avsluttende`],t,h,()=>{a&&=(w(a),null)});a=C(n,e.channelName(n),r)}return m}function ve(e,t,n){return g(e.spelarar.filter(e=>e.kasterid!=null),t,n)}function $(e){return e?.members.reduce((e,t)=>e+h(t),0)??0}var ye=_e({channelName:e=>`stevne-avsl-cup-${e}`,renderMatchesHtml:e=>{let{finalMatches:t,standings:n,startNumberMap:r,positionMap:i,isTeam:a,isAdmin:o}=e;return`<div class="d-flex gap-3 flex-wrap">${[...new Set(n.map(e=>e.gruppe?.navn).filter(e=>e!=null))].sort().map(e=>{let s=t.filter(t=>t.gruppe_navn===e),c=n.filter(t=>t.gruppe?.navn===e),l=c.filter(e=>e.runde_eliminert==null).length,u=c.length,d=s.length?Math.max(...s.map(e=>e.runde_nummer)):0,f=s.filter(e=>e.runde_nummer===d),p=f.length>0&&f.every(e=>e.er_bekreftet||e.er_walkover),m=s.some(e=>e.runde_navn===`Semifinale`),h=o&&(s.length===0||p)&&l>1&&!m,g=f.length>0&&f.every(e=>e.runde_navn===`Semifinale`),_=s.some(e=>e.runde_navn===`Finale`);return xe(e,s,l,u,d,h,o&&g&&p&&!_,r,i,a?`par`:`spelarar`,o)}).join(``)}</div>`},bindMatchEvents:(e,t)=>{!t.isAdmin&&t.finalMatches.length===0||De(e,t.stevneid,t.finalMatches,t.isAdmin,t.reload,t.startNumberMap,t.positionMap)},renderSetupHtml:e=>{let{stevne:t,isAdmin:n,round1Format:r,unitCount:i,standings:a}=e,o=r?.nA??null;if(t.stevne_fase===`avsluttende`)return n?G(a,{showPlayerList:!0,initNa:o,initFormat:r}):`<p class="text-muted fst-italic">Gruppefordeling er ikkje klar enno.</p>`;if(!n)return``;if(i<2)return`<p class="text-muted fst-italic">${t.kategori?.erlagbasert?`Minst 2 par må vere oppretta før gruppefordelinga kan setjast.`:`Minst 2 spelarar må vere påmelde før gruppefordelinga kan setjast.`}</p>`;let s=a.length>0;return G(s?a:i,{showPlayerList:s,initNa:o,initFormat:r})},bindHeaderEvents:(e,n)=>{let{container:r,stevneid:o,stevne:c,standings:u,results:d,round1Format:f,allInitialConfirmed:p,hasGroupAssignment:m,groupNameMap:h,reload:g}=n;if(e?.querySelector(`#start-final-btn`)?.addEventListener(`click`,async()=>{if(!p)return;let{error:e}=await l(o,`avsluttende`);if(e){s(`Feil ved oppstart av avsluttande fase`,`error`);return}if(f?.nA!=null){let e=f.nA,{error:t}=await M(o,be(u,d,e,h.A??null,h.B??null));if(t){s(`Feil ved lagring av gruppefordeling`,`error`);return}}await g()}),!m){let e=parseInt(r.querySelector(`#group-assignment-wrapper`)?.dataset.n??`0`)||u.length;function t(e,t){let n=r.querySelector(`input[name="${e}"]:checked`);if(n?.dataset.oppsett)try{return JSON.parse(n.dataset.oppsett)}catch{}return B(t)[0]??null}function n(e,t,n){let i=r.querySelector(`#group-preview`);i&&(i.innerHTML=K(u.map((e,t)=>({...e,cupPlassering:t+1})),e,t?.walkovers??0,n?.walkovers??0))}let i=r.querySelector(`#group-panels`);i&&i.addEventListener(`change`,i=>{let a=i.target;if(!a.matches(`input[name^="round1-format"]`))return;let o=parseInt(r.querySelector(`input[name="group-split"]:checked`)?.value??String(e)),s=e-o,c=t(`round1-format-a`,o),l=t(`round1-format-b`,s);if(a.name===`round1-format-a`){let e=r.querySelector(`#structure-a`);e&&(e.outerHTML=q(o,c,`a`))}else{let e=r.querySelector(`#structure-b`);e&&(e.outerHTML=q(s,l,`b`))}n(o,c,l)}),r.querySelectorAll(`input[name="group-split"]`).forEach(t=>{t.addEventListener(`change`,()=>{let r=parseInt(t.value),a=e-r,o=B(r)[0]??null,s=a>=2?B(a)[0]??null:null;i&&(i.innerHTML=`<div id="group-panel-a" class="final-group-col">
                ${J(`Gruppe A`,r,`round1-format-a`,o)}
              </div>`+(a>=2?`<div id="group-panel-b" class="final-group-col">
                ${J(`Gruppe B`,a,`round1-format-b`,s)}
              </div>`:``)),n(r,o,s)})}),r.querySelector(`#confirm-group-btn`)?.addEventListener(`click`,async()=>{let n=r.querySelector(`input[name="group-split"]:checked`);if(!n)return;let i=parseInt(n.value),l=e-i,{error:f}=await a(o,{A:t(`round1-format-a`,i),B:l>=2?t(`round1-format-b`,l):null,nA:i});if(f){s(`Feil ved lagring av format`,`error`);return}if(c.stevne_fase===`avsluttende`){let{error:e}=await M(o,be(u,d,i,h.A??null,h.B??null));if(e){s(`Feil ved lagring av gruppefordeling`,`error`);return}}s(`Gruppefordeling lagra`,`success`),await g()})}e?.querySelector(`#edit-group-assignment-btn`)?.addEventListener(`click`,async()=>{await i({title:`Tilbakestill gruppeinndeling`,message:`Gruppefordeling og format vert fjerna.`,danger:!0})&&(await Promise.all([N(o),a(o,null)]),await g())}),m&&(r.querySelectorAll(`[data-generate-group]`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.dataset.generateGroup??``,n=parseInt(e.dataset.runde??`1`);fe(o,t,u.filter(e=>e.gruppe?.navn===t),n,f,g)})}),r.querySelectorAll(`[data-generate-finale-group]`).forEach(e=>{e.addEventListener(`click`,async()=>{let n=e.dataset.generateFinaleGroup??``;e.disabled=!0,e.textContent=`Genererer…`;try{await de(o,n),await g()}catch(n){t(`cup:genererFinale`,n),s(`Feil ved generering av finale`,`error`),e.disabled=!1,e.textContent=`Generer finale`}})}))}});function be(e,t,n,r,i){return e.flatMap((e,a)=>{let o=a<n?r:i??r,s=e.startnummer==null?[]:t.filter(t=>t.startnummer===e.startnummer).map(e=>e.kasterid);return(s.length?s:[e.kasterid]).map(e=>({kasterid:e,gruppeid:o}))})}function xe(e,t,n,r,i,a,s,c,l,u,d=!0){let f=new Map;for(let e of t)f.has(e.runde_nummer)||f.set(e.runde_nummer,[]),f.get(e.runde_nummer).push(e);let p=[...f.entries()].reverse().map(([e,t])=>{let n=t[0]?.runde_navn??`Runde ${e}`,r=t.filter(e=>!e.er_walkover);return r.length?`
      <h6 class="fw-bold text-center mb-1">${o(n)}</h6>
      <div class="d-flex flex-wrap gap-2 mb-2">
        ${r.map(e=>Ee(e,c,l,d)).join(``)}
    ...
    <td class="${u}"${d}>${a}</td>
        ...
        <td colspan="2">${P(t[0]??null,!1)} <span class="badge bg-secondary">Walkover</span></td>
          ...
          </tr>`}function Ee(e,t,n,r=!0){let i=ve(e,t,n),a=e.er_bekreftet||e.er_walkover,o=e.spelarar.some(e=>(e.omgangar?.length??0)>0),s={isConfirmed:a,hasRounds:o,canEditScore:r&&e.er_bekreftet&&!e.er_tre_spelarar&&!o,isThreeSides:e.er_tre_spelarar},c=r?Te(e,a,we(e,i,o,a)):``;return`
    ...
    </div>`}function De(e,n,r,i,a,o,c){for(let l of r){let r=ve(l,o,c),u=r[0]??null,d=r[1]??null,f=u?.rep??null,p=d?.rep??null,h=P(u,!1),g=P(d,!1),v=r.flatMap(e=>e.members.map(e=>e.id)),y=async(e,n)=>{let r=[];f?.id&&r.push(m(f.id,e)),p?.id&&r.push(m(p.id,n));for(let e of[u,d])for(let t of e?.members.slice(1)??[])r.push(m(t.id,0));try{return(await Promise.all(r)).find(e=>e.error)??null}catch(e){return t(`cup:writeSideScore`,e),{error:e}}};if(e.querySelector(`#plus-${l.id}`)?.addEventListener(`click`,()=>{I({side1Name:h,side2Name:g,currentS1:$(u),currentS2:$(d),playerIds:v,hasRounds:l.spelarar.some(e=>(e.omgangar?.length??0)>0),logPrefix:`cup`,onSave:y,onSaved:a})}),e.querySelector(`#scoreboard-${l.id}`)?.addEventListener(`click`,()=>{window.open(`#/kamp/${l.id}`,`_blank`)}),e.querySelector(`#bekrft-${l.id}`)?.addEventListener(`click`,async e=>{if(l.er_tre_spelarar)pe(l,r,n,a);else{let t=e.currentTarget;t.disabled=!0,t.textContent=`Lagrer…`;try{await Oe(n,l,r,a)||(t.disabled=!1,t.textContent=`Bekreft`)}catch{t.disabled=!1,t.textContent=`Bekreft`}}}),i&&l.er_bekreftet&&!l.er_tre_spelarar){let t=r.flatMap(e=>e.members.map(e=>e.kasterid)),i=()=>{F(h,g,$(u),$(d),async(e,r)=>{if(v.length){let{error:e}=await b(v);if(e){s(`DB-feil ved sletting av omgangar`,`error`);return}}if(await y(e,r)){s(`DB-feil ved oppdatering av score`,`error`);return}let i=e>=r?u:d,o=e>=r?d:u,c=i?.members.map(e=>e.kasterid)??[],f=o?.members.map(e=>e.kasterid)??[],p=[...c.map(e=>({kasterid:e,plassering:1})),...f.map(e=>({kasterid:e,plassering:2}))],{error:m}=await S(l.id,p);if(m){s(`DB-feil ved oppdatering av plassering`,`error`);return}await _({stevneId:n,roundNumber:l.runde_nummer,roundName:l.runde_navn,allThrowerIds:t,newWinnerIds:c,newLoserIds:f}),await a()})};e.querySelectorAll(`[data-endre-score="${l.id}"]`).forEach(e=>e.addEventListener(`click`,i))}}}async function Oe(e,t,n,r){let a=n[0]??null,o=n[1]??null,{data:c}=await y(t.id),l=e=>e?.members.reduce((e,t)=>e+h(c.find(e=>e.id===t.id)??t),0)??0,u=l(a),d=l(o);if(u===0&&d===0&&!await i({title:`Ingen score registrert`,message:`Vil du bekrefte kampen likevel?`}))return!1;let f=u>=d?a:o,p=u>=d?o:a,m=n.flatMap(e=>e.members.map(e=>e.kasterid)),{error:g}=await x({kampId:t.id,stevneId:e,roundNumber:t.runde_nummer,roundName:t.runde_navn,allThrowerIds:m,eliminatedIds:p?.members.map(e=>e.kasterid)??[],advancingSides:f?[f.members.map(e=>e.kasterid)]:[]});return g?(s(`DB-feil ved bekreft`,`error`),!1):(await r(),!0)}export{ye as render};