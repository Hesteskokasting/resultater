import{n as e,t}from"./logError-CTQ3euge.js";import{t as n}from"./escHtml-CfOHO0aD.js";import{An as r,En as i,Fn as a,In as o,Mt as s,Rn as c,Tt as l,Un as u,Vt as d,Yn as f,Yt as p,Zn as m,bt as h,h as g,hr as _,it as v,kn as y,kt as b,m as x,mn as S,mr as C,u as w}from"./index-Bj8YGowA.js";import{S as T,_ as E,b as D,g as O,n as k,o as A,r as j,t as M,w as N}from"./kampService-Dl7Ruzf_.js";import{t as P}from"./realtime-CtSjZAnf.js";import{t as F}from"./groupBy-Bg_SEHjk.js";import{t as I}from"./ScoreboardButton-cO_q_Bk1.js";import{a as ee,l as te,n as ne,r as re}from"./stevne-BGy95bVa.js";import{a as L,i as R,n as z,o as ie,r as B,s as V,t as ae}from"./ScoreEditor-CeOeDOCr.js";import{C as oe,D as se,E as ce,O as le,S as ue,T as de,_ as fe,b as pe,g as me,k as H,v as he,x as ge,y as _e}from"./padInput-abWEuyWi.js";function U(e,{showPlayerList:t=!0,initNa:n=null,initFormat:r=null}={}){let i=typeof e==`number`?e:e.length,a=typeof e==`number`?[]:e.map((e,t)=>({...e,cupPlassering:t+1})),o=L(i),s=n===i?i:n!=null&&o.some(e=>e.nA===n)?n:o[0]?.nA??i,c=i-s,l=o.filter(e=>V(e.nA).some(e=>e.c3>0)),u=o.filter(e=>!V(e.nA).some(e=>e.c3>0)),d=V(i).length>0,f=(e,t)=>e.map((e,r)=>{let a=e.nA===s&&n!==i,o=t+r;return`
