import{t as e}from"./logError-DFCPgUum.js";import{$ as t,ct as n,dt as r,ht as i,lt as a,ot as o,st as s,tt as c,ut as l}from"./index-DUX4qgVd.js";import{t as u}from"./LoadingState-Ps7fTB_T.js";import{t as d}from"./EmptyState-DJibJB-o.js";import{t as f}from"./Table-BmSR2ayy.js";import{t as p}from"./expandableRows-CT17yEcT.js";var m=2007,h=2024,g={year:new Date().getFullYear(),cupType:`NC`,classNum:1,view:`singel`},_={year:null,rules:null,tournaments:[],results:[]};async function v(t){if(_.year===t)return!0;try{let[{data:e,error:r},{stevner:i,resultater:a,error:o}]=await Promise.all([s(t),n(t)]);return r||o?!1:(_.year=t,_.rules=e,_.tournaments=i,_.results=a,!0)}catch(t){return e(`fetchAndBufferData`,t),!1}}function y(e,t){return t===`SNC`?`Dei ${e.max_snc} beste SNC-stevna er teljande`:t===`DNC`?`Dei ${e.max_dnc} beste DNC-stevna er teljande`:`Dei ${e.maxtotal} beste stevna, herav maks ${e.max_nc_total} NC-stevner og ${e.max_snc_total} SNC-stevner er teljande`}function b(e){return`
    ...
    <div class="content-page">
      ...
      <div id="nc-content"></div>
        ...
        </section>`;let e=c.querySelector(`#nc-team-table-container`);if(!s)e.replaceChildren(d(`Ingen data.`));else{let t=l(_.results,_.tournaments,s);e.replaceChildren(w(t)),p(e,{triggerSel:`.nc-team-points-cell`,idAttr:`team-idx`,detailSel:`.nc-team-detail-row`,lookupRoot:c})}}else{c.innerHTML=`
        <section id="nc-single-section">
          <h2 class="nc-section-title">${r} Singel ${t} - Klasse ${i}</h2>
