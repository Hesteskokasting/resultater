import{n as e,t}from"./logError-D5z16FyH.js";import{C as n,Ct as r,St as i,T as a,_t as o,bt as s,et as c,m as l,pt as u,vt as d,w as f,wt as p}from"./index-BErz4npm.js";import{t as m}from"./LoadingState-BWi0wPLz.js";import{C as h,N as g,O as _,T as v,a as y,c as b,i as x,t as S,v as C,y as w}from"./kampService-CnBu9jM9.js";import{n as T}from"./navigation-BZAaZHac.js";import{C as E,D,E as O,O as k,S as ee,T as A,_ as te,b as j,g as ne,h as M,l as re,m as ie,o as N,p as P,s as ae,v as oe,x as F}from"./omgangValidation-BgUa1-eP.js";import{l as I,m as se}from"./xkastKongelagService-DQu2ncw1.js";import{n as L}from"./ScoreNumberpad-DWi0VLIH.js";import{t as ce}from"./scoreEditor-BHL4AFbo.js";function R(e){let t=[...e];for(let e=t.length-1;e>0;e--){let n=Math.floor(Math.random()*(e+1));[t[e],t[n]]=[t[n],t[e]]}return t}function z(e){return e===2||e===4?!0:e<2?!1:e%3==0?z(Math.floor(e/3)*2):e%2==0?z(e/2):!1}function B(e){return e%3==0?{c3:e/3,c2:0}:e%2==0?{c3:0,c2:e/2}:{c3:0,c2:0}}function V(e){if(e<2)return[];let t=[],n=Math.floor(e/2);for(let r=e%3;r<=n&&r<=3&&t.filter(e=>e.c2===0).length<2;r+=3){let n=(e-r)/3;if(n<1)break;z(r+2*n)&&t.push({walkovers:r,c3:n,c2:0})}for(let r=e%2;r<=n&&r<=3&&t.filter(e=>e.c3===0).length<2;r+=2){let n=(e-r)/2;if(n<1)break;let i=r+n;!t.some(e=>e.walkovers===r&&e.c3===0&&e.c2===n)&&z(i)&&t.push({walkovers:r,c3:0,c2:n})}return t.sort((e,t)=>e.walkovers-t.walkovers||t.c3-e.c3),t}function H(e){return e===2?!0:V(e).length>0}function le(e){let t=Math.ceil(e*.5),n=Math.round(e*.8),r=[];for(let i=n;i>=t;i--){let t=e-i;t>=2&&H(i)&&H(t)&&r.push({nA:i,nB:t})}return r}function ue(e,{runde1:t=null,walkovers1:n=null}={}){let r=[],i=e,a=1,o=!0;for(;i>2;){let e,s,c;if(o){let r=t;!r&&n!==null&&(r={walkovers:n,c3:Math.floor((i-n)/3),c2:0}),r||=V(i)[0]??{walkovers:i%3,c3:Math.floor(i/3),c2:0},c=r.walkovers,e=r.c3,s=r.c2,o=!1}else{let t=B(i);e=t.c3,s=t.c2,c=0}let l=e*2+s+c;r.push({runde:a,players:i,lanes:e+s,threePlayers:e>0,walkovers:c,advancing:l}),i=l,a++}return r}function U(e,{medSeeding:t=!0,isRunde1:n=!1,walkoverTall:r=null,runde1Oppsett:i=null,shuffleFn:a}={}){let o=a??R,s=[],c=[...e];if(n){let e=i?.walkovers??r??c.length%3;if(e>0){let t=c.slice(0,e);c=c.slice(e);for(let e of t)s.push({players:[e.kasterid],isWalkover:!0,isThreePlayers:!1})}}let l=c.length,u,d;if(i&&n)u=i.c3,d=i.c2;else if(n)u=Math.floor(l/3),d=0;else{let e=B(l);u=e.c3,d=e.c2}let f=u+d;if(t&&f>0){let e=o(c.slice(0,f)),t=o(c.slice(f,2*f)),n=o(c.slice(2*f)),r=0;for(let i=0;i<f;i++){let a=i<u,o=[e[i],t[i]].filter(e=>e!=null),c=a?n[r]:void 0;c&&(o.push(c),r++),s.push({players:o.map(e=>e.kasterid),isWalkover:!1,isThreePlayers:a})}}else{let e=o(c),t=0;for(let n=0;n<u;n++)s.push({players:e.slice(t,t+3).map(e=>e.kasterid),isWalkover:!1,isThreePlayers:!0}),t+=3;for(let n=0;n<d;n++)s.push({players:e.slice(t,t+2).map(e=>e.kasterid),isWalkover:!1,isThreePlayers:!1}),t+=2}return s}function W(e,{showPlayerList:t=!0,initNa:n=null,initFormat:r=null}={}){let i=typeof e==`number`?e:e.length,a=typeof e==`number`?[]:e.map((e,t)=>({...e,cupPlassering:t+1})),o=le(i),s=n===i?i:n!=null&&o.some(e=>e.nA===n)?n:o[0]?.nA??i,c=i-s,l=o.filter(e=>V(e.nA).some(e=>e.c3>0)),u=o.filter(e=>!V(e.nA).some(e=>e.c3>0)),d=V(i).length>0,f=(e,t)=>e.map((e,r)=>{let a=e.nA===s&&n!==i,o=t+r;return`
  ...
  `}function G(e,t,n=0,i=0){let a=e.slice(0,t),o=e.slice(t),s=e.some(e=>e.poeng_xkast!=null);function c(e,t=0){return e.map((e,n)=>{let i=n<t,a=s?e.antall_ring_xkast??0:e.kamp_poeng??0,o=s?e.poeng_xkast??0:e.score_poeng??0;return`
      <tr>
    ...
    <td class="${u}"${d}>${a}</td>
        ...
        <td colspan="2">${k(t[0]??null,!1)} <span class="badge bg-secondary">Walkover</span></td>
          ...
          </tr>`}function Ne(e,t,n,r=!0){let a=Ee(e,t,n),o=e.er_bekreftet||e.er_walkover,s=e.spelarar.some(e=>(e.omgangar?.length??0)>0),c={isConfirmed:o,hasRounds:s,canEditScore:r&&e.er_bekreftet&&!e.er_tre_spelarar&&!s,isThreeSides:e.er_tre_spelarar},l=r?Me(e,o,je(e,a,s,o)):``;return`
    ...
    </div>`}function Pe(e,n,r,i,a,o,s){M(e);for(let c of r){let r=Ee(c,o,s),l=r[0]??null,u=r[1]??null,d=l?.rep??null,p=u?.rep??null,m=k(l,!1),g=k(u,!1),_=r.flatMap(e=>e.members.map(e=>e.id)),y=async(e,n)=>{let r=[];d?.id&&r.push(h(d.id,e)),p?.id&&r.push(h(p.id,n));for(let e of[l,u])for(let t of e?.members.slice(1)??[])r.push(h(t.id,0));try{return(await Promise.all(r)).find(e=>e.error)??null}catch(e){return t(`cup:writeSideScore`,e),{error:e}}};if(e.querySelector(`#plus-${c.id}`)?.addEventListener(`click`,()=>{ce({side1Name:m,side2Name:g,currentS1:Q(l),currentS2:Q(u),playerIds:_,hasRounds:c.spelarar.some(e=>(e.omgangar?.length??0)>0),logPrefix:`cup`,onSave:y,onSaved:a})}),e.querySelector(`#bekrft-${c.id}`)?.addEventListener(`click`,async e=>{if(c.er_tre_spelarar)xe(c,r,n,a);else{let t=e.currentTarget;t.disabled=!0,t.textContent=`Lagrer…`;try{await Fe(n,c,r,a)||(t.disabled=!1,t.textContent=`Bekreft`)}catch{t.disabled=!1,t.textContent=`Bekreft`}}}),i&&c.er_bekreftet&&!c.er_tre_spelarar){let t=r.flatMap(e=>e.members.map(e=>e.kasterid)),i=()=>{L([{name:m,score:Q(l)},{name:g,score:Q(u)}],async([e=0,r=0])=>{if(_.length){let{error:e}=await x(_);if(e){f(`DB-feil ved sletting av omgangar`,`error`);return}}if(await y(e,r)){f(`DB-feil ved oppdatering av score`,`error`);return}let i=e>=r?l:u,o=e>=r?u:l,s=i?.members.map(e=>e.kasterid)??[],d=o?.members.map(e=>e.kasterid)??[],p=[...s.map(e=>({kasterid:e,plassering:1})),...d.map(e=>({kasterid:e,plassering:2}))],{error:m}=await C(c.id,p);if(m){f(`DB-feil ved oppdatering av plassering`,`error`);return}await v({stevneId:n,roundNumber:c.runde_nummer,roundName:c.runde_navn,allThrowerIds:t,newWinnerIds:s,newLoserIds:d}),await a()})};e.querySelectorAll(`[data-endre-score="${c.id}"]`).forEach(e=>e.addEventListener(`click`,i))}}}async function Fe(e,t,n,r){let i=n[0]??null,o=n[1]??null,{data:s}=await b(t.id),c=e=>e?.members.reduce((e,t)=>e+g(s.find(e=>e.id===t.id)??t),0)??0,l=c(i),u=c(o);if(l===0&&u===0&&!await a({title:`Ingen score registrert`,message:`Vil du bekrefte kampen likevel?`}))return!1;let d=l>=u?i:o,p=l>=u?o:i,m=n.flatMap(e=>e.members.map(e=>e.kasterid)),{error:h}=await S({kampId:t.id,stevneId:e,roundNumber:t.runde_nummer,roundName:t.runde_navn,allThrowerIds:m,eliminatedIds:p?.members.map(e=>e.kasterid)??[],advancingSides:d?[d.members.map(e=>e.kasterid)]:[]});return h?(f(`DB-feil ved bekreft`,`error`),!1):(await r(),!0)}export{De as render};