import{t as e}from"./logError-ByTg738k.js";import{S as t,b as n,dr as r,f as i,fr as a,i as o,ur as s,y as c}from"./index-BzkBRoPl.js";import{a as l,n as u,r as d}from"./klubbService-pPakrKDt.js";import{o as f,r as p}from"./kasterService-BN8H2rLx.js";import{t as m}from"./SearchInput-CDoDGwhR.js";import{t as h}from"./AdminLinkBar-BpzUqV5t.js";import{t as g}from"./Table-B_UMcRWp.js";function _(e){let n=new Map;for(let r of e){if(!r.klubb?.id)continue;let e=t(r).toLowerCase(),i=n.get(r.klubb.id);i?i.push(e):n.set(r.klubb.id,[e])}return n}function v(e,t,n){let r=n.trim().toLowerCase();return r?e.filter(e=>e.navn.toLowerCase().includes(r)||(t.get(e.id)??[]).some(e=>e.includes(r))):e}function y(e,n){let r=n.trim().toLowerCase();return r?e.filter(e=>t(e).toLowerCase().includes(r)):e}var b={searchText:``};function x(e,t){return`
    ...
    </div>`}function D(){return w.showAll?u():l()}async function O(t){t.replaceChildren(a(`Laster klubbar...`));try{let[{data:e,error:n},{data:i}]=await Promise.all([D(),p()]);if(n){t.replaceChildren(r(`Kunne ikkje laste klubbar.`));return}let a=_(i);t.innerHTML=E();let o=e,s=t.querySelector(`#club-grid`),c=t.querySelector(`#club-active-only`);function l(){let e=v(o,a,w.searchText);s.innerHTML=e.length?e.map(e=>T(e)).join(``):`<p class="empty-state">Ingen klubbar funnet.</p>`}m({slot:t.querySelector(`#club-search-slot`),placeholder:`Søk på klubbnavn eller utøvar`,state:w,onInput:l}),l(),c.addEventListener(`change`,async()=>{w.showAll=!c.checked;let{data:e,error:t}=await D();t||(o=e),l()}),h(t,{href:`#/klubber/ny`,label:`+ Ny klubb`,variant:`success`,canShow:e=>e.profil?.role===`admin`})}catch(n){e(`klubber.renderList`,n),t.replaceChildren(r(`Kunne ikkje laste klubbar.`))}}var k=async(e,t)=>{t.id?await C(e,Number(t.id)):await O(e)};export{k as render};