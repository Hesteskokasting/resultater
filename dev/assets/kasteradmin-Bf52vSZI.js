import{t as e}from"./logError-D5z16FyH.js";import{Ct as t,O as n,St as r,k as i,w as a}from"./index-_Sbv_Pyg.js";import{i as o,n as s,r as c,t as l}from"./adminForms-BgTw4KBl.js";import{r as u}from"./klubbService-CaXvOdL5.js";import{a as d,l as f,n as p,p as m,s as h,t as g}from"./kasterService-B3gLOC11.js";import{t as _}from"./LoadingState-BWi0wPLz.js";import{t as v}from"./buildDropdownOptions-BuszUz0k.js";import{t as y}from"./formNum-DDzUPdUs.js";async function b(b,x={}){let S=x.id===void 0?void 0:Number(x.id);b.replaceChildren(_());let C=[],w=[],T=[];try{let e=await Promise.all([u(),d(),h()]);C=e[0].data,w=e[1].data,T=e[2].data}catch(n){e(`kasteradmin.render`,n),b.replaceChildren(t(`Kunne ikkje laste skjema.`));return}let E=null;if(S){let{data:e,error:r}=await f(S);if(r||!e){b.replaceChildren(t(`Utøvar ikkje funne.`));return}if(E=e,!await n()&&!await i(E.klubbid??void 0)){b.replaceChildren(t(`Ingen tilgang til denne utøvaren.`));return}}let D=S?`Rediger utøvar: ${E?`${r(E.fornavn)} ${r(E.etternavn)}`:``}`:`Ny utøvar`,O=E??{};b.innerHTML=`
