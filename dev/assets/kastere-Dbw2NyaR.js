...
import{t as e}from"./logError-BO7RC_Nh.js";import{Bt as t,Ft as n,Nt as r,Wt as i,a,r as o}from"./index-z7iEevWR.js";import{i as s,l as c,r as l}from"./kasterService-BMY5rO_4.js";import{t as u}from"./LoadingState-C6NB62Ct.js";import{t as d}from"./EmptyState-CCNgsnix.js";import{t as f}from"./SearchInput-BwD50MFz.js";import{n as p,r as m}from"./kaster-CGWDYFbf.js";import{t as h}from"./AdminLinkBar-BkDP_THQ.js";var g=24,_=`https://placehold.co/200x200/444/888?text=?`,v={showAll:!1,searchText:``,page:1};function y(e){let t=m(e);return`
    <a href="#/kastere/${p(e)}" class="thrower-card">
    ...
    </div>`}function R(e,t,n){return t==null?``:`<span class="kd-round-chip">${e} ${n==null?`${t}`:`${t} (${n})`}</span>`}function z(e,t){return`<span class="kd-sort-icon${e?` kd-sort-icon--active`:``}" aria-hidden="true">${e?t===`asc`?`↑`:`↓`:`↕`}</span>`}function B(e,t,n){let r=n.column===e,i=n.direction===`asc`?`stigande`:`synkande`,a=r?`Sortert etter ${t}, ${i}. Vel for å snu.`:`Sorter etter ${t}`;return`<button type="button" class="kd-sort-btn${r?` kd-sort-btn--active`:``}" data-sort="${e}" aria-pressed="${r}" aria-label="${a}">${t}${z(r,n.direction)}</button>`}function V(e,t,r,i){let o=e;t!==`alle`&&(o=o.filter(e=>String(T(e.stevne?.dato))===t)),r!==`alle`&&(o=o.filter(e=>String(e.stevne?.stevnetype?.id)===r));let s=o.length,c=`
    ...
    <div class="kd-res-head">
    ...
    </div>`,u=D(o,i).map(e=>{let t=e.stevne,r=t?.id?`<a href="#/stevne/${t.id}/resultat" class="kd-res-row__name">${a(t.navn??``)}</a>`:`<span class="kd-res-row__name">${a(t?.navn??`–`)}</span>`,i=R(`X-kast`,e.poeng_xkast,e.antall_ring_xkast)+R(`Kongelag`,e.poeng_kongelag,e.antall_ring_kongelag),o=e.plassering==null?`<span class="kd-res-row__pl kd-res-row__pl--empty">–</span>`:`<span class="kd-res-row__pl">${e.plassering}</span>`;return`
      <div class="kd-res-row">
        ...
        ${o}
      </div>`}).join(``);return c+l+`<div class="kd-res-list">${u}</div>`}function H(e,n){let r=k(e),i=A(e,n.klubb?.id??null);return`
