import{t as e}from"./logError-BO7RC_Nh.js";import{D as t,M as n,a as r,j as i,wt as a}from"./index-BOGgiIrf.js";import{i as o,n as s,r as c,t as l}from"./adminForms-CWyQ7dys.js";import{r as u}from"./klubbService-BRsJvfyR.js";import{a as d,l as f,n as p,p as m,s as h,t as g}from"./kasterService-CNRTXiz_.js";import{t as _}from"./LoadingState-C6NB62Ct.js";import{t as v}from"./buildDropdownOptions-BO1_8OQD.js";import{t as y}from"./formNum-HGeagI_O.js";async function b(b,x={}){let S=x.id===void 0?void 0:Number(x.id);b.replaceChildren(_());let C=[],w=[],T=[];try{let e=await Promise.all([u(),d(),h()]);C=e[0].data,w=e[1].data,T=e[2].data}catch(t){e(`kasteradmin.render`,t),b.replaceChildren(a(`Kunne ikkje laste skjema.`));return}let E=null;if(S){let{data:e,error:t}=await f(S);if(t||!e){b.replaceChildren(a(`Utøvar ikkje funne.`));return}if(E=e,!await i()&&!await n(E.klubbid??void 0)){b.replaceChildren(a(`Ingen tilgang til denne utøvaren.`));return}}let D=S?`Rediger utøvar: ${E?`${r(E.fornavn)} ${r(E.etternavn)}`:``}`:`Ny utøvar`,O=E??{};b.innerHTML=`
