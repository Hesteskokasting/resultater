import{t as e}from"./logError-BO7RC_Nh.js";import{B as t,Dt as n,G as r,H as i,J as a,K as o,U as s,V as c,W as l,a as u,ct as d,i as f,q as p,t as m}from"./index-BOGgiIrf.js";import{t as h}from"./adminForms-CWyQ7dys.js";import{r as g}from"./klubbService-BRsJvfyR.js";import{d as _}from"./kasterService-CNRTXiz_.js";import{r as v}from"./kaster-CGWDYFbf.js";import{t as y}from"./LoadingState-C6NB62Ct.js";import{t as b}from"./EmptyState-CCNgsnix.js";var x=[`links`,`users`,`club-admin`],S={links:`Koblingforespørslar`,users:`Brukarar`,"club-admin":`Klubbadmin-tilgang`};function C(e){let t=e.stevne_fase===`avsluttende`?`avsluttende`:`innledende`;return f({title:e.navn,href:`#/stevne/${e.id}/${t}`,date:n(e.dato),status:`live`})}function w(e){let t=document.createElement(`div`);return t.className=`stevne-kort-liste`,e.forEach(e=>t.appendChild(e)),t}async function T(e){e.innerHTML=`
