const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/gloppen-C9vvH4uC.js","assets/index-CT9_SLr0.js","assets/vendor-3yxEHqvy.js","assets/rolldown-runtime-lhHHWwHU.js","assets/index-BvF18F-H.css","assets/innledendeBase-ZAcuJA9r.js","assets/ConfirmDialog-DNGrXiEY.js","assets/LivePill-C1AxE8Dw.js","assets/LoadingState-RVZNML7E.js","assets/resultatService-C7WXhC4V.js","assets/Table-BBE7tcG_.js","assets/kamp-Bpd8LcU6.js","assets/kampService-DVPnG528.js","assets/testDataService-BjBH7Z9u.js","assets/realtime-N__YnKU4.js","assets/nordhordland-BTzJRpIv.js","assets/kampGenereringInnledendeService-CqH0JOzr.js","assets/xkast-ByjmQ3Qw.js","assets/cup-CCfdK3AC.js","assets/kampGenereringCupService-CFvRQwAl.js","assets/pameldingService-C5JYfWd8.js","assets/kongelag-CikEvgXn.js","assets/nordhordland-BUQng5p3.js"])))=>i.map(i=>d[i]);
import{$ as e,C as t,G as n,L as r,M as i,N as a,R as o,S as s,U as c,W as l,Y as u,Z as d,_ as f,i as p,lt as m,n as h,nt as g,r as _,rt as v,st as y,t as b,y as x}from"./index-CT9_SLr0.js";import{o as S}from"./kasterService-BqK4cCl3.js";import{t as C}from"./LoadingState-RVZNML7E.js";import{t as w}from"./EmptyState-a5aDhc-8.js";import{t as T}from"./ConfirmDialog-DNGrXiEY.js";import{t as E}from"./realtime-N__YnKU4.js";import{t as D}from"./Tabs-6YId7vWj.js";import{a as O,f as k,i as A,l as ee,p as te,r as j,s as M,t as ne,u as N}from"./pameldingService-C5JYfWd8.js";import{a as P,o as F}from"./resultatService-C7WXhC4V.js";import{t as I}from"./kampGenereringInnledendeService-CqH0JOzr.js";import{n as re}from"./testDataService-BjBH7Z9u.js";function L(e){if(e instanceof Error)return e.message;if(typeof e==`object`&&e&&`message`in e){let t=e.message;if(typeof t==`string`)return t}return String(e)}async function R(e,{id:t,isAdmin:i=!1},a=null){e.replaceChildren(C());try{let[o,c,f]=await Promise.all([s(t),A(t),p()]);if(o.error||!o.data){e.replaceChildren(n(`Stevne ikkje funne.`));return}let m=o.data,h=m.stevne_fase??null,g=h===null||h===`ikke_startet`,_=m.kastemetodeInnl?.navn??`—`,v=_.toLowerCase().includes(`gloppen`),y=m.kategori?.erlagbasert??!1;if(a&&g&&i){a.innerHTML=`<button id="start-stevne-btn" class="btn btn-sm btn-success">Start stevne</button>`;let e=a.querySelector(`#start-stevne-btn`);e.addEventListener(`click`,async()=>{if(y?c<4:c<2){b(y?`Stevnet treng minst 2 par (4 spelarar) for å startast.`:`Stevnet må ha minst 2 spelarar for å startast.`,`error`);return}if(v&&!m.antall_runder_innl){b(`Du må setje antal rundar for innledande fase. Gå til Innstillingar for å endre.`,`error`);return}let n=await O(t);if(n>0&&!await T({title:`Ubekrefta spelarar`,message:`${n} spelar(ar) er ikkje bekrefta. Vil du starte stevnet likevel?`}))return;e.disabled=!0,e.textContent=`Starter…`;try{await I(t,_,m.antall_runder_innl??1,y)}catch(t){b(`Feil ved kampgenerering: `+L(t),`error`),e.disabled=!1,e.textContent=`Start stevne`;return}let{error:i}=await r(t,`innledende`);if(i){b(`Feil ved oppdatering av fase.`,`error`),e.disabled=!1,e.textContent=`Start stevne`;return}location.hash=`#/stevne/${t}/innledende`})}e.innerHTML=`
