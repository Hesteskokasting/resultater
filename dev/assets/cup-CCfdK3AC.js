import{B as e,D as t,G as n,L as r,V as i,W as a,b as o,nt as s,t as c}from"./index-CT9_SLr0.js";import{t as l}from"./LoadingState-RVZNML7E.js";import{t as u}from"./ConfirmDialog-DNGrXiEY.js";import{r as d,s as f}from"./kamp-Bpd8LcU6.js";import{C as p,S as m,a as h,b as g,f as _,n as v,s as y,x as b,y as x}from"./kampService-DVPnG528.js";import{t as S}from"./realtime-N__YnKU4.js";import{a as C,i as w,n as T,o as E,r as D,s as O}from"./kampGenereringCupService-CFvRQwAl.js";import{l as k}from"./pameldingService-C5JYfWd8.js";import{S as A,_ as j,b as M,c as N,d as P,f as F,g as I,h as ee,l as te,n as L,p as R,r as z,t as B,u as V,v as H,x as U}from"./resultatService-C7WXhC4V.js";import{n as W,t as G}from"./LivePill-C1AxE8Dw.js";function K(e,{visSpelarliste:t=!0,initNa:n=null,initFormat:r=null}={}){let i=typeof e==`number`?e:e.length,a=typeof e==`number`?[]:e.map((e,t)=>({...e,cupPlassering:t+1})),o=E(i),s=n===i?i:n!=null&&o.some(e=>e.nA===n)?n:o[0]?.nA??i,c=i-s,l=o.filter(e=>O(e.nA).some(e=>e.c3>0)),u=o.filter(e=>!O(e.nA).some(e=>e.c3>0)),d=O(i).length>0,f=(e,t)=>e.map((e,r)=>{let a=e.nA===s&&n!==i,o=t+r;return`
      ...
      </div>`));let m=p.join(``),h=r?.A??O(s)[0]??null,g=c>=2?r?.B??O(c)[0]??null:null,_=t?`<div id="gruppe-preview">${q(a,s,h?.walkovers??0,g?.walkovers??0)}</div>`:``;return`
  ...
  `}function q(e,t,n=0,r=0){let i=e.slice(0,t),o=e.slice(t);function s(e,t=0){return e.map((e,n)=>{let r=n<t;return`
      <tr>
    ...
    </div>`}function ne(e){let t=e.c3>0?3:2;return`${e.walkovers} walkover - ${t} deltakere per bane`}function re(e,t,n,r=null){let i=O(t);return i.length<=1?``:`<div class="d-flex flex-column align-items-start gap-1 mb-2">${i.map((e,t)=>{let i=`${n}-${t}`,a=JSON.stringify(e),o=r?e.walkovers===r.walkovers&&e.c3===r.c3&&e.c2===r.c2:t===0,s=e.c3>0?`btn-outline-success`:`btn-outline-warning`;return`
      <input type="radio" class="btn-check" name="${n}" id="${i}"
        value='${a}' data-oppsett='${a}' autocomplete="off" ${o?`checked`:``}>
      <label class="btn btn-sm ${s}" for="${i}">${ne(e)}</label>`}).join(``)}</div>`}function J(e,t,n){return`<div id="struktur-${n}">
  ...
  </div>`}function Y(e,t,n,r){let i=n.slice(-1),a=re(e,t,n,r);return`
    <div class="card">
      <div class="card-body">
    ...
    `,o.querySelector(`#avbryt-tre-btn`).addEventListener(`click`,()=>o.remove()),o.querySelectorAll(`[data-kasterid]`).forEach(e=>{e.addEventListener(`click`,()=>{let t=Number(e.dataset.kasterid),n=a.indexOf(t);n===-1?a.length<2&&a.push(t):a.splice(n,1),s()})}),o.querySelector(`#bekreft-tre-btn`)?.addEventListener(`click`,async()=>{if(a.length!==2)return;let i=t.find(e=>!a.includes(e.rep.kasterid))??null,s=a.map(e=>t.find(t=>t.rep.kasterid===e)).filter(e=>e!=null).map(e=>e.members.map(e=>e.kasterid)),l=t.flatMap(e=>e.members.map(e=>e.kasterid));o.remove();let{error:u}=await v({kampId:e.id,stevneId:n,rundeNummer:e.runde_nummer,rundeNavn:e.runde_navn,allKasterids:l,eliminertIds:i?.members.map(e=>e.kasterid)??[],vidareSider:s});if(u){c(`DB-feil ved bekreft`,`error`);return}await r()})}s()}function oe(e){return typeof e!=`object`||!e||Array.isArray(e)?null:e}function se(e){return e.map(e=>({er_bekreftet:e.er_bekreftet,er_walkover:e.er_walkover,runde_nummer:e.runde_nummer,bane_nummer:e.bane_nummer,spelarar:ce(e.spelarar)}))}function ce(e){return e.map(e=>({kasterid:e.kasterid??0,kamp_poeng:e.kamp_poeng??0,score_poeng:e.score_poeng??0,antall_ringer:e.antall_ringer,omgangar:e.omgangar,kaster:e.kaster}))}function le(e){let r=null,a=null,d=!1,f=new Set;async function m(e,{id:t,isAdmin:n=!1},i=null){a=i,d=n,r&&=(await S(r),null),e.replaceChildren(l(`Laster…`)),await h(e,t)}async function h(r,l){try{let[{data:s},{data:p},{data:m},{data:_},{count:v}]=await Promise.all([o(l),y(l),z(l),L([`A`,`B`]),t(l)]);if(!s){r.replaceChildren(n(`Stevne ikkje funne.`));return}let b=m.filter(e=>e.kasterid!=null),x=p.filter(e=>e.fase===`innledende`),S=p.filter(e=>e.fase===`avsluttende`),C={},w={},T=new Map;for(let e of b)e.startnummer!=null&&(C[e.kasterid]=e.startnummer,T.set(e.startnummer,(T.get(e.startnummer)??0)+1)),e.posisjon!=null&&(w[e.kasterid]=e.posisjon);let E=[...T.values()].some(e=>e>1),D={};for(let e of p)for(let t of e.spelarar)t.kasterid&&t.kaster&&!D[t.kasterid]&&(D[t.kasterid]=`${t.kaster.fornavn} ${t.kaster.etternavn}`);let O=se(x),A=R(O,b,D,C,w),N=x.length>0&&x.every(e=>e.er_bekreftet),I=S.length>0,B=b.some(e=>e.gruppe!=null),V=Object.fromEntries(_.map(e=>[e.navn,e.id])),W=oe(s.runde1_format),G=v??0;if(s.kategori?.erlagbasert){let{data:e}=await k(l);G=e.length}let K={container:r,stevneid:l,stevne:s,stilling:A,startnrMap:C,posisjonMap:w,erLag:E,navnMap:D,innlKampar:x,avslKampar:S,resultat:b,isAdmin:d,harGruppefordeling:B,alleInnlBekrefta:N,harAvslKampar:I,runde1Format:W,unitCount:G,gruppeNavnMap:V,reload:()=>h(r,l)};d&&a&&(a.innerHTML=j(s,{alleInnlBekrefta:N,harAvslKampar:I,harGruppefordeling:B,harPrekonfigurertFormat:W!=null&&s.stevne_fase!==`avsluttende`}));let q=ee(r);if(B){let t=M(A,O,C,{tableId:`stilling-avsl`,harGrupper:!0,harEliminasjon:!0,posisjonMap:w,unitLabel:E?`par`:`spelarar`});r.innerHTML=H(e.renderKamparHtml(K),t),P(r,`stilling-avsl`,f),F(r),q===`stilling`&&U(r,`stilling`),e.bindKamparEvents(r,K),g(r,l)}else r.innerHTML=e.renderSetupHtml(K);a?.querySelector(`#fullfør-turnering-btn`)?.addEventListener(`click`,async()=>{if(!await u({title:`Fullfør turnering`,message:`Vil du fullføre turneringa? Dette kan ikkje angrast.`,danger:!0}))return;let{error:e}=await te(l,[...A.filter(e=>e.gruppe?.navn===`A`),...A.filter(e=>e.gruppe?.navn===`B`),...A.filter(e=>e.gruppe?.navn!==`A`&&e.gruppe?.navn!==`B`)]);if(e){c(`Feil ved lagring av plasseringar`,`error`);return}let{error:t}=await i(l);if(t){c(`Feil ved fullføring av turnering`,`error`);return}await h(r,l)}),e.bindHeaderEvents(a,K)}catch(e){s(`avsluttendeBase.lastOgVis`,e),r.replaceChildren(n(`Kunne ikkje laste avsluttande fase.`))}}function g(t,n){if(r)return;let i=I(n,[`avsluttende`],t,h,()=>{r&&=(S(r),null)});r=p(n,e.channelName(n),i)}return m}function X(e,t,n){return d(e.spelarar.filter(e=>e.kasterid!=null),t,n)}function Z(e){return e?.members.reduce((e,t)=>e+f(t),0)??0}var ue=le({channelName:e=>`stevne-avsl-cup-${e}`,renderKamparHtml:e=>{let{avslKampar:t,stilling:n,startnrMap:r,posisjonMap:i,erLag:a,isAdmin:o}=e;return`<div class="d-flex gap-3 flex-wrap">${[...new Set(n.map(e=>e.gruppe?.navn).filter(e=>e!=null))].sort().map(e=>{let s=t.filter(t=>t.gruppe_navn===e),c=n.filter(t=>t.gruppe?.navn===e),l=c.filter(e=>e.runde_eliminert==null).length,u=c.length,d=s.length?Math.max(...s.map(e=>e.runde_nummer)):0,f=s.filter(e=>e.runde_nummer===d),p=f.length>0&&f.every(e=>e.er_bekreftet||e.er_walkover),m=s.some(e=>e.runde_navn===`Semifinale`);return de(e,s,l,u,d,o&&(s.length===0||p)&&l>1&&!m,r,i,a?`par`:`spelarar`,o)}).join(``)}</div>`},bindKamparEvents:(e,t)=>{!t.isAdmin&&t.avslKampar.length===0||me(e,t.stevneid,t.avslKampar,t.isAdmin,t.reload,t.startnrMap,t.posisjonMap)},renderSetupHtml:e=>{let{stevne:t,isAdmin:n,runde1Format:r,unitCount:i,stilling:a}=e,o=r?.nA??null;if(t.stevne_fase===`avsluttende`)return n?K(a,{visSpelarliste:!0,initNa:o,initFormat:r}):`<p class="text-muted fst-italic">Gruppefordeling er ikkje klar enno.</p>`;if(!n)return``;if(i<2)return`<p class="text-muted fst-italic">${t.kategori?.erlagbasert?`Minst 2 par må vere oppretta før gruppefordelinga kan setjast.`:`Minst 2 spelarar må vere påmelde før gruppefordelinga kan setjast.`}</p>`;let s=a.length>0;return K(s?a:i,{visSpelarliste:s,initNa:o,initFormat:r})},bindHeaderEvents:(t,n)=>{let{container:i,stevneid:a,stevne:o,stilling:s,resultat:l,runde1Format:d,alleInnlBekrefta:f,harGruppefordeling:p,gruppeNavnMap:m,reload:h}=n;if(t?.querySelector(`#start-avsl-btn`)?.addEventListener(`click`,async()=>{if(!f)return;let{error:e}=await r(a,`avsluttende`);if(e){c(`Feil ved oppstart av avsluttande fase`,`error`);return}if(d?.nA!=null){let e=d.nA,{error:t}=await N(a,Q(s,l,e,m.A??null,m.B??null));if(t){c(`Feil ved lagring av gruppefordeling`,`error`);return}}await h()}),!p){let t=parseInt(i.querySelector(`#gruppe-val-wrapper`)?.dataset.n??`0`)||s.length;function n(e,t){let n=i.querySelector(`input[name="${e}"]:checked`);if(n?.dataset.oppsett)try{return JSON.parse(n.dataset.oppsett)}catch{}return O(t)[0]??null}let r=i.querySelector(`#gruppe-paneler`);r&&r.addEventListener(`change`,e=>{let r=e.target;if(!r.matches(`input[name^="runde1-format"]`))return;let a=parseInt(i.querySelector(`input[name="gruppe-split"]:checked`)?.value??String(t)),o=t-a,c=n(`runde1-format-a`,a),l=n(`runde1-format-b`,o);if(r.name===`runde1-format-a`){let e=i.querySelector(`#struktur-a`);e&&(e.outerHTML=J(a,c,`a`))}else{let e=i.querySelector(`#struktur-b`);e&&(e.outerHTML=J(o,l,`b`))}let u=c?.walkovers??0,d=l?.walkovers??0,f=i.querySelector(`#gruppe-preview`);f&&(f.innerHTML=q(s.map((e,t)=>({...e,cupPlassering:t+1})),a,u,d))}),i.querySelectorAll(`input[name="gruppe-split"]`).forEach(e=>{e.addEventListener(`change`,()=>{let n=parseInt(e.value),a=t-n,o=O(n)[0]??null,c=a>=2?O(a)[0]??null:null;r&&(r.innerHTML=`<div id="gruppe-panel-a" class="avsl-gruppe-kol">
                ${Y(`Gruppe A`,n,`runde1-format-a`,o)}
              </div>`+(a>=2?`<div id="gruppe-panel-b" class="avsl-gruppe-kol">
                ${Y(`Gruppe B`,a,`runde1-format-b`,c)}
              </div>`:``));let l=o?.walkovers??0,u=c?.walkovers??0,d=i.querySelector(`#gruppe-preview`);d&&(d.innerHTML=q(s.map((e,t)=>({...e,cupPlassering:t+1})),n,l,u))})}),i.querySelector(`#bekreft-gruppe-btn`)?.addEventListener(`click`,async()=>{let r=i.querySelector(`input[name="gruppe-split"]:checked`);if(!r)return;let u=parseInt(r.value),d=t-u,{error:f}=await e(a,{A:n(`runde1-format-a`,u),B:d>=2?n(`runde1-format-b`,d):null,nA:u});if(f){c(`Feil ved lagring av format`,`error`);return}if(o.stevne_fase===`avsluttende`){let{error:e}=await N(a,Q(s,l,u,m.A??null,m.B??null));if(e){c(`Feil ved lagring av gruppefordeling`,`error`);return}}c(`Gruppefordeling lagra`,`success`),await h()})}t?.querySelector(`#endre-gruppeinndeling-btn`)?.addEventListener(`click`,async()=>{await u({title:`Tilbakestill gruppeinndeling`,message:`Gruppefordeling og format vert fjerna.`,danger:!0})&&(await Promise.all([B(a),e(a,null)]),await h())}),p&&i.querySelectorAll(`[data-generer-gruppe]`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.dataset.genererGruppe??``,n=parseInt(e.dataset.runde??`1`);ie(a,t,s.filter(e=>e.gruppe?.navn===t),n,d,h)})})}});function Q(e,t,n,r,i){return e.flatMap((e,a)=>{let o=a<n?r:i??r,s=e.startnummer==null?[]:t.filter(t=>t.startnummer===e.startnummer).map(e=>e.kasterid);return(s.length?s:[e.kasterid]).map(e=>({kasterid:e,gruppeid:o}))})}function de(e,t,n,r,i,o,s,c,l,u=!0){let d=new Map;for(let e of t)d.has(e.runde_nummer)||d.set(e.runde_nummer,[]),d.get(e.runde_nummer).push(e);let f=[...d.entries()].reverse().map(([e,t])=>{let n=t[0]?.runde_navn??`Runde ${e}`,r=t.filter(e=>!e.er_walkover);return r.length?`
    ...
    <div class="avsl-gruppe-kol">
      ...
      ${m}
      ${f}
    </div>`}function fe(e,t,n,r=!0){let i=X(e,t,n),a=e.er_bekreftet||e.er_walkover,o=e.spelarar.some(e=>(e.omgangar?.length??0)>0),s=o&&!a,c=r&&e.er_bekreftet&&!e.er_tre_spelarar&&!o,l=e.er_walkover?`<tr>
        <td colspan="2">${A(i[0]??null,!1)} <span class="badge bg-secondary">Walkover</span></td>
      </tr>`:i.map(t=>{let n=Z(t),r=n>0||a||o?n:`—`,s=i.length,l=t.rep.kamp_plassering,u=e.er_bekreftet&&l!=null&&l>=s,d=e.er_bekreftet&&l!=null&&l<s,f=u?`kamp-eliminert`:d?`kamp-vidare`:``,p=`text-center fw-semibold avsl-score-cel${c?` score-redigerbar`:``}`,m=c?` data-endre-score="${e.id}"`:``;return`<tr${f?` class="${f}"`:``}>
          <td>${A(t,!1)}</td>
          <td class="${p}"${m}>${r}</td>
        </tr>`}).join(``),u,d,f,p;if(e.er_tre_spelarar)u=a?`btn-secondary`:`btn-outline-secondary`,d=a?`Endre plassering`:`Sett plassering`,f=!1,p=``;else{let t=V(e,pe(i.map(e=>e.rep)),o);u=a?`btn-secondary`:t?`btn-success`:`btn-outline-secondary`,d=a?`Bekreftet`:`Bekreft`,f=a||!t,p=` btn-bekreft`}let m=s?G():``,h=r?`<tr>
