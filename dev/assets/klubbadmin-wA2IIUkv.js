import{G as e,W as t,n,r}from"./index-BFQjj73C.js";import{i,n as a,r as o,t as s}from"./adminForms-DD2Dssyx.js";import{i as c,n as l}from"./klubbService-BKGOeICt.js";import{t as u}from"./LoadingState-RVZNML7E.js";async function d(d,f={}){let p=f.id===void 0?void 0:Number(f.id);if(!p){d.replaceChildren(e(`Manglande ID.`));return}d.replaceChildren(u());let{data:m,error:h}=await l(p);if(h||!m){d.replaceChildren(e(`Klubb ikkje funne.`));return}if(!await n()&&!await r(p)){d.replaceChildren(e(`Ingen tilgang til denne klubben.`));return}d.innerHTML=`
