import{t as e}from"./logError-D5z16FyH.js";import{Dt as t,Ft as n,It as r,Lt as i,Mt as a,Nt as o,Pt as s,Tt as c,Vt as l,wt as u}from"./index-DVHt6_kn.js";import{t as d}from"./LoadingState-BWi0wPLz.js";import{t as f}from"./EmptyState-B1E_7OzB.js";import{t as p}from"./Table-BMdVKjzY.js";import{t as m}from"./expandableRows-Ceb191m9.js";var h=2007,g=2024,_={year:new Date().getFullYear(),cupType:`NC`,classNum:1,view:`singel`},v={year:null,rules:null,tournaments:[],results:[]};async function y(t){if(v.year===t)return!0;try{let[{data:e,error:n},{stevner:r,resultater:i,error:a}]=await Promise.all([o(t),s(t)]);return n||a?!1:(v.year=t,v.rules=e,v.tournaments=r,v.results=i,!0)}catch(t){return e(`fetchAndBufferData`,t),!1}}function b(e,t){return t===`SNC`?`Dei ${e.max_snc} beste SNC-stevna er teljande`:t===`DNC`?`Dei ${e.max_dnc} beste DNC-stevna er teljande`:`Dei ${e.maxtotal} beste stevna, herav maks ${e.max_nc_total} NC-stevner og ${e.max_snc_total} SNC-stevner er teljande`}function x(e){return`
    ...
    </div>`}async function D(e){if(_.year=new Date().getFullYear(),_.cupType=`NC`,_.classNum=1,_.view=`singel`,v={year:null,rules:null,tournaments:[],results:[]},e.replaceChildren(d(`Laster Norgescupen...`)),!await y(_.year)){e.replaceChildren(c(`Kunne ikkje laste data for Norgescupen.`));return}e.innerHTML=E(_.year,_.cupType);function t(){let{year:i,cupType:a,classNum:o,view:s}=_,{rules:c}=v,l=e.querySelector(`#nc-content`);if(e.querySelector(`.nc-main-title`).textContent=`Norgescupen ${i}`,e.querySelector(`#nc-cuptype`).classList.toggle(`d-none`,i<g),e.querySelector(`#nc-view-tabs-container`).innerHTML=a===`NC`?x(s):``,s===`lag`&&a===`NC`){l.innerHTML=`
        <section>
