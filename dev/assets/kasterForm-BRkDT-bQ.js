import{t as e}from"./logError-BO7RC_Nh.js";import{I as t,It as n,L as r,s as i}from"./index-DGqE6WFf.js";import{a,m as o,n as s,s as c,t as l,u}from"./kasterService-BMY5rO_4.js";import{a as d,i as f,n as p,o as m,r as h,s as g,t as _}from"./_formButtons-BaM3QJc6.js";import{t as v}from"./LoadingState-C6NB62Ct.js";import{a as y}from"./klubbService-Haapdsx7.js";import{t as b}from"./buildDropdownOptions-i2h7jtyZ.js";import{t as x}from"./formNum-HGeagI_O.js";async function S(S,C){let{container:w}=S;w.replaceChildren(v());let T=[],E=[],D=[];try{let e=await Promise.all([y(),a(),c()]);T=e[0].data,E=e[1].data,D=e[2].data}catch(t){e(`kasterForm.mount`,t),w.replaceChildren(n(`Kunne ikkje laste skjema.`));return}let O=null;if(C){let{data:e,error:i}=await u(C);if(i||!e){w.replaceChildren(n(`Utøvar ikkje funne.`));return}if(O=e,!await t()&&!await r(O.klubbid??void 0)){w.replaceChildren(n(`Ingen tilgang til denne utøvaren.`));return}}let k=O??{},A=T.map(e=>`<option value="${e.id}"${e.id===k.klubbid?` selected`:``}>${i(e.navn)}</option>`).join(``),{wrapper:j,headingHtml:M}=h(S);j.innerHTML=`
    ${M}
