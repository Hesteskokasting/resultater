const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/gloppen-C7rZjWi2.js","assets/index-C0p0H8n3.js","assets/vendor-3yxEHqvy.js","assets/rolldown-runtime-lhHHWwHU.js","assets/index-gfJxPSuv.css","assets/innledendeBase-b6sjJ5mf.js","assets/ConfirmDialog-DNGrXiEY.js","assets/LivePill-C1AxE8Dw.js","assets/LoadingState-RVZNML7E.js","assets/resultatService-DRYw1ttl.js","assets/Table-BBE7tcG_.js","assets/kamp-CpbenSSn.js","assets/kampService-CtGEy8in.js","assets/testDataService-CVWuPRuq.js","assets/realtime-pHWNok_A.js","assets/nordhordland-lVj8W3Ab.js","assets/kampGenereringInnledendeService-CjhW7KKp.js","assets/xkast-BLWQOG7n.js","assets/cup-BHpP5vkH.js","assets/kampGenereringCupService-BNgzBx7x.js","assets/kongelag-BaWgFVQ1.js","assets/nordhordland-BAptMmLS.js"])))=>i.map(i=>d[i]);
import{$ as e,C as t,G as n,L as r,M as i,N as a,R as o,S as s,U as c,W as l,Y as u,Z as d,_ as f,ct as p,i as m,n as h,nt as g,r as _,rt as v,st as y,t as b,y as x}from"./index-C0p0H8n3.js";import{o as S}from"./kasterService-C2e256Ex.js";import{t as C}from"./LoadingState-RVZNML7E.js";import{t as w}from"./EmptyState-a5aDhc-8.js";import{t as T}from"./ConfirmDialog-DNGrXiEY.js";import{t as E}from"./realtime-pHWNok_A.js";import{a as D,i as O,l as k,r as A,s as ee,t as te}from"./pameldingService-CPclPmDd.js";import{a as ne,o as re}from"./resultatService-DRYw1ttl.js";import{t as j}from"./kampGenereringInnledendeService-CjhW7KKp.js";import{n as M}from"./testDataService-CVWuPRuq.js";async function N(e,{id:t,isAdmin:i=!1},a=null){e.replaceChildren(C());try{let[o,c,f]=await Promise.all([s(t),O(t),m()]);if(o.error||!o.data){e.replaceChildren(n(`Stevne ikkje funne.`));return}let p=o.data,h=p.stevne_fase??null,g=h===null||h===`ikke_startet`,_=p.kastemetodeInnl?.navn??`—`,v=_.toLowerCase().includes(`gloppen`);if(a&&g&&i){a.innerHTML=`<button id="start-stevne-btn" class="btn btn-sm btn-success">Start stevne</button>`;let e=a.querySelector(`#start-stevne-btn`);e.addEventListener(`click`,async()=>{if(c<2){b(`Stevnet må ha minst 2 spelarar for å startast.`,`error`);return}if(v&&!p.antall_runder_innl){b(`Du må setje antal rundar for innledande fase. Gå til Innstillingar for å endre.`,`error`);return}let n=await D(t);if(n>0&&!await T({title:`Ubekrefta spelarar`,message:`${n} spelar(ar) er ikkje bekrefta. Vil du starte stevnet likevel?`}))return;e.disabled=!0,e.textContent=`Starter…`;try{await j(t,_,p.antall_runder_innl??1)}catch(t){b(`Feil ved kampgenerering: `+(t instanceof Error?t.message:String(t)),`error`),e.disabled=!1,e.textContent=`Start stevne`;return}let{error:i}=await r(t,`innledende`);if(i){b(`Feil ved oppdatering av fase.`,`error`),e.disabled=!1,e.textContent=`Start stevne`;return}location.hash=`#/stevne/${t}/innledende`})}e.innerHTML=`
