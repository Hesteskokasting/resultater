import{G as e,W as t,n,nt as r,r as i}from"./index-DBpCd5l1.js";import{i as a,n as o,r as s,t as c}from"./adminForms-C6qxi1YL.js";import{r as l}from"./klubbService-BFP8BUSI.js";import{c as u,d,f,l as p,n as m,p as h}from"./kasterService-8qWFQG3m.js";import{t as g}from"./LoadingState-RVZNML7E.js";import{t as _}from"./ConfirmDialog-DNGrXiEY.js";import{t as v}from"./buildDropdownOptions-Dx3EDoJE.js";import{t as y}from"./formNum-DroYxM0M.js";async function b(b,x={}){let S=x.id===void 0?void 0:Number(x.id);b.replaceChildren(g());let C=[],w=[],T=[];try{let e=await Promise.all([l(),p(),u()]);C=e[0].data,w=e[1].data,T=e[2].data}catch(t){r(`kasteradmin.render`,t),b.replaceChildren(e(`Kunne ikkje laste skjema.`));return}let E=null;if(S){let{data:t,error:r}=await m(S);if(r||!t){b.replaceChildren(e(`Utøvar ikkje funne.`));return}if(E=t,!await n()&&!await i(E.klubbid??void 0)){b.replaceChildren(e(`Ingen tilgang til denne utøvaren.`));return}}let D=S?`Rediger utøvar: ${E?`${t(E.fornavn)} ${t(E.etternavn)}`:``}`:`Ny utøvar`,O=E??{};b.innerHTML=`
