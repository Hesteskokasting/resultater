import{$ as e,A as t,B as n,C as r,D as i,E as a,G as o,H as s,I as c,J as l,K as u,M as d,O as f,P as p,Q as m,R as h,T as g,V as _,X as v,Y as y,Z as b,_ as x,b as S,d as C,et as w,f as T,g as E,h as D,j as O,k,n as A,o as j,p as M,r as N,s as ee,t as P,tt as F,u as I,v as te,w as L,x as R,z}from"./index-qBaQ99pE.js";import{t as B}from"./ScoreNumberpad-C-b3sWkY.js";function V(e,{visSpelarliste:t=!0,initNa:n=null,initFormat:r=null}={}){let a=typeof e==`number`?e:e.length,o=typeof e==`number`?[]:e.map((e,t)=>({...e,cupPlassering:t+1})),s=i(a),c=n===a?a:n!=null&&s.some(e=>e.nA===n)?n:s[0]?.nA??a,l=a-c,u=s.filter(e=>f(e.nA).some(e=>e.c3>0)),d=s.filter(e=>!f(e.nA).some(e=>e.c3>0)),p=f(a).length>0,m=(e,t)=>e.map((e,r)=>{let i=e.nA===c&&n!==a,o=t+r;return`
