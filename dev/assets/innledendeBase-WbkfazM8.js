import{C as e,D as t,F as n,G as r,I as i,J as a,K as o,L as s,N as c,R as l,S as u,T as d,V as f,Y as p,a as m,b as h,c as g,d as _,f as v,g as y,h as b,i as x,j as S,k as C,m as w,q as T,s as E,u as D,v as O,w as k,x as A,y as j,z as M}from"./index-CufTpKqI.js";import{t as N}from"./ScoreNumberpad-C-b3sWkY.js";var P=null,F=null,I=null,L=null;function R(){return P||(P=document.createElement(`div`),P.className=`modal`,P.style.display=`none`,P.setAttribute(`role`,`dialog`),P.setAttribute(`aria-modal`,`true`),P.setAttribute(`aria-labelledby`,`pd-title`),P.innerHTML=`
