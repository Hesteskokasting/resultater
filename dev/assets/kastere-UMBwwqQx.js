...
import{t as e}from"./preload-helper-tDRSoqHn.js";import{t}from"./logError-CTQ3euge.js";import{t as n}from"./escHtml-CfOHO0aD.js";import{ar as r,dr as i,er as a,hr as o,i as s,mr as c,pr as l,x as u,y as d}from"./index-Bj8YGowA.js";import{i as f,l as p,r as m}from"./kasterService-DIBRsqwT.js";import{t as h}from"./SearchInput-CDoDGwhR.js";import{t as g}from"./AdminLinkBar-DEP8AvMc.js";var _=2017,v={kongelag:40,minimatch:60,halvmatch:100,heilmatch:200};function y(e){return e.length?Math.round(e.reduce((e,t)=>e+t,0)/e.length):null}function b(e,t){let n=t.direction===`asc`?1:-1;return[...e].sort((e,r)=>{if(t.column===`plassering`){let t=e.plassering,i=r.plassering;return t==null&&i==null?0:t==null?1:i==null?-1:(t-i)*n}return(e.stevne?.dato??``).localeCompare(r.stevne?.dato??``)*n})}function x(e,t){return e.column===t?{column:t,direction:e.direction===`asc`?`desc`:`asc`}:{column:t,direction:t===`plassering`?`asc`:`desc`}}function S(e){return{years:[...new Set(e.map(e=>i(e.stevne?.dato)).filter(e=>e!==null))].sort((e,t)=>t-e),types:[...new Map(e.map(e=>e.stevne?.stevnetype).filter(e=>e!=null).map(e=>[e.id,e.navn])).entries()].sort((e,t)=>e[1].localeCompare(t[1]))}}function C(e,t,n){return e.filter(e=>!(t!==`alle`&&String(i(e.stevne?.dato))!==t||n!==`alle`&&String(e.stevne?.stevnetype?.id)!==n))}function w(e,t){let n=(e.stevne?.innledendekastemetode?.navn??``).toLowerCase(),r=(e.stevne?.avsluttendekastemetode?.navn??``).toLowerCase();return n===t||r===t}function T(e){return[{label:`Kongelag`,rader:e.filter(e=>e.poeng_kongelag!=null),poengFn:e=>e.poeng_kongelag,ringFn:e=>e.antall_ring_kongelag,maxRing:v.kongelag},...[`minimatch`,`halvmatch`,`heilmatch`].map(t=>({label:t.charAt(0).toUpperCase()+t.slice(1),rader:e.filter(e=>e.poeng_xkast!=null&&w(e,t)),poengFn:e=>e.poeng_xkast,ringFn:e=>e.antall_ring_xkast,maxRing:v[t]}))].map(({label:e,rader:t,poengFn:n,ringFn:r,maxRing:a})=>{let o=t.length?Math.max(...t.map(e=>n(e))):null,s=y(t.map(e=>n(e))),c=t.filter(e=>r(e)!=null&&(i(e.stevne?.dato)??0)>=2017);return{label:e,rekord:o,snittPoeng:s,snittProsent:c.length?Math.round(c.reduce((e,t)=>e+r(t)/a*100,0)/c.length*100)/100:null}})}function E(e,t){let n=new Map;for(let r of e)r.klubb?.id&&r.klubb.id!==t&&n.set(r.klubb.id,r.klubb.navn);return[...n.values()]}function D(e,t,n){return t===`plassering`?e.plassering??null:n===`kongelag`?e.antall_ring_kongelag==null?null:Math.round(e.antall_ring_kongelag/v.kongelag*1e4)/100:w(e,n)?e.antall_ring_xkast==null?null:Math.round(e.antall_ring_xkast/v[n]*1e4)/100:null}function O(e,t,n,r,o){let s=[...e].filter(e=>{let a=i(e.stevne?.dato);return r&&(a??0)<r||o&&(a??0)>o?!1:D(e,t,n)!=null}).sort((e,t)=>(e.stevne?.dato??``).localeCompare(t.stevne?.dato??``));return{labels:s.map(e=>a(e.stevne?.dato)),stevneNamn:s.map(e=>e.stevne?.navn??``),verdiar:s.map(e=>D(e,t,n))}}var k={active:`resultater`,year:`alle`,tournamentType:`alle`,resultSort:{column:`dato`,direction:`desc`},chartMetric:`plassering`,chartMethod:`kongelag`,chartFrom:null,chartTo:null},A=!1,j=null;function M(){j&&=(j.destroy(),null)}function N(e,t){let r=n(u(e)),i=e.medlemsnummer?` ${e.medlemsnummer}`:``,{years:a,types:o}=S(t),s=k.chartMetric===`prosent`?``:` d-none`;return`
    ...
    </div>`}function P(e,t,n){return t==null?``:`<span class="kd-round-chip">${e} ${n==null?`${t}`:`${t} (${n})`}</span>`}function F(e,t){return`<span class="kd-sort-icon${e?` kd-sort-icon--active`:``}" aria-hidden="true">${e?t===`asc`?`↑`:`↓`:`↕`}</span>`}function I(e,t,n){let r=n.column===e,i=n.direction===`asc`?`stigande`:`synkande`,a=r?`Sortert etter ${t}, ${i}. Vel for å snu.`:`Sorter etter ${t}`;return`<button type="button" class="kd-sort-btn${r?` kd-sort-btn--active`:``}" data-sort="${e}" aria-pressed="${r}" aria-label="${a}">${t}${F(r,n.direction)}</button>`}function L(e,t,r,i){let o=C(e,t,r),s=o.length,c=`
    ...
    </div>`,u=b(o,i).map(e=>{let t=e.stevne,r=t?.id?`<a href="#/stevne/${t.id}/resultat" class="kd-res-row__name">${n(t.navn??``)}</a>`:`<span class="kd-res-row__name">${n(t?.navn??`–`)}</span>`,i=P(`X-kast`,e.poeng_xkast,e.antall_ring_xkast)+P(`Kongelag`,e.poeng_kongelag,e.antall_ring_kongelag),o=e.plassering==null?`<span class="kd-res-row__pl kd-res-row__pl--empty">–</span>`:`<span class="kd-res-row__pl">${e.plassering}</span>`;return`
      <div class="kd-res-row">
        ${r}
        <div class="kd-res-row__meta">
          <span class="kd-res-row__date">${a(t?.dato)}</span>
        ...
        ${o}
      </div>`}).join(``);return c+l+`<div class="kd-res-list">${u}</div>`}function R(e,t){let i=T(e),a=E(e,t.klubb?.id??null);return`
    ...
    </div>`}async function z(t,n){M();let{labels:r,stevneNamn:i,verdiar:a}=O(n,k.chartMetric,k.chartMethod,k.chartFrom?Number(k.chartFrom):null,k.chartTo?Number(k.chartTo):null);if(!a.length){let e=t.parentElement;if(e){let t=l(`Ingen data for valt filter.`);t.classList.add(`pt-3`),e.replaceChildren(t)}return}let{Chart:o,registerables:s}=await e(async()=>{let{Chart:e,registerables:t}=await import(`./charts-qQqpzAio.js`).then(e=>e.t);return{Chart:e,registerables:t}},__vite__mapDeps([0,1]));A||=(o.register(...s),!0);let c=k.chartMetric===`plassering`,u=c?`Plassering`:`% Ring`;j=new o(t,{type:`line`,data:{labels:r,datasets:[{label:u,data:a,borderColor:`#4e8fc7`,backgroundColor:`rgba(78,143,199,0.15)`,pointBackgroundColor:`#4e8fc7`,pointRadius:4,tension:.1,fill:!1}]},options:{responsive:!0,maintainAspectRatio:!1,scales:{x:{ticks:{maxTicksLimit:14,maxRotation:45,color:`#ccc`},grid:{color:`rgba(255,255,255,0.08)`}},y:{reverse:c,ticks:{color:`#ccc`},grid:{color:`rgba(255,255,255,0.08)`},title:{display:!0,text:u,color:`#ccc`}}},plugins:{legend:{display:!1},tooltip:{callbacks:{title:e=>{let t=e[0]?.dataIndex;return t==null?``:i[t]??r[t]??``},label:e=>`${u}: ${String(e.raw)}`}}}}})}async function B(e,n){k.active=`resultater`,k.year=`alle`,k.tournamentType=`alle`,k.resultSort={column:`dato`,direction:`desc`},k.chartMetric=`plassering`,k.chartMethod=`kongelag`,k.chartFrom=null,k.chartTo=null,e.replaceChildren(o(`Laster utøvar...`));try{let{kaster:t,resultater:r,error:i}=await p(n);if(i||!t){e.replaceChildren(c(`Kunne ikkje laste utøvar.`));return}let a=t;s(u(a)),e.innerHTML=N(a,r);let o=e.querySelector(`#kd-year`),l=e.querySelector(`#kd-type`),d=e.querySelector(`#kd-chart-method`),f=e.querySelector(`#kd-result-table`);function m(){f.innerHTML=L(r,k.year,k.tournamentType,k.resultSort)}f.addEventListener(`click`,e=>{let t=e.target.closest(`[data-sort]`);t&&(k.resultSort=x(k.resultSort,t.dataset.sort),m())});function h(){e.querySelector(`#kd-statistics-content`).innerHTML=R(r,a)}function _(){let t=e.querySelector(`#kd-chart-canvas`);t&&z(t,r)}function v(t){k.active=t,e.querySelectorAll(`.thrower-tab-button`).forEach(e=>{e.classList.toggle(`active`,e.dataset.tab===t)}),e.querySelectorAll(`.kd-tab`).forEach(e=>{e.classList.toggle(`kd-hidden`,e.id!==`kd-tab-${t}`)}),t===`statistikk`&&h(),t===`graf`&&_()}m(),o.addEventListener(`change`,()=>{k.year=o.value,m()}),l.addEventListener(`change`,()=>{k.tournamentType=l.value,m()}),e.querySelectorAll(`.thrower-tab-button`).forEach(e=>{e.addEventListener(`click`,()=>v(e.dataset.tab??``))});let y=e.querySelector(`#kd-chart-metric`);y.addEventListener(`change`,()=>{k.chartMetric=y.value,d.classList.toggle(`d-none`,y.value!==`prosent`),_()}),d.addEventListener(`change`,()=>{k.chartMethod=d.value,_()});let b=e.querySelector(`#kd-chart-from`),S=e.querySelector(`#kd-chart-to`);b.addEventListener(`change`,()=>{k.chartFrom=b.value||null,_()}),S.addEventListener(`change`,()=>{k.chartTo=S.value||null,_()}),g(e,{href:`#/kaster/${n}/admin`,label:`Rediger utøvar`,variant:`warning`,canShow:e=>e.profil?.role===`admin`||e.profil?.role===`klubbadmin`&&e.clubs.includes(a.klubbid??-1)})}catch(n){t(`kastere.renderDetail`,n),e.replaceChildren(c(`Kunne ikkje laste utøvar.`))}}var V=24,H=`https://placehold.co/200x200/444/888?text=?`,U={showAll:!1,searchText:``,page:1};function W(e){let t=u(e);return`
