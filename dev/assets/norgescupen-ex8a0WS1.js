import{G as e,K as t,at as n,et as r,it as i,nt as a,ot as o,q as s,st as c,tt as l}from"./index-C0p0H8n3.js";import{t as u}from"./LoadingState-RVZNML7E.js";import{t as d}from"./EmptyState-a5aDhc-8.js";import{t as f}from"./Table-BBE7tcG_.js";import{t as p}from"./expandableRows-DRqhMaDu.js";var m=2007,h=2024,g={ar:new Date().getFullYear(),cupType:`NC`,klasse:1,visning:`singel`},_={ar:null,regler:null,stevner:[],resultater:[]};async function v(e){if(_.ar===e)return!0;try{let[{data:t,error:n},{stevner:i,resultater:a,error:o}]=await Promise.all([r(e),l(e)]);return n||o?!1:(_.ar=e,_.regler=t,_.stevner=i,_.resultater=a,!0)}catch(e){return a(`hentOgBufferData`,e),!1}}function y(e,t){return t===`SNC`?`Dei ${e.max_snc} beste SNC-stevna er teljande`:t===`DNC`?`Dei ${e.max_dnc} beste DNC-stevna er teljande`:`Dei ${e.maxtotal} beste stevna, herav maks ${e.max_nc_total} NC-stevner og ${e.max_snc_total} SNC-stevner er teljande`}function b(e){return`
    ...
    </div>`}function S(e){let t=document.createDocumentFragment();t.appendChild(document.createTextNode(o(e)));let n=document.createElement(`span`);return n.className=`nc-chevron`,n.textContent=` ▼`,t.appendChild(n),t}function C(e){return e.length===0?d(`Ingen resultater funnet.`):f({rows:e,rowClass:`nc-singel-rad`,rowAttrs:(e,t)=>({"data-idx":String(t)}),detailRowClass:`nc-detalj-rad d-none`,detailRow:e=>f({rows:e.detaljRader,tableClass:`detalj-tabell`,theadClass:``,columns:[{label:`Dato`,render:e=>s(e._stevne?.dato)},{label:`Type`,render:e=>e._stevne?.typeNavn??`–`},{label:`Stevne`,render:e=>e._stevne?.navn??`–`},{label:`Pl.`,render:e=>String(e.plassering??`–`)},{label:`Poeng`,render:e=>o(e.nc_poeng)}]}),columns:[{label:`Pl.`,thClass:`nc-td-pl`,cellClass:`nc-td-pl`,render:e=>String(e.plassering)},{label:`Navn`,render:e=>e.navn},{label:`Klubb`,render:e=>e.klubb},{label:`Poeng`,thClass:`nc-td-poeng`,cellClass:`nc-td-poeng nc-poeng-celle`,cellAttrs:(e,t)=>({"data-idx":String(t)}),render:e=>S(e.totalPoeng)}]})}function w(e){return e.length===0?d(`Ingen lag funnet.`):f({rows:e,rowClass:`nc-lag-rad`,rowAttrs:(e,t)=>({"data-lag-idx":String(t)}),detailRowClass:`nc-lag-detalj-rad d-none`,detailRow:e=>f({rows:e.bidragsytere,tableClass:`detalj-tabell`,showHeader:!1,columns:[{label:``,render:e=>c(e.kaster)},{label:``,cellClass:`nc-td-poeng`,render:e=>o(e.sum)}]}),columns:[{label:`Pl.`,thClass:`nc-td-pl`,cellClass:`nc-td-pl`,render:e=>String(e.plassering)},{label:`Klubb`,render:e=>e.klubb?.navn??`–`},{label:`Poeng`,thClass:`nc-td-poeng`,cellClass:`nc-td-poeng nc-lag-poeng-celle`,cellAttrs:(e,t)=>({"data-lag-idx":String(t)}),render:e=>S(e.lagTotal)}]})}function T(e,n){return`
    <div class="nc-side">
    ...
    </div>`}async function E(t){if(g.ar=new Date().getFullYear(),g.cupType=`NC`,g.klasse=1,g.visning=`singel`,_={ar:null,regler:null,stevner:[],resultater:[]},t.replaceChildren(u(`Laster Norgescupen...`)),!await v(g.ar)){t.replaceChildren(e(`Kunne ikkje laste data for Norgescupen.`));return}t.innerHTML=T(g.ar,g.cupType);function r(){let{ar:e,cupType:a,klasse:o,visning:s}=g,{regler:c}=_,l=t.querySelector(`#nc-content`);if(t.querySelector(`.nc-hovudtittel`).textContent=`Norgescupen ${e}`,t.querySelector(`#nc-cuptype`).classList.toggle(`d-none`,e<h),t.querySelector(`#nc-visning-tabs-container`).innerHTML=a===`NC`?b(s):``,s===`lag`&&a===`NC`){l.innerHTML=`
        <section>
