import{n as e,t}from"./logError-ByTg738k.js";import{S as n,_r as r,f as i,gr as a,or as o,vr as s}from"./index-ScyQGOLm.js";import{r as c}from"./dropdown-BfusA0XK.js";import{t as l}from"./fetchAllRows-CYe7NsMC.js";import{t as u}from"./klasse-D9YhVdn2.js";import{t as d}from"./placements-BkOKWPKO.js";import{a as f,i as p,n as m,o as h,r as g,t as _}from"./truncate-xo4AruK9.js";var v=2024;function y(e){e.year<2024&&(e.cupType=`NC`),e.cupType!==`NC`&&(e.view=`singel`)}function b(e){if(e==null)return`–`;let t=Number(e);return Number.isInteger(t)?String(t):t.toFixed(1)}function x(e){let t=new Map;for(let n of e)t.set(n.id,{navn:n.navn,dato:n.dato,typeNavn:n.stevnetype?.navn??``});return t}function S(e){return[...e].sort((e,t)=>(t.nc_poeng??0)-(e.nc_poeng??0))}function C(e,t,n){let r=[],i=[],a=[];for(let t of e){let e=n.get(t.stevneid??-1)?.typeNavn??``;e===`NC`?r.push(t):e===`SNC`?i.push(t):e===`DNC`&&a.push(t)}let o=S(r).slice(0,t.max_nc_total),s=S(i).slice(0,t.max_snc_total),c=t.max_dnc_total>0?t.max_dnc_total:1/0,l=S(a).slice(0,c);return S([...o,...s,...l]).slice(0,t.maxtotal)}function w(e,t,n){return S(e.filter(e=>n.get(e.stevneid??-1)?.typeNavn===`SNC`)).slice(0,t.max_snc)}function T(e,t,n){return S(e.filter(e=>n.get(e.stevneid??-1)?.typeNavn===`DNC`)).slice(0,t.max_dnc)}function E(e){return e===`SNC`?w:e===`DNC`?T:C}function D(e){let t=new Map;for(let n of e)n.kasterid!=null&&n.kaster!=null&&(t.has(n.kasterid)||t.set(n.kasterid,{kaster:n.kaster,rader:[]}),t.get(n.kasterid).rader.push(n));return t}function O(e,t,r,i,a,o){let s=x(t),c=E(i),l=a===1?`Klasse 1`:`Klasse 2`,f=D(u(o)?e.filter(e=>e.klasse?.navn===l):e),p=[];for(let[,e]of f){let t=c(e.rader,r,s),i=t.reduce((e,t)=>e+(t.nc_poeng??0),0),a=[...new Set(t.map(e=>e.klubb?.navn).filter(e=>e!=null))],o=t.map(e=>({...e,_stevne:s.get(e.stevneid??-1)})).sort((e,t)=>(t.nc_poeng??0)-(e.nc_poeng??0)||(e._stevne?.dato??``).localeCompare(t._stevne?.dato??``));p.push({navn:n(e.kaster),klubb:a.join(` / `),totalPoeng:i,detaljRader:o,plassering:0})}return p.sort((e,t)=>t.totalPoeng-e.totalPoeng||e.navn.localeCompare(t.navn)),d(p,e=>e.totalPoeng),p}function k(e,t,n,r){let i=x(t),a=D(u(r)?e.filter(e=>e.klasse?.navn===`Klasse 1`):e),o=new Map,s=new Map;for(let[,e]of a){let t=C(e.rader,n,i),r=new Map;for(let e of t){let t=e.klubb;t&&e.klubbid!=null&&!s.has(e.klubbid)&&s.set(e.klubbid,t),e.klubbid!=null&&r.set(e.klubbid,(r.get(e.klubbid)??0)+(e.nc_poeng??0))}for(let[t,n]of r)o.set(`${e.kaster.id}_${t}`,{kaster:e.kaster,klubbId:t,sum:n})}let c=new Map;for(let[,e]of o)c.has(e.klubbId)||c.set(e.klubbId,{klubb:s.get(e.klubbId),bidragsytere:[]}),c.get(e.klubbId).bidragsytere.push(e);let l=[];for(let[,e]of c){e.bidragsytere.sort((e,t)=>t.sum-e.sum);let t=e.bidragsytere.slice(0,4);l.push({klubb:e.klubb,lagTotal:t.reduce((e,t)=>e+t.sum,0),bidragsytere:t,plassering:0})}return l.sort((e,t)=>t.lagTotal-e.lagTotal),d(l,e=>e.lagTotal),l}e.from(`resultat`).select(`
  ...
  <p>Kun klasse 1. Dei 4 beste poengsummene frå kvar klubb er teljande.</p>`;function H(e,t,n){return`
    <p class="info-tip__tittel">${i(t)} Singel ${n}</p>
    <p>${i(e?B(e,t):`Ingen telleregel funnet for ${n}`)}</p>`}function U(e){return`
    ...
    </div>`}async function J(e){R.year=new Date().getFullYear(),R.cupType=`NC`,R.classNum=1,R.view=`singel`,P(),e.replaceChildren(s(`Laster Norgescupen...`));let t=await F(R.year);if(!t){e.replaceChildren(r(`Kunne ikkje laste data for Norgescupen.`));return}z=t,e.innerHTML=q(R.year,R.cupType);let n=f({slot:e.querySelector(`#nc-info-slot`),label:`Om denne lista`,html:``});function i(){let{year:t,cupType:r,classNum:o,view:s}=R,{rules:c}=z,l=e.querySelector(`#nc-content`);if(e.querySelector(`#nc-title-text`).textContent=`Norgescupen ${t}`,e.querySelector(`#nc-cuptype`).classList.toggle(`d-none`,t<v),e.querySelector(`#nc-view-tabs-container`).innerHTML=r===`NC`?U(s):``,s===`lag`&&r===`NC`){n.setHtml(V),l.innerHTML=`
        <section>
          <div class="click-hint click-hint-row">Klikk ein klubb for å vise detaljar</div>
          <div id="nc-team-table-container"></div>
        </section>`;let e=l.querySelector(`#nc-team-table-container`),r=c?k(z.results,z.tournaments,c,t):[];r.length?(e.innerHTML=K(r),m(e)):e.replaceChildren(a(c?`Ingen lag funnet.`:`Ingen data.`))}else{n.setHtml(H(c,r,t)),l.innerHTML=`
        <section id="nc-single-section">
          <div id="nc-class-tabs-container">${W(o,t)}</div>
          <div id="nc-single-table-container"></div>
        </section>`;let e=l.querySelector(`#nc-single-table-container`),s=c?O(z.results,z.tournaments,c,r,o,t):[];s.length?(e.innerHTML=G(s),m(e)):e.replaceChildren(a(c?`Ingen resultater funnet.`:`Ingen data.`)),l.querySelector(`#nc-single-section`).addEventListener(`click`,e=>{let t=e.target.closest(`[data-class]`);t&&(R.classNum=Number(t.dataset.class),i())})}}i(),e.querySelector(`#nc-year`).addEventListener(`change`,async t=>{R.year=Number(t.target.value),R.classNum=1,y(R),e.querySelector(`#nc-cuptype`).value=R.cupType,e.querySelector(`#nc-content`).replaceChildren(s());let n=await F(R.year);if(!n){e.querySelector(`#nc-content`).replaceChildren(r(`Feil ved henting av data.`));return}z=n,i()}),e.querySelector(`#nc-cuptype`).addEventListener(`change`,e=>{R.cupType=e.target.value,R.classNum=1,y(R),i()}),e.querySelector(`#nc-view-tabs-container`).addEventListener(`click`,e=>{let t=e.target.closest(`[data-view]`);t&&(R.view=t.dataset.view,i())})}export{J as render};