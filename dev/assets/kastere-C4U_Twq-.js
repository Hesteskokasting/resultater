...
import{t as e}from"./logError-DhxY2JQv.js";import{Q as t,X as n,Y as r,dt as i,it as a,pt as o,tt as s}from"./index-C7fZNAx-.js";import{o as c,s as l,t as u}from"./kasterService-D1rq1bik.js";import{t as d}from"./LoadingState-xRmJ3K_t.js";import{t as f}from"./EmptyState-BvE_0HiD.js";import{t as p}from"./AdminLinkBar-CuilJiI5.js";var m=24,h=`https://placehold.co/200x200/444/888?text=?`,g={visAlle:!1,sokeTekst:``,side:1};function _(e){let t=i(e);return`
    <a href="#/kastere/${o(e)}" class="kaster-kort">
      <img src="${r(e.avatarurl||h)}" alt="${r(t)}" loading="lazy">
      <div class="kaster-navn">${r(t)}</div>
      <div class="kaster-klubb">${r(e.klubb?.navn??`–`)}</div>
    </a>`}function v(){return`
    ...
    <div class="table-responsive">
      <table class="app-tabell">
        ...
        <tbody>${a.map(e=>{let n=e.stevne,i=n?.id?`<a href="#/stevne/${n.id}/resultat" class="tl-lenkje">${r(n.navn??``)}</a>`:r(n?.navn??`–`);return`
      <tr>
        <td class="text-nowrap">${t(n?.dato)}</td>
        <td>${i}</td>
        <td>${r(n?.stevnetype?.navn??`–`)}</td>
    ...
    </div>`}function I(e,t){let n=E(e),i=D(e,t.klubb?.id??null);return`
