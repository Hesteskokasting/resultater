import{A as e,Ct as t,k as n,wt as r}from"./index-CcPBCJzk.js";import{i,n as a,r as o,t as s}from"./adminForms-Bsglovcs.js";import{i as c,n as l}from"./klubbService-CaXvOdL5.js";import{t as u}from"./LoadingState-BWi0wPLz.js";async function d(d,f={}){let p=f.id===void 0?void 0:Number(f.id);if(!p){d.replaceChildren(r(`Manglande ID.`));return}d.replaceChildren(u());let{data:m,error:h}=await l(p);if(h||!m){d.replaceChildren(r(`Klubb ikkje funne.`));return}if(!await n()&&!await e(p)){d.replaceChildren(r(`Ingen tilgang til denne klubben.`));return}d.innerHTML=`
