import{t as e}from"./logError-ByTg738k.js";import{Ft as t,O as n,f as r,fr as i,h as a,k as o,pr as s}from"./index-CkbUM2Oe.js";import{a as c}from"./klubbService-pPakrKDt.js";import{a as l,i as u,n as d,r as f,t as p}from"./_formButtons-Cxp3wbpd.js";import{t as m}from"./dropdown-Bu71pdFg.js";import{t as h}from"./formNum-HGeagI_O.js";import{a as g,m as _,n as v,s as y,t as b,u as x}from"./kasterService-BN8H2rLx.js";async function S(S,C){let{container:w}=S;w.replaceChildren(s());let T=[],E=[],D=[];try{let e=await Promise.all([c(),g(),y()]);T=e[0].data,E=e[1].data,D=e[2].data}catch(t){e(`kasterForm.mount`,t),w.replaceChildren(i(`Kunne ikkje laste skjema.`));return}let O=null;if(C){let{data:e,error:t}=await x(C);if(t||!e){w.replaceChildren(i(`Utøvar ikkje funne.`));return}if(O=e,!await n()&&!await o(O.klubbid??void 0)){w.replaceChildren(i(`Ingen tilgang til denne utøvaren.`));return}}let k=O??{},A=T.map(e=>`<option value="${e.id}"${e.id===k.klubbid?` selected`:``}>${r(e.navn)}</option>`).join(``),{wrapper:j,headingHtml:M}=u(S);j.innerHTML=`
    ${M}
