import{B as e,D as t,G as n,L as r,V as i,W as a,b as o,nt as s,t as c}from"./index-DWjo0-lM.js";import{t as l}from"./LoadingState-RVZNML7E.js";import{t as u}from"./ConfirmDialog-DNGrXiEY.js";import{i as d}from"./kamp-CpbenSSn.js";import{C as f,S as p,a as m,b as h,f as g,n as _,s as v,x as y,y as b}from"./kampService-BDUG7PJS.js";import{t as x}from"./realtime-6_aQ1GT-.js";import{a as S,i as C,n as w,o as T,r as E,s as D}from"./kampGenereringCupService-ChszZ6vg.js";import{_ as O,b as k,c as A,d as j,f as M,g as N,h as P,l as F,n as I,p as L,r as R,t as z,u as B,v as V,x as H}from"./resultatService-D71b82Gv.js";import{t as U}from"./ScoreNumberpad-DEYDshL3.js";function W(e,{visSpelarliste:t=!0,initNa:n=null,initFormat:r=null}={}){let i=typeof e==`number`?e:e.length,a=typeof e==`number`?[]:e.map((e,t)=>({...e,cupPlassering:t+1})),o=T(i),s=n===i?i:n!=null&&o.some(e=>e.nA===n)?n:o[0]?.nA??i,c=i-s,l=o.filter(e=>D(e.nA).some(e=>e.c3>0)),u=o.filter(e=>!D(e.nA).some(e=>e.c3>0)),d=D(i).length>0,f=(e,t)=>e.map((e,r)=>{let a=e.nA===s&&n!==i,o=t+r;return`
