import{C as e,D as t,F as n,G as r,H as i,L as a,M as o,N as s,P as c,T as l,U as u,V as d,W as f,_ as p,a as m,b as h,d as g,f as _,g as v,h as y,i as b,j as x,k as S,l as C,p as w,s as T,u as E,v as D,x as O,y as k}from"./index-CuXC9St-.js";import{t as A}from"./ScoreNumberpad-DYEk7r3I.js";var j=null,M=null,N=null,P=null;function F(){return j||(j=document.createElement(`div`),j.className=`modal`,j.style.display=`none`,j.setAttribute(`role`,`dialog`),j.setAttribute(`aria-modal`,`true`),j.setAttribute(`aria-labelledby`,`pd-title`),j.innerHTML=`
