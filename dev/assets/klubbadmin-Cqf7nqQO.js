import{n as e,t}from"./authService-CcI7FLUE.js";import{J as n,Y as r}from"./index-B_yOZcdN.js";import{i,n as a,r as o,t as s}from"./adminForms-FITq6uog.js";import{i as c,n as l}from"./klubbService-avZCVzgk.js";import{t as u}from"./LoadingState-xRmJ3K_t.js";async function d(d,f={}){let p=f.id===void 0?void 0:Number(f.id);if(!p){d.replaceChildren(r(`Manglande ID.`));return}d.replaceChildren(u());let{data:m,error:h}=await l(p);if(h||!m){d.replaceChildren(r(`Klubb ikkje funne.`));return}if(!await t()&&!await e(p)){d.replaceChildren(r(`Ingen tilgang til denne klubben.`));return}d.innerHTML=`
