import{B as e,D as t,G as n,L as r,V as i,W as a,b as o,nt as s,t as c}from"./index-BePamk3G.js";import{t as l}from"./LoadingState-RVZNML7E.js";import{t as u}from"./ConfirmDialog-3D8QuJxP.js";import{C as d,N as f,S as p,a as m,b as h,f as g,k as _,n as v,s as y,x as b,y as x}from"./kampService-DR346jJK.js";import{t as S}from"./realtime-DOgbYL8v.js";import{a as C,i as w,n as T,o as E,r as D,s as O}from"./kampGenereringCupService-Bk4w47wr.js";import{l as k}from"./pameldingService-DCrJcXZe.js";import{S as A,_ as j,b as M,c as N,d as ee,f as P,g as F,h as I,l as L,n as R,p as te,r as ne,t as z,u as B,v as V,x as H}from"./resultatService-BKUQAYxA.js";import{n as U,t as W}from"./LivePill-BTyzkGe4.js";function G(e,{visSpelarliste:t=!0,initNa:n=null,initFormat:r=null}={}){let i=typeof e==`number`?e:e.length,a=typeof e==`number`?[]:e.map((e,t)=>({...e,cupPlassering:t+1})),o=E(i),s=n===i?i:n!=null&&o.some(e=>e.nA===n)?n:o[0]?.nA??i,c=i-s,l=o.filter(e=>O(e.nA).some(e=>e.c3>0)),u=o.filter(e=>!O(e.nA).some(e=>e.c3>0)),d=O(i).length>0,f=(e,t)=>e.map((e,r)=>{let a=e.nA===s&&n!==i,o=t+r;return`
  ...
  `}function K(e,t,n=0,r=0){let i=e.slice(0,t),o=e.slice(t);function s(e,t=0){return e.map((e,n)=>{let r=n<t;return`
    ...
    </div>`}function _e(e,t,n,r,i,a,o){for(let l of n){let n=X(l,a,o),u=n[0]??null,d=n[1]??null,f=u?.rep??null,m=d?.rep??null,g=A(u,!1),_=A(d,!1),v=async(e,t)=>{let n=[];f?.id&&n.push(x(f.id,e)),m?.id&&n.push(x(m.id,t));for(let e of[u,d])for(let t of e?.members.slice(1)??[])n.push(x(t.id,0));try{return(await Promise.all(n)).find(e=>e.error)??null}catch(e){return s(`cup:skrivSideScore`,e),{error:e}}};if(e.querySelector(`#plus-${l.id}`)?.addEventListener(`click`,async()=>{U(g,_,Z(u),Z(d),async(e,t)=>{if(await v(e,t)){c(`DB-feil ved oppdatering av score`,`error`);return}await i()})}),e.querySelector(`#scoreboard-${l.id}`)?.addEventListener(`click`,()=>{window.open(`#/kamp/${l.id}`,`_blank`)}),e.querySelector(`#bekrft-${l.id}`)?.addEventListener(`click`,async e=>{if(l.er_tre_spelarar)oe(l,n,t,async()=>{await $(t,l),await i()});else{let r=e.currentTarget;r.disabled=!0,r.textContent=`Lagrer…`;try{await ve(t,l,n,i)||(r.disabled=!1,r.textContent=`Bekreft`)}catch{r.disabled=!1,r.textContent=`Bekreft`}}}),r&&l.er_bekreftet&&!l.er_tre_spelarar){let r=n.flatMap(e=>e.members.map(e=>e.kasterid)),a=()=>{U(g,_,Z(u),Z(d),async(e,a)=>{let o=n.flatMap(e=>e.members.map(e=>e.id));if(o.length){let{error:e}=await p(o);if(e){c(`DB-feil ved sletting av omgangar`,`error`);return}}if(await v(e,a)){c(`DB-feil ved oppdatering av score`,`error`);return}let s=e>=a?u:d,f=e>=a?d:u,m=s?.members.map(e=>e.kasterid)??[],g=f?.members.map(e=>e.kasterid)??[],_=[...m.map(e=>({kasterid:e,plassering:1})),...g.map(e=>({kasterid:e,plassering:2}))],{error:y}=await b(l.id,_);if(y){c(`DB-feil ved oppdatering av plassering`,`error`);return}await h({stevneId:t,rundeNummer:l.runde_nummer,rundeNavn:l.runde_navn,allKasterids:r,nyVinnarIds:m,nyTaparIds:g}),await i()})};e.querySelectorAll(`[data-endre-score="${l.id}"]`).forEach(e=>e.addEventListener(`click`,a))}}}async function ve(e,t,n,r){let i=n[0]??null,a=n[1]??null,{data:o}=await g(t.id),s=e=>e?.members.reduce((e,t)=>e+f(o.find(e=>e.id===t.id)??t),0)??0,l=s(i),d=s(a);if(l===0&&d===0&&!await u({title:`Ingen score registrert`,message:`Vil du bekrefte kampen likevel?`}))return!1;let p=l>=d?i:a,m=l>=d?a:i,h=n.flatMap(e=>e.members.map(e=>e.kasterid)),{error:_}=await v({kampId:t.id,stevneId:e,rundeNummer:t.runde_nummer,rundeNavn:t.runde_navn,allKasterids:h,eliminertIds:m?.members.map(e=>e.kasterid)??[],vidareSider:p?[p.members.map(e=>e.kasterid)]:[]});return _?(c(`DB-feil ved bekreft`,`error`),!1):(await $(e,t),await r(),!0)}async function $(e,t){t.runde_navn!==`Semifinale`||!t.gruppe_navn||await m(e,t.gruppe_navn)&&await D(e,t.gruppe_navn)}export{ue as render};