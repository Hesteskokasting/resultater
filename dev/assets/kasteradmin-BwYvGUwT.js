import{t as e}from"./logError-DFCPgUum.js";import{a as t,i as n}from"./authService-3qblRciR.js";import{$ as r,C as i,Q as a}from"./index-CpxSVsbW.js";import{i as o,n as s,r as c,t as l}from"./adminForms-DZoL-lYJ.js";import{r as u}from"./klubbService-g15VfQEw.js";import{a as d,l as f,n as p,p as m,s as h,t as g}from"./kasterService-VZ0s6Z5J.js";import{t as _}from"./LoadingState-Ps7fTB_T.js";import{t as v}from"./buildDropdownOptions-BwlnvrC6.js";import{t as y}from"./formNum-BJzy6BAM.js";async function b(b,x={}){let S=x.id===void 0?void 0:Number(x.id);b.replaceChildren(_());let C=[],w=[],T=[];try{let e=await Promise.all([u(),d(),h()]);C=e[0].data,w=e[1].data,T=e[2].data}catch(t){e(`kasteradmin.render`,t),b.replaceChildren(r(`Kunne ikkje laste skjema.`));return}let E=null;if(S){let{data:e,error:i}=await f(S);if(i||!e){b.replaceChildren(r(`Utøvar ikkje funne.`));return}if(E=e,!await n()&&!await t(E.klubbid??void 0)){b.replaceChildren(r(`Ingen tilgang til denne utøvaren.`));return}}let D=S?`Rediger utøvar: ${E?`${a(E.fornavn)} ${a(E.etternavn)}`:``}`:`Ny utøvar`,O=E??{};b.innerHTML=`
