const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/gloppen-BvEA-jIT.js","assets/index-DBpCd5l1.js","assets/vendor-3yxEHqvy.js","assets/rolldown-runtime-lhHHWwHU.js","assets/index-B12VKaLv.css","assets/innledendeBase-00YSAKhw.js","assets/ConfirmDialog-DNGrXiEY.js","assets/LivePill-C1AxE8Dw.js","assets/LoadingState-RVZNML7E.js","assets/resultatService-063NuPR7.js","assets/Table-BBE7tcG_.js","assets/kamp-CpbenSSn.js","assets/kampService-BhvBB1aA.js","assets/testDataService-DH2ZZd6E.js","assets/realtime-Du29nLXl.js","assets/nordhordland-D9LCKrE3.js","assets/kampGenereringInnledendeService-Cx9D-mv5.js","assets/xkast-B0YDP4bt.js","assets/cup-CrUtPIPO.js","assets/kampGenereringCupService-Bdqy8nJV.js","assets/kongelag-2TV7PmcY.js","assets/nordhordland-BceLzW4Y.js"])))=>i.map(i=>d[i]);
import{$ as e,C as t,G as n,L as r,M as i,N as a,R as o,S as s,U as c,W as l,Y as u,Z as d,_ as f,ct as p,i as m,n as h,nt as g,r as _,rt as v,st as y,t as b,y as x}from"./index-DBpCd5l1.js";import{o as S}from"./kasterService-8qWFQG3m.js";import{t as C}from"./LoadingState-RVZNML7E.js";import{t as w}from"./EmptyState-a5aDhc-8.js";import{t as T}from"./ConfirmDialog-DNGrXiEY.js";import{t as E}from"./realtime-Du29nLXl.js";import{a as D,i as O,l as k,r as A,s as ee,t as te}from"./pameldingService-CAU8WuL_.js";import{a as ne,o as re}from"./resultatService-063NuPR7.js";import{t as j}from"./kampGenereringInnledendeService-Cx9D-mv5.js";import{n as M}from"./testDataService-DH2ZZd6E.js";async function N(e,{id:t,isAdmin:i=!1},a=null){e.replaceChildren(C());try{let[o,c,f]=await Promise.all([s(t),O(t),m()]);if(o.error||!o.data){e.replaceChildren(n(`Stevne ikkje funne.`));return}let p=o.data,h=p.stevne_fase??null,g=h===null||h===`ikke_startet`,_=p.kastemetodeInnl?.navn??`—`,v=_.toLowerCase().includes(`gloppen`);if(a&&g&&i){a.innerHTML=`<button id="start-stevne-btn" class="btn btn-sm btn-success">Start stevne</button>`;let e=a.querySelector(`#start-stevne-btn`);e.addEventListener(`click`,async()=>{if(c<2){b(`Stevnet må ha minst 2 spelarar for å startast.`,`error`);return}if(v&&!p.antall_runder_innl){b(`Du må setje antal rundar for innledande fase. Gå til Innstillingar for å endre.`,`error`);return}let n=await D(t);if(n>0&&!await T({title:`Ubekrefta spelarar`,message:`${n} spelar(ar) er ikkje bekrefta. Vil du starte stevnet likevel?`}))return;e.disabled=!0,e.textContent=`Starter…`;try{await j(t,_,p.antall_runder_innl??1)}catch(t){b(`Feil ved kampgenerering: `+(t instanceof Error?t.message:String(t)),`error`),e.disabled=!1,e.textContent=`Start stevne`;return}let{error:i}=await r(t,`innledende`);if(i){b(`Feil ved oppdatering av fase.`,`error`),e.disabled=!1,e.textContent=`Start stevne`;return}location.hash=`#/stevne/${t}/innledende`})}e.innerHTML=`
