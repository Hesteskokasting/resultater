import{n as e,t}from"./logError-CTQ3euge.js";import{t as n}from"./escHtml-CfOHO0aD.js";import{E as r,I as i,Mt as a,P as o,R as s,S as c,T as l,Un as u,Y as d,Zn as f,_r as p,er as m,f as h,fn as g,h as _,hr as v,m as y,mr as b,pr as x,r as S,s as C,t as w,x as T,y as E,zt as D}from"./index-Bj8YGowA.js";import{d as O,r as k}from"./kasterService-DIBRsqwT.js";import{t as A}from"./SearchSelect-IXTu1--V.js";import{n as j,r as M,t as ee}from"./accountService-V7Tg3SB3.js";import{f as te,l as N}from"./kampService-Dl7Ruzf_.js";import{n as P,t as F}from"./groupBy-Bg_SEHjk.js";import{t as I}from"./navigationService-7TauNUam.js";import{n as L}from"./ScoreboardButton-cO_q_Bk1.js";function R(e,t,n){let r=(e?.spelarar??[]).filter(e=>e.kasterid!=null),i={};for(let t of r){let r=e?.stevneid==null?void 0:n[`${e.stevneid}:${t.kasterid}`];r!=null&&(i[t.kasterid]=r)}let a=u(r,i),o=a.findIndex(e=>e.members.some(e=>e.kasterid===t));return{mine:o===-1?[]:a[o]?.members??[],others:a.filter((e,t)=>t!==o).map(e=>e.members)}}function ne(e){return!e?.length||e.every(e=>e.kaster==null)}function z(e,t){return f({rep:e[0],members:e},t)}function re(e,t,n){let r=e?.er_bekreftet??!1,{mine:i,others:a}=R(e,t,n);if(e?.er_walkover)return{kind:`walkover`};if(r&&(e?.er_tre_spelarar||a.length>1)){let e=i.find(e=>e.kasterid===t)?.kamp_plassering;return e==null?{kind:`unknown`}:{kind:`placement`,placement:e}}let o=a[0];return!i.length||!o?.length?{kind:`unknown`}:{kind:`score`,me:z(i,r),them:z(o,r),confirmed:r}}function ie(e){return`
