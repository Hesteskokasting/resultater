import{Ct as e,O as t,St as n,k as r}from"./index-BckkKJXl.js";import{i,n as a,r as o,t as s}from"./adminForms-DCvJWIUd.js";import{i as c,n as l}from"./klubbService-CaXvOdL5.js";import{t as u}from"./LoadingState-BWi0wPLz.js";async function d(d,f={}){let p=f.id===void 0?void 0:Number(f.id);if(!p){d.replaceChildren(e(`Manglande ID.`));return}d.replaceChildren(u());let{data:m,error:h}=await l(p);if(h||!m){d.replaceChildren(e(`Klubb ikkje funne.`));return}if(!await t()&&!await r(p)){d.replaceChildren(e(`Ingen tilgang til denne klubben.`));return}d.innerHTML=`
