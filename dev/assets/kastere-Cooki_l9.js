...
import{t as e}from"./logError-D5z16FyH.js";import{Bt as t,Dt as n,Lt as r,Rt as i,St as a,r as o,wt as s,xt as c}from"./index-BKVpNZfr.js";import{c as l,i as u,r as d}from"./kasterService-B3gLOC11.js";import{t as f}from"./LoadingState-BWi0wPLz.js";import{t as p}from"./EmptyState-B1E_7OzB.js";import{t as m}from"./AdminLinkBar-BLpmi5v0.js";import{t as h}from"./SearchInput-BLUeXGg6.js";var g=24,_=`https://placehold.co/200x200/444/888?text=?`,v={showAll:!1,searchText:``,page:1};function y(e){let t=i(e);return`
    ...
    </div>`}function L(e,t,n){let r=e;t!==`alle`&&(r=r.filter(e=>String(T(e.stevne?.dato))===t)),n!==`alle`&&(r=r.filter(e=>String(e.stevne?.stevnetype?.id)===n));let i=r.length,a=`
