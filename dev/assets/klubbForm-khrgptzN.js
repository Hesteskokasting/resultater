import{I as e,It as t,L as n,s as r}from"./index-f4GJwwSh.js";import{a as i,i as a,o,r as s,s as c,t as l}from"./_formButtons-C4lBVz0l.js";import{t as u}from"./LoadingState-C6NB62Ct.js";import{i as d,o as f,t as p}from"./klubbService-880HYSCf.js";async function m(m,h){let{container:g}=m;g.replaceChildren(u());let _=null;if(h){let{data:r,error:i}=await d(h);if(i||!r){g.replaceChildren(t(`Klubb ikkje funne.`));return}if(_=r,!await e()&&!await n(h)){g.replaceChildren(t(`Ingen tilgang til denne klubben.`));return}}else if(!await e()){g.replaceChildren(t(`Ingen tilgang.`));return}let{wrapper:v,headingHtml:y}=s(m);v.innerHTML=`
    ${y}
    <form id="club-form">
