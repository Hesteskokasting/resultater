...
import { buildXkastStanding, compareOmgangArrays } from "@/utils/xkastKongelag/xkastStandings";
import type { XkastStandingParticipant } from "@/utils/xkastKongelag/xkastStandings";
