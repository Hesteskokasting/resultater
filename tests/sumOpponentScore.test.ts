...
describe('sumOpponentScore', () => {
  ...
  describe('Par/Mix (posisjon 1 vs 1, 2 vs 2)', () => {
    ...
    const posMap = new Map<number, number>([[1, 1], [2, 2], [3, 1], [4, 2]])
    const spelarar = [
  ...
  describe('3-pair Par match (6 players, same posisjon across three sides)', () => {
    ...
    const posMap = new Map<number, number>([[1, 1], [2, 2], [3, 1], [4, 2], [5, 1], [6, 2]])
    const spelarar = [
      { kasterid: 1, score_poeng: 10 }, { kasterid: 2, score_poeng: 8 },
      { kasterid: 3, score_poeng: 7 },  { kasterid: 4, score_poeng: 9 },
      { kasterid: 5, score_poeng: 6 },  { kasterid: 6, score_poeng: 5 },
    ]
