import{n as e,t}from"./logError-ByTg738k.js";import{An as n,At as r,Dn as i,Et as a,Ht as o,In as s,Ln as c,Nt as l,Wn as u,Xt as d,Zn as f,at as p,dr as m,f as h,g,h as _,hn as v,jn as y,u as b,ur as x,xt as S,zn as C}from"./index-DwETKpjY.js";import{b as w,h as T,m as E,n as D,r as O,t as k,v as A,y as j}from"./kampService-D4F-2ppi.js";import{t as M}from"./realtime-07s7ItoM.js";import{t as N}from"./groupBy-Bg_SEHjk.js";import{t as P}from"./ScoreboardButton-cO_q_Bk1.js";import{a as ee,l as te,n as ne,r as re}from"./stevne-sxxiDJR-.js";import{a as F,i as I,n as L,o as ie,r as R,s as z,t as B}from"./kampScoreEditor-CwAxEGIi.js";import{C as ae,D as oe,E as se,O as ce,S as le,T as ue,_ as de,b as fe,g as pe,k as V,v as me,x as he,y as ge}from"./padInput-XpWR78GJ.js";function H(e,{showPlayerList:t=!0,initNa:n=null,initFormat:r=null}={}){let i=typeof e==`number`?e:e.length,a=typeof e==`number`?[]:e.map((e,t)=>({...e,cupPlassering:t+1})),o=F(i),s=n===i?i:n!=null&&o.some(e=>e.nA===n)?n:o[0]?.nA??i,c=i-s,l=o.filter(e=>z(e.nA).some(e=>e.c3>0)),u=o.filter(e=>!z(e.nA).some(e=>e.c3>0)),d=z(i).length>0,f=(e,t)=>e.map((e,r)=>{let a=e.nA===s&&n!==i,o=t+r;return`
