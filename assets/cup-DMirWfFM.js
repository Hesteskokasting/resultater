import{n as e,t}from"./logError-Cjb5zwtM.js";import{$ as n,H as r,K as i,Q as a,S as o,Y as s,Z as c,f as l,k as u,q as d,x as f}from"./index-wARUugz0.js";import{t as p}from"./LoadingState-DU0ZcPlb.js";import{C as m,N as h,O as g,T as _,a as v,c as y,i as b,t as x,v as S,y as C}from"./kampService-C_WXpEG0.js";import{n as w}from"./navigation-C6VSc9K5.js";import{b as T,c as E,d as D,g as O,h as ee,l as k,m as A,n as te,p as j,r as ne,s as M,t as N,u as re,v as ie,x as P,y as ae}from"./resultatService-DmkNPf20.js";import{n as F,t as I}from"./scoreEditor-Bnu1ZZiA.js";function L(e){let t=[...e];for(let e=t.length-1;e>0;e--){let n=Math.floor(Math.random()*(e+1));[t[e],t[n]]=[t[n],t[e]]}return t}function R(e){return e===2||e===4?!0:e<2?!1:e%3==0?R(Math.floor(e/3)*2):e%2==0?R(e/2):!1}function z(e){return e%3==0?{c3:e/3,c2:0}:e%2==0?{c3:0,c2:e/2}:{c3:0,c2:0}}function B(e){if(e<2)return[];let t=[],n=Math.floor(e/2);for(let r=e%3;r<=n&&r<=3&&t.filter(e=>e.c2===0).length<2;r+=3){let n=(e-r)/3;if(n<1)break;R(r+2*n)&&t.push({walkovers:r,c3:n,c2:0})}for(let r=e%2;r<=n&&r<=3&&t.filter(e=>e.c3===0).length<2;r+=2){let n=(e-r)/2;if(n<1)break;let i=r+n;!t.some(e=>e.walkovers===r&&e.c3===0&&e.c2===n)&&R(i)&&t.push({walkovers:r,c3:0,c2:n})}return t.sort((e,t)=>e.walkovers-t.walkovers||t.c3-e.c3),t}function V(e){return e===2?!0:B(e).length>0}function H(e){let t=Math.ceil(e*.5),n=Math.round(e*.8),r=[];for(let i=n;i>=t;i--){let t=e-i;t>=2&&V(i)&&V(t)&&r.push({nA:i,nB:t})}return r}function U(e,{runde1:t=null,walkovers1:n=null}={}){let r=[],i=e,a=1,o=!0;for(;i>2;){let e,s,c;if(o){let r=t;!r&&n!==null&&(r={walkovers:n,c3:Math.floor((i-n)/3),c2:0}),r||=B(i)[0]??{walkovers:i%3,c3:Math.floor(i/3),c2:0},c=r.walkovers,e=r.c3,s=r.c2,o=!1}else{let t=z(i);e=t.c3,s=t.c2,c=0}let l=e*2+s+c;r.push({runde:a,players:i,lanes:e+s,threePlayers:e>0,walkovers:c,advancing:l}),i=l,a++}return r}function W(e,{medSeeding:t=!0,isRunde1:n=!1,walkoverTall:r=null,runde1Oppsett:i=null,shuffleFn:a}={}){let o=a??L,s=[],c=[...e];if(n){let e=i?.walkovers??r??c.length%3;if(e>0){let t=c.slice(0,e);c=c.slice(e);for(let e of t)s.push({players:[e.kasterid],isWalkover:!0,isThreePlayers:!1})}}let l=c.length,u,d;if(i&&n)u=i.c3,d=i.c2;else if(n)u=Math.floor(l/3),d=0;else{let e=z(l);u=e.c3,d=e.c2}let f=u+d;if(t&&f>0){let e=o(c.slice(0,f)),t=o(c.slice(f,2*f)),n=o(c.slice(2*f)),r=0;for(let i=0;i<f;i++){let a=i<u,o=[e[i],t[i]].filter(e=>e!=null),c=a?n[r]:void 0;c&&(o.push(c),r++),s.push({players:o.map(e=>e.kasterid),isWalkover:!1,isThreePlayers:a})}}else{let e=o(c),t=0;for(let n=0;n<u;n++)s.push({players:e.slice(t,t+3).map(e=>e.kasterid),isWalkover:!1,isThreePlayers:!0}),t+=3;for(let n=0;n<d;n++)s.push({players:e.slice(t,t+2).map(e=>e.kasterid),isWalkover:!1,isThreePlayers:!1}),t+=2}return s}function G(e,{showPlayerList:t=!0,initNa:n=null,initFormat:r=null}={}){let i=typeof e==`number`?e:e.length,a=typeof e==`number`?[]:e.map((e,t)=>({...e,cupPlassering:t+1})),o=H(i),s=n===i?i:n!=null&&o.some(e=>e.nA===n)?n:o[0]?.nA??i,c=i-s,l=o.filter(e=>B(e.nA).some(e=>e.c3>0)),u=o.filter(e=>!B(e.nA).some(e=>e.c3>0)),d=B(i).length>0,f=(e,t)=>e.map((e,r)=>{let a=e.nA===s&&n!==i,o=t+r;return`
  ...
  `}function K(e,t,n=0,r=0){let i=e.slice(0,t),o=e.slice(t);function s(e,t=0){return e.map((e,n)=>{let r=n<t;return`
    ...
    <div class="card">
      ...
      <div class="card final-dialog-card-wide">
        <div class="final-dialog-drag-handle">
          ...
          <h5 class="mb-1">Gruppe ${a(n)} — Runde ${i}</h5>
    ...
    `,o.querySelector(`#avbryt-tre-btn`).addEventListener(`click`,()=>o.remove()),o.querySelectorAll(`[data-kasterid]`).forEach(e=>{e.addEventListener(`click`,()=>{let t=Number(e.dataset.kasterid),n=a.indexOf(t);n===-1?a.length<2&&a.push(t):a.splice(n,1),s()})}),o.querySelector(`#bekreft-tre-btn`)?.addEventListener(`click`,async()=>{if(a.length!==2)return;let i=t.find(e=>!a.includes(e.rep.kasterid))??null,s=a.map(e=>t.find(t=>t.rep.kasterid===e)).filter(e=>e!=null).map(e=>e.members.map(e=>e.kasterid)),c=t.flatMap(e=>e.members.map(e=>e.kasterid));o.remove();let{error:l}=await x({kampId:e.id,stevneId:n,roundNumber:e.runde_nummer,roundName:e.runde_navn,allThrowerIds:c,eliminatedIds:i?.members.map(e=>e.kasterid)??[],advancingSides:s});if(l){f(`DB-feil ved bekreft`,`error`);return}await r()})}s()}function me(e){return typeof e!=`object`||!e||Array.isArray(e)?null:e}function he(e){return e.map(e=>({er_bekreftet:e.er_bekreftet,er_walkover:e.er_walkover,runde_nummer:e.runde_nummer,bane_nummer:e.bane_nummer,spelarar:ge(e.spelarar)}))}function ge(e){return e.map(e=>({kasterid:e.kasterid??0,kamp_poeng:e.kamp_poeng??0,score_poeng:e.score_poeng??0,antall_ringer:e.antall_ringer,omgangar:e.omgangar,kaster:e.kaster}))}function _e(e){let i=null,a=null,s=!1,c=new Set;async function m(e,{id:t,isAdmin:n=!1},r=null){a=r,s=n,i&&=(await w(i),null),e.replaceChildren(p(`Laster…`)),await h(e,t)}async function h(i,p){try{let[{data:t},{data:m},{data:_},{data:y},{count:b}]=await Promise.all([u(p),v(p),ne(p),te([`A`,`B`]),r(p)]);if(!t){i.replaceChildren(n(`Stevne ikkje funne.`));return}let x=_.filter(e=>e.kasterid!=null),S=m.filter(e=>e.fase===`innledende`),C=m.filter(e=>e.fase===`avsluttende`),w={},A={},j=new Map;for(let e of x)e.startnummer!=null&&(w[e.kasterid]=e.startnummer,j.set(e.startnummer,(j.get(e.startnummer)??0)+1)),e.posisjon!=null&&(A[e.kasterid]=e.posisjon);let M=[...j.values()].some(e=>e>1),N={};for(let e of m)for(let t of e.spelarar)t.kasterid&&t.kaster&&!N[t.kasterid]&&(N[t.kasterid]=`${t.kaster.fornavn} ${t.kaster.etternavn}`);let P=he(S),F=D(P,x,N,w,A),I=S.length>0&&S.every(e=>e.er_bekreftet),L=C.length>0,R=(S.length>0||L)&&S.every(e=>e.er_bekreftet)&&C.every(e=>e.er_bekreftet),z=x.some(e=>e.gruppe!=null),B=Object.fromEntries(y.map(e=>[e.navn,e.id])),V=me(t.runde1_format),H=b??0;if(t.kategori?.erlagbasert){let{data:e}=await l(p);H=e.length}let U={container:i,stevneid:p,stevne:t,standings:F,startNumberMap:w,positionMap:A,isTeam:M,nameMap:N,initialMatches:S,finalMatches:C,results:x,isAdmin:s,hasGroupAssignment:z,allInitialConfirmed:I,hasFinalMatches:L,round1Format:V,unitCount:H,groupNameMap:B,reload:()=>h(i,p)};s&&a&&(a.innerHTML=O(t,{allMatchesConfirmed:R,hasFinalMatches:L,hasGroupAssignment:z,hasPreconfiguredFormat:V!=null&&t.stevne_fase!==`avsluttende`}));let W=ee(i);if(z){let t=ae(F,P,w,{tableId:`standing-final`,hasGroups:!0,hasElimination:!0,positionMap:A,unitLabel:M?`par`:`spelarar`});i.innerHTML=ie(e.renderMatchesHtml(U),t),k(i,`standing-final`,c),re(i),W===`standing`&&T(i,`standing`),e.bindMatchEvents(i,U),g(i,p)}else i.innerHTML=e.renderSetupHtml(U);a?.querySelector(`#complete-tournament-btn`)?.addEventListener(`click`,async()=>{if(!await o({title:`Fullfør turnering`,message:`Vil du fullføre turneringa? Dette kan ikkje angrast.`,danger:!0}))return;let{error:e}=await E(p,[...F.filter(e=>e.gruppe?.navn===`A`),...F.filter(e=>e.gruppe?.navn===`B`),...F.filter(e=>e.gruppe?.navn!==`A`&&e.gruppe?.navn!==`B`)]);if(e){f(`Feil ved lagring av plasseringar`,`error`);return}let{error:t}=await d(p);if(t){f(`Feil ved fullføring av turnering`,`error`);return}await h(i,p)}),e.bindHeaderEvents(a,U)}catch(e){t(`avsluttendeBase.loadAndRender`,e),i.replaceChildren(n(`Kunne ikkje laste avsluttande fase.`))}}function g(t,n){if(i)return;let r=A(n,[`avsluttende`],t,h,()=>{i&&=(w(i),null)});i=C(n,e.channelName(n),r)}return m}function ve(e,t,n){return g(e.spelarar.filter(e=>e.kasterid!=null),t,n)}function $(e){return e?.members.reduce((e,t)=>e+h(t),0)??0}var ye=_e({channelName:e=>`stevne-avsl-cup-${e}`,renderMatchesHtml:e=>{let{finalMatches:t,standings:n,startNumberMap:r,positionMap:i,isTeam:a,isAdmin:o}=e;return`<div class="d-flex gap-3 flex-wrap">${[...new Set(n.map(e=>e.gruppe?.navn).filter(e=>e!=null))].sort().map(e=>{let s=t.filter(t=>t.gruppe_navn===e),c=n.filter(t=>t.gruppe?.navn===e),l=c.filter(e=>e.runde_eliminert==null).length,u=c.length,d=s.length?Math.max(...s.map(e=>e.runde_nummer)):0,f=s.filter(e=>e.runde_nummer===d),p=f.length>0&&f.every(e=>e.er_bekreftet||e.er_walkover),m=s.some(e=>e.runde_navn===`Semifinale`),h=o&&(s.length===0||p)&&l>1&&!m,g=f.length>0&&f.every(e=>e.runde_navn===`Semifinale`),_=s.some(e=>e.runde_navn===`Finale`);return xe(e,s,l,u,d,h,o&&g&&p&&!_,r,i,a?`par`:`spelarar`,o)}).join(``)}</div>`},bindMatchEvents:(e,t)=>{!t.isAdmin&&t.finalMatches.length===0||De(e,t.stevneid,t.finalMatches,t.isAdmin,t.reload,t.startNumberMap,t.positionMap)},renderSetupHtml:e=>{let{stevne:t,isAdmin:n,round1Format:r,unitCount:i,standings:a}=e,o=r?.nA??null;if(t.stevne_fase===`avsluttende`)return n?G(a,{showPlayerList:!0,initNa:o,initFormat:r}):`<p class="text-muted fst-italic">Gruppefordeling er ikkje klar enno.</p>`;if(!n)return``;if(i<2)return`<p class="text-muted fst-italic">${t.kategori?.erlagbasert?`Minst 2 par må vere oppretta før gruppefordelinga kan setjast.`:`Minst 2 spelarar må vere påmelde før gruppefordelinga kan setjast.`}</p>`;let s=a.length>0;return G(s?a:i,{showPlayerList:s,initNa:o,initFormat:r})},bindHeaderEvents:(e,n)=>{let{container:r,stevneid:a,stevne:c,standings:l,results:u,round1Format:d,allInitialConfirmed:p,hasGroupAssignment:m,groupNameMap:h,reload:g}=n;if(e?.querySelector(`#start-final-btn`)?.addEventListener(`click`,async()=>{if(!p)return;let{error:e}=await s(a,`avsluttende`);if(e){f(`Feil ved oppstart av avsluttande fase`,`error`);return}if(d?.nA!=null){let e=d.nA,{error:t}=await M(a,be(l,u,e,h.A??null,h.B??null));if(t){f(`Feil ved lagring av gruppefordeling`,`error`);return}}await g()}),!m){let e=parseInt(r.querySelector(`#group-assignment-wrapper`)?.dataset.n??`0`)||l.length;function t(e,t){let n=r.querySelector(`input[name="${e}"]:checked`);if(n?.dataset.oppsett)try{return JSON.parse(n.dataset.oppsett)}catch{}return B(t)[0]??null}function n(e,t,n){let i=r.querySelector(`#group-preview`);i&&(i.innerHTML=K(l.map((e,t)=>({...e,cupPlassering:t+1})),e,t?.walkovers??0,n?.walkovers??0))}let o=r.querySelector(`#group-panels`);o&&o.addEventListener(`change`,i=>{let a=i.target;if(!a.matches(`input[name^="round1-format"]`))return;let o=parseInt(r.querySelector(`input[name="group-split"]:checked`)?.value??String(e)),s=e-o,c=t(`round1-format-a`,o),l=t(`round1-format-b`,s);if(a.name===`round1-format-a`){let e=r.querySelector(`#structure-a`);e&&(e.outerHTML=q(o,c,`a`))}else{let e=r.querySelector(`#structure-b`);e&&(e.outerHTML=q(s,l,`b`))}n(o,c,l)}),r.querySelectorAll(`input[name="group-split"]`).forEach(t=>{t.addEventListener(`change`,()=>{let r=parseInt(t.value),i=e-r,a=B(r)[0]??null,s=i>=2?B(i)[0]??null:null;o&&(o.innerHTML=`<div id="group-panel-a" class="final-group-col">
                ${J(`Gruppe A`,r,`round1-format-a`,a)}
              </div>`+(i>=2?`<div id="group-panel-b" class="final-group-col">
                ${J(`Gruppe B`,i,`round1-format-b`,s)}
              </div>`:``)),n(r,a,s)})}),r.querySelector(`#confirm-group-btn`)?.addEventListener(`click`,async()=>{let n=r.querySelector(`input[name="group-split"]:checked`);if(!n)return;let o=parseInt(n.value),s=e-o,{error:d}=await i(a,{A:t(`round1-format-a`,o),B:s>=2?t(`round1-format-b`,s):null,nA:o});if(d){f(`Feil ved lagring av format`,`error`);return}if(c.stevne_fase===`avsluttende`){let{error:e}=await M(a,be(l,u,o,h.A??null,h.B??null));if(e){f(`Feil ved lagring av gruppefordeling`,`error`);return}}f(`Gruppefordeling lagra`,`success`),await g()})}e?.querySelector(`#edit-group-assignment-btn`)?.addEventListener(`click`,async()=>{await o({title:`Tilbakestill gruppeinndeling`,message:`Gruppefordeling og format vert fjerna.`,danger:!0})&&(await Promise.all([N(a),i(a,null)]),await g())}),m&&(r.querySelectorAll(`[data-generate-group]`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.dataset.generateGroup??``,n=parseInt(e.dataset.runde??`1`);fe(a,t,l.filter(e=>e.gruppe?.navn===t),n,d,g)})}),r.querySelectorAll(`[data-generate-finale-group]`).forEach(e=>{e.addEventListener(`click`,async()=>{let n=e.dataset.generateFinaleGroup??``;e.disabled=!0,e.textContent=`Genererer…`;try{await de(a,n),await g()}catch(n){t(`cup:genererFinale`,n),f(`Feil ved generering av finale`,`error`),e.disabled=!1,e.textContent=`Generer finale`}})}))}});function be(e,t,n,r,i){return e.flatMap((e,a)=>{let o=a<n?r:i??r,s=e.startnummer==null?[]:t.filter(t=>t.startnummer===e.startnummer).map(e=>e.kasterid);return(s.length?s:[e.kasterid]).map(e=>({kasterid:e,gruppeid:o}))})}function xe(e,t,n,r,i,o,s,c,l,u,d=!0){let f=new Map;for(let e of t)f.has(e.runde_nummer)||f.set(e.runde_nummer,[]),f.get(e.runde_nummer).push(e);let p=[...f.entries()].reverse().map(([e,t])=>{let n=t[0]?.runde_navn??`Runde ${e}`,r=t.filter(e=>!e.er_walkover);return r.length?`
      <h6 class="fw-bold text-center mb-1">${a(n)}</h6>
      <div class="d-flex flex-wrap gap-2 mb-2">
        ${r.map(e=>Ee(e,c,l,d)).join(``)}
      </div>`:``}).join(``),m=i+1,h=o?`<button class="btn btn-success w-100 mt-2"
         data-generate-group="${a(e)}" data-runde="${m}">
         Generer runde ${m}
       </button>`:``,g=s?`<button class="btn btn-success w-100 mt-2" data-generate-finale-group="${a(e)}">
         Generer finale
       </button>`:``;return`
    <div class="final-group-col">
      <h6 class="text-center fw-bold mb-2">Gruppe ${a(e)} (${r} ${a(u)})</h6>
      ${h}
      ${g}
      ${p}
