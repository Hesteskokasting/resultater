import{$ as e,A as t,F as n,G as r,H as i,L as a,N as o,Q as s,S as c,U as l,V as u,W as d,Z as f,a as p,b as m,c as h,d as g,et as _,f as v,g as y,h as b,i as x,j as S,k as C,m as w,q as T,s as E,tt as D,u as O,v as k,x as A,y as j,z as M}from"./index-DwQ8eJ0f.js";import{t as N}from"./ScoreNumberpad-C-b3sWkY.js";var P=null,F=null,I=null,L=null;function R(){return P||(P=document.createElement(`div`),P.className=`modal`,P.style.display=`none`,P.setAttribute(`role`,`dialog`),P.setAttribute(`aria-modal`,`true`),P.setAttribute(`aria-labelledby`,`pd-title`),P.innerHTML=`
