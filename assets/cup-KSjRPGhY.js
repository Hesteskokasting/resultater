import{t as e}from"./logError-DhxY2JQv.js";import{C as t,G as n,J as r,V as i,W as a,Y as o,j as s,p as c,q as l,v as u,y as d}from"./index-C_tXKeOg.js";import{t as f}from"./LoadingState-xRmJ3K_t.js";import{C as p,N as m,S as h,a as g,b as _,f as v,k as y,n as b,s as x,x as S,y as C}from"./kampService-Cdqslr0w.js";import{t as w}from"./realtime-NvcShmho.js";import{a as T,i as E,n as D,o as O,r as k,s as A}from"./kampGenereringCupService-DdzQK5Tm.js";import{_ as j,b as M,c as ee,d as te,f as N,g as ne,h as P,l as F,m as re,n as ie,r as I,s as L,t as R,u as ae,x as z,y as oe}from"./resultatService-DLDGX0pg.js";import{n as B,t as V}from"./scoreEditor-C5F_rpcY.js";function H(e,{visSpelarliste:t=!0,initNa:n=null,initFormat:r=null}={}){let i=typeof e==`number`?e:e.length,a=typeof e==`number`?[]:e.map((e,t)=>({...e,cupPlassering:t+1})),o=O(i),s=n===i?i:n!=null&&o.some(e=>e.nA===n)?n:o[0]?.nA??i,c=i-s,l=o.filter(e=>A(e.nA).some(e=>e.c3>0)),u=o.filter(e=>!A(e.nA).some(e=>e.c3>0)),d=A(i).length>0,f=(e,t)=>e.map((e,r)=>{let a=e.nA===s&&n!==i,o=t+r;return`
