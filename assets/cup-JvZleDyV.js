import{n as e,t}from"./logError-D5z16FyH.js";import{D as n,E as r,St as i,T as a,a as o,bt as s,g as c,ht as l,nt as u,wt as d,yt as f}from"./index-CApPqR2n.js";import{t as p}from"./LoadingState-CllUVMAe.js";import{C as m,N as h,O as g,T as _,a as v,c as y,i as b,t as x,v as S,y as C}from"./kampService-D1sz2b5T.js";import{n as w}from"./navigation-KP4Hrbbr.js";import{t as T}from"./LivePill-1-grqP3m.js";import{C as E,D,E as O,O as k,S as ee,T as A,_ as te,b as j,g as ne,h as M,l as re,m as ie,o as N,p as P,s as ae,v as oe,x as F}from"./omgangValidation-Dw0wvKyM.js";import{l as I,m as se}from"./xkastKongelagService-BHw4VCz7.js";import{n as L}from"./ScoreNumberpad-CcjhoeyY.js";import{t as ce}from"./scoreEditor-t5-K4nkD.js";function R(e){let t=[...e];for(let e=t.length-1;e>0;e--){let n=Math.floor(Math.random()*(e+1));[t[e],t[n]]=[t[n],t[e]]}return t}function z(e){return e===2||e===4?!0:e<2?!1:e%3==0?z(Math.floor(e/3)*2):e%2==0?z(e/2):!1}function B(e){return e%3==0?{c3:e/3,c2:0}:e%2==0?{c3:0,c2:e/2}:{c3:0,c2:0}}function V(e){if(e<2)return[];let t=[],n=Math.floor(e/2);for(let r=e%3;r<=n&&r<=3&&t.filter(e=>e.c2===0).length<2;r+=3){let n=(e-r)/3;if(n<1)break;z(r+2*n)&&t.push({walkovers:r,c3:n,c2:0})}for(let r=e%2;r<=n&&r<=3&&t.filter(e=>e.c3===0).length<2;r+=2){let n=(e-r)/2;if(n<1)break;let i=r+n;!t.some(e=>e.walkovers===r&&e.c3===0&&e.c2===n)&&z(i)&&t.push({walkovers:r,c3:0,c2:n})}return t.sort((e,t)=>e.walkovers-t.walkovers||t.c3-e.c3),t}function H(e){return e===2?!0:V(e).length>0}function le(e){let t=Math.ceil(e*.5),n=Math.round(e*.8),r=[];for(let i=n;i>=t;i--){let t=e-i;t>=2&&H(i)&&H(t)&&r.push({nA:i,nB:t})}return r}function ue(e,{runde1:t=null,walkovers1:n=null}={}){let r=[],i=e,a=1,o=!0;for(;i>2;){let e,s,c;if(o){let r=t;!r&&n!==null&&(r={walkovers:n,c3:Math.floor((i-n)/3),c2:0}),r||=V(i)[0]??{walkovers:i%3,c3:Math.floor(i/3),c2:0},c=r.walkovers,e=r.c3,s=r.c2,o=!1}else{let t=B(i);e=t.c3,s=t.c2,c=0}let l=e*2+s+c;r.push({runde:a,players:i,lanes:e+s,threePlayers:e>0,walkovers:c,advancing:l}),i=l,a++}return r}function U(e,{medSeeding:t=!0,isRunde1:n=!1,walkoverTall:r=null,runde1Oppsett:i=null,shuffleFn:a}={}){let o=a??R,s=[],c=[...e];if(n){let e=i?.walkovers??r??c.length%3;if(e>0){let t=c.slice(0,e);c=c.slice(e);for(let e of t)s.push({players:[e.kasterid],isWalkover:!0,isThreePlayers:!1})}}let l=c.length,u,d;if(i&&n)u=i.c3,d=i.c2;else if(n)u=Math.floor(l/3),d=0;else{let e=B(l);u=e.c3,d=e.c2}let f=u+d;if(t&&f>0){let e=o(c.slice(0,f)),t=o(c.slice(f,2*f)),n=o(c.slice(2*f)),r=0;for(let i=0;i<f;i++){let a=i<u,o=[e[i],t[i]].filter(e=>e!=null),c=a?n[r]:void 0;c&&(o.push(c),r++),s.push({players:o.map(e=>e.kasterid),isWalkover:!1,isThreePlayers:a})}}else{let e=o(c),t=0;for(let n=0;n<u;n++)s.push({players:e.slice(t,t+3).map(e=>e.kasterid),isWalkover:!1,isThreePlayers:!0}),t+=3;for(let n=0;n<d;n++)s.push({players:e.slice(t,t+2).map(e=>e.kasterid),isWalkover:!1,isThreePlayers:!1}),t+=2}return s}function W(e,{showPlayerList:t=!0,initNa:n=null,initFormat:r=null}={}){let i=typeof e==`number`?e:e.length,a=typeof e==`number`?[]:e.map((e,t)=>({...e,cupPlassering:t+1})),o=le(i),s=n===i?i:n!=null&&o.some(e=>e.nA===n)?n:o[0]?.nA??i,c=i-s,l=o.filter(e=>V(e.nA).some(e=>e.c3>0)),u=o.filter(e=>!V(e.nA).some(e=>e.c3>0)),d=V(i).length>0,f=(e,t)=>e.map((e,r)=>{let a=e.nA===s&&n!==i,o=t+r;return`
  ...
  `}function G(e,t,n=0,r=0){let i=e.slice(0,t),a=e.slice(t),s=e.some(e=>e.poeng_xkast!=null);function c(e,t=0){return e.map((e,n)=>{let r=n<t,i=s?e.antall_ring_xkast??0:e.kamp_poeng??0,a=s?e.poeng_xkast??0:e.score_poeng??0;return`
      <tr>
    ...
    `,s.querySelector(`#avbryt-tre-btn`).addEventListener(`click`,()=>s.remove()),s.querySelectorAll(`[data-kasterid]`).forEach(e=>{e.addEventListener(`click`,()=>{let t=Number(e.dataset.kasterid),n=o.indexOf(t);n===-1?o.length<2&&o.push(t):o.splice(n,1),c()})}),s.querySelector(`#bekreft-tre-btn`)?.addEventListener(`click`,async()=>{if(o.length!==2)return;let a=t.find(e=>!o.includes(e.rep.kasterid))??null,c=o.map(e=>t.find(t=>t.rep.kasterid===e)).filter(e=>e!=null).map(e=>e.members.map(e=>e.kasterid)),l=t.flatMap(e=>e.members.map(e=>e.kasterid));s.remove();let{error:u}=await x({kampId:e.id,stevneId:n,roundNumber:e.runde_nummer,roundName:e.runde_navn,allThrowerIds:l,eliminatedIds:a?.members.map(e=>e.kasterid)??[],advancingSides:c});if(u){r(`DB-feil ved bekreft`,`error`);return}await i()})}c()}function Se(e){return typeof e!=`object`||!e||Array.isArray(e)?null:e}function Ce(e){return e.map(e=>({er_bekreftet:e.er_bekreftet,er_walkover:e.er_walkover,runde_nummer:e.runde_nummer,bane_nummer:e.bane_nummer,spelarar:we(e.spelarar)}))}function we(e){return e.map(e=>({kasterid:e.kasterid??0,kamp_poeng:e.kamp_poeng??0,score_poeng:e.score_poeng??0,antall_ringer:e.antall_ringer,omgangar:e.omgangar,kaster:e.kaster}))}function Te(e){let i=null,a=null,o=!1,f=new Set;async function m(e,{id:t,isAdmin:n=!1},r=null){a=r,o=n,i&&=(await w(i),null),e.replaceChildren(p(`Laster…`)),await h(e,t)}async function h(i,p){try{let[{data:t},{data:m},{data:_},{data:y},{count:b}]=await Promise.all([u(p),v(p),re(p),ae([`A`,`B`]),l(p)]);if(!t){i.replaceChildren(d(`Stevne ikkje funne.`));return}let x=_.filter(e=>e.kasterid!=null),S=m.filter(e=>e.fase===`innledende`),C=m.filter(e=>e.fase===`avsluttende`),w={},T={},k=new Map;for(let e of x)e.startnummer!=null&&(w[e.kasterid]=e.startnummer,k.set(e.startnummer,(k.get(e.startnummer)??0)+1)),e.posisjon!=null&&(T[e.kasterid]=e.posisjon);let j=[...k.values()].some(e=>e>1),M={};for(let e of m)for(let t of e.spelarar)t.kasterid&&t.kaster&&!M[t.kasterid]&&(M[t.kasterid]=`${t.kaster.fornavn} ${t.kaster.etternavn}`);for(let e of x)e.kaster&&!M[e.kasterid]&&(M[e.kasterid]=`${e.kaster.fornavn} ${e.kaster.etternavn}`);let N=Ce(S),P=oe(N,x,M,w,T),F=S.length>0&&S.every(e=>e.er_bekreftet),I=C.length>0,se=(S.length>0||I)&&S.every(e=>e.er_bekreftet)&&C.every(e=>e.er_bekreftet),L=x.some(e=>e.gruppe!=null),ce=Object.fromEntries(y.map(e=>[e.navn,e.id])),R=Se(t.runde1_format),z=b??0;if(t.kategori?.erlagbasert){let{data:e}=await c(p);z=e.length}let B={container:i,stevneid:p,stevne:t,standings:P,startNumberMap:w,positionMap:T,isTeam:j,nameMap:M,initialMatches:S,finalMatches:C,results:x,isAdmin:o,hasGroupAssignment:L,allInitialConfirmed:F,hasFinalMatches:I,round1Format:R,unitCount:z,groupNameMap:ce,reload:()=>h(i,p)};o&&a&&(a.innerHTML=E(t,{allMatchesConfirmed:se,hasFinalMatches:I,hasGroupAssignment:L,hasPreconfiguredFormat:R!=null&&t.stevne_fase!==`avsluttende`}));let V=ee(i);if(L){let t=O(P,N,w,{tableId:`standing-final`,hasGroups:!0,hasElimination:!0,positionMap:T,unitLabel:j?`par`:`spelarar`});i.innerHTML=A(e.renderMatchesHtml(B),t),ne(i,`standing-final`,f),te(i),V===`standing`&&D(i,`standing`),e.bindMatchEvents(i,B),g(i,p)}else i.innerHTML=e.renderSetupHtml(B);a?.querySelector(`#complete-tournament-btn`)?.addEventListener(`click`,async()=>{if(!await n({title:`Fullfør turnering`,message:`Vil du fullføre turneringa? Dette kan ikkje angrast.`,danger:!0}))return;let{error:e}=await ie(p,[...P.filter(e=>e.gruppe?.navn===`A`),...P.filter(e=>e.gruppe?.navn===`B`),...P.filter(e=>e.gruppe?.navn!==`A`&&e.gruppe?.navn!==`B`)]);if(e){r(`Feil ved lagring av plasseringar`,`error`);return}let{error:t}=await s(p);if(t){r(`Feil ved fullføring av turnering`,`error`);return}await h(i,p)}),e.bindHeaderEvents(a,B)}catch(e){t(`avsluttendeBase.loadAndRender`,e),i.replaceChildren(d(`Kunne ikkje laste avsluttande fase.`))}}function g(t,n){if(i)return;let r=F(n,[`avsluttende`],t,h,()=>{i&&=(w(i),null)});i=C(n,e.channelName(n),r)}return m}function Ee(e,t,n){return g(e.spelarar.filter(e=>e.kasterid!=null),t,n)}function Q(e){return e?.members.reduce((e,t)=>e+h(t),0)??0}var De=Te({channelName:e=>`stevne-avsl-cup-${e}`,renderMatchesHtml:e=>{let{finalMatches:t,standings:n,startNumberMap:r,positionMap:i,isTeam:a,isAdmin:o}=e;return`<div class="d-flex gap-3 flex-wrap">${[...new Set(n.map(e=>e.gruppe?.navn).filter(e=>e!=null))].sort().map(e=>{let s=t.filter(t=>t.gruppe_navn===e),c=n.filter(t=>t.gruppe?.navn===e),l=c.filter(e=>e.runde_eliminert==null).length,u=c.length,d=s.length?Math.max(...s.map(e=>e.runde_nummer)):0,f=s.filter(e=>e.runde_nummer===d),p=f.length>0&&f.every(e=>e.er_bekreftet||e.er_walkover),m=s.some(e=>e.runde_navn===`Semifinale`),h=o&&(s.length===0||p)&&l>1&&!m,g=f.length>0&&f.every(e=>e.runde_navn===`Semifinale`),_=s.some(e=>e.runde_navn===`Finale`);return Oe(e,s,l,u,d,h,o&&g&&p&&!_,r,i,a?`par`:`spelarar`,o)}).join(``)}</div>`},bindMatchEvents:(e,t)=>{!t.isAdmin&&t.finalMatches.length===0||Pe(e,t.stevneid,t.finalMatches,t.isAdmin,t.reload,t.startNumberMap,t.positionMap)},renderSetupHtml:e=>{let{stevne:t,isAdmin:n,round1Format:r,unitCount:i,standings:a}=e,o=r?.nA??null;if(t.stevne_fase===`avsluttende`)return n?W(a,{showPlayerList:!0,initNa:o,initFormat:r}):`<p class="text-muted fst-italic">Gruppefordeling er ikkje klar enno.</p>`;if(!n)return``;if(i<2)return`<p class="text-muted fst-italic">${t.kategori?.erlagbasert?`Minst 2 par må vere oppretta før gruppefordelinga kan setjast.`:`Minst 2 spelarar må vere påmelde før gruppefordelinga kan setjast.`}</p>`;let s=a.length>0;return W(s?a:i,{showPlayerList:s,initNa:o,initFormat:r})},bindHeaderEvents:(e,o)=>{let{container:s,stevneid:c,stevne:l,standings:u,results:d,round1Format:p,allInitialConfirmed:m,hasGroupAssignment:h,groupNameMap:g,reload:_}=o;if(e?.querySelector(`#start-final-btn`)?.addEventListener(`click`,async()=>{if(!m)return;let{error:e}=await i(c,`avsluttende`);if(e){r(`Feil ved oppstart av avsluttande fase`,`error`);return}if(p?.nA!=null){let e=p.nA,{error:t}=await P(c,$(u,d,e,g.A??null,g.B??null));if(t){r(`Feil ved lagring av gruppefordeling: `+a(t),`error`);return}}await _()}),!h){let e=parseInt(s.querySelector(`#group-assignment-wrapper`)?.dataset.n??`0`)||u.length;function t(e,t){let n=s.querySelector(`input[name="${e}"]:checked`);if(n?.dataset.oppsett)try{return JSON.parse(n.dataset.oppsett)}catch{}return V(t)[0]??null}function n(e,t,n){let r=s.querySelector(`#group-preview`);r&&(r.innerHTML=G(u.map((e,t)=>({...e,cupPlassering:t+1})),e,t?.walkovers??0,n?.walkovers??0))}let o=s.querySelector(`#group-panels`);o&&o.addEventListener(`change`,r=>{let i=r.target;if(!i.matches(`input[name^="round1-format"]`))return;let a=parseInt(s.querySelector(`input[name="group-split"]:checked`)?.value??String(e)),o=e-a,c=t(`round1-format-a`,a),l=t(`round1-format-b`,o);if(i.name===`round1-format-a`){let e=s.querySelector(`#structure-a`);e&&(e.outerHTML=K(a,c,`a`))}else{let e=s.querySelector(`#structure-b`);e&&(e.outerHTML=K(o,l,`b`))}n(a,c,l)}),s.querySelectorAll(`input[name="group-split"]`).forEach(t=>{t.addEventListener(`change`,()=>{let r=parseInt(t.value),i=e-r,a=V(r)[0]??null,s=i>=2?V(i)[0]??null:null;o&&(o.innerHTML=`<div id="group-panel-a" class="final-group-col">
                ${q(`Gruppe A`,r,`round1-format-a`,a)}
              </div>`+(i>=2?`<div id="group-panel-b" class="final-group-col">
                ${q(`Gruppe B`,i,`round1-format-b`,s)}
              </div>`:``)),n(r,a,s)})}),s.querySelector(`#confirm-group-btn`)?.addEventListener(`click`,async()=>{let n=s.querySelector(`input[name="group-split"]:checked`);if(!n)return;let o=parseInt(n.value),p=e-o,{error:m}=await f(c,{A:t(`round1-format-a`,o),B:p>=2?t(`round1-format-b`,p):null,nA:o});if(m){r(`Feil ved lagring av format: `+a(m),`error`);return}let h=l.stevne_fase;if(h!==`avsluttende`&&se(l.kastemetodeInnl?.navn??``)){let{data:e}=await I(c);if(!e){r(`Fullfør den innleiande fasen før cupen kan startast`,`error`);return}let{error:t}=await i(c,`avsluttende`);if(t){r(`Feil ved oppstart av avsluttande fase: `+a(t),`error`);return}h=`avsluttende`}if(h===`avsluttende`){let{error:e}=await P(c,$(u,d,o,g.A??null,g.B??null));if(e){r(`Feil ved lagring av gruppefordeling: `+a(e),`error`);return}}r(`Gruppefordeling lagra`,`success`),await _()})}e?.querySelector(`#edit-group-assignment-btn`)?.addEventListener(`click`,async()=>{await n({title:`Tilbakestill gruppeinndeling`,message:`Gruppefordeling og format vert fjerna.`,danger:!0})&&(await Promise.all([N(c),f(c,null)]),await _())}),h&&(s.querySelectorAll(`[data-generate-group]`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.dataset.generateGroup??``,n=parseInt(e.dataset.runde??`1`);be(c,t,u.filter(e=>e.gruppe?.navn===t),n,p,_)})}),s.querySelectorAll(`[data-generate-finale-group]`).forEach(e=>{e.addEventListener(`click`,async()=>{let n=e.dataset.generateFinaleGroup??``;e.disabled=!0,e.textContent=`Genererer…`;try{await ye(c,n),await _()}catch(n){t(`cup:genererFinale`,n),r(`Feil ved generering av finale`,`error`),e.disabled=!1,e.textContent=`Generer finale`}})}))}});function $(e,t,n,r,i){return e.flatMap((e,a)=>{let o=a<n?r:i??r,s=e.startnummer==null?[]:t.filter(t=>t.startnummer===e.startnummer).map(e=>e.kasterid);return(s.length?s:[e.kasterid]).map(e=>({kasterid:e,gruppeid:o}))})}function Oe(e,t,n,r,i,a,s,c,l,u,d=!0){let f=new Map;for(let e of t)f.has(e.runde_nummer)||f.set(e.runde_nummer,[]),f.get(e.runde_nummer).push(e);let p=[...f.entries()].reverse().map(([e,t])=>{let n=t[0]?.runde_navn??`Runde ${e}`,r=t.filter(e=>!e.er_walkover);return r.length?`
      <h6 class="fw-bold text-center mb-1">${o(n)}</h6>
      <div class="d-flex flex-wrap gap-2 mb-2">
        ${r.map(e=>Ne(e,c,l,d)).join(``)}
    ...
    <td class="${u}"${d}>${a}</td>
        ...
        <td colspan="2">${k(t[0]??null,!1)} <span class="badge bg-secondary">Walkover</span></td>
          ...
          </tr>`}function Ne(e,t,n,r=!0){let i=Ee(e,t,n),a=e.er_bekreftet||e.er_walkover,o=e.spelarar.some(e=>(e.omgangar?.length??0)>0),s={isConfirmed:a,hasRounds:o,canEditScore:r&&e.er_bekreftet&&!e.er_tre_spelarar&&!o,isThreeSides:e.er_tre_spelarar},c=r?Me(e,a,je(e,i,o,a)):``;return`
    ...
    </div>`}function Pe(e,n,i,a,o,s,c){M(e);for(let l of i){let i=Ee(l,s,c),u=i[0]??null,d=i[1]??null,f=u?.rep??null,p=d?.rep??null,h=k(u,!1),g=k(d,!1),v=i.flatMap(e=>e.members.map(e=>e.id)),y=async(e,n)=>{let r=[];f?.id&&r.push(m(f.id,e)),p?.id&&r.push(m(p.id,n));for(let e of[u,d])for(let t of e?.members.slice(1)??[])r.push(m(t.id,0));try{return(await Promise.all(r)).find(e=>e.error)??null}catch(e){return t(`cup:writeSideScore`,e),{error:e}}};if(e.querySelector(`#plus-${l.id}`)?.addEventListener(`click`,()=>{ce({side1Name:h,side2Name:g,currentS1:Q(u),currentS2:Q(d),playerIds:v,hasRounds:l.spelarar.some(e=>(e.omgangar?.length??0)>0),logPrefix:`cup`,onSave:y,onSaved:o})}),e.querySelector(`#bekrft-${l.id}`)?.addEventListener(`click`,async e=>{if(l.er_tre_spelarar)xe(l,i,n,o);else{let t=e.currentTarget;t.disabled=!0,t.textContent=`Lagrer…`;try{await Fe(n,l,i,o)||(t.disabled=!1,t.textContent=`Bekreft`)}catch{t.disabled=!1,t.textContent=`Bekreft`}}}),a&&l.er_bekreftet&&!l.er_tre_spelarar){let t=i.flatMap(e=>e.members.map(e=>e.kasterid)),a=()=>{L([{name:h,score:Q(u)},{name:g,score:Q(d)}],async([e=0,i=0])=>{if(v.length){let{error:e}=await b(v);if(e){r(`DB-feil ved sletting av omgangar`,`error`);return}}if(await y(e,i)){r(`DB-feil ved oppdatering av score`,`error`);return}let a=e>=i?u:d,s=e>=i?d:u,c=a?.members.map(e=>e.kasterid)??[],f=s?.members.map(e=>e.kasterid)??[],p=[...c.map(e=>({kasterid:e,plassering:1})),...f.map(e=>({kasterid:e,plassering:2}))],{error:m}=await S(l.id,p);if(m){r(`DB-feil ved oppdatering av plassering`,`error`);return}await _({stevneId:n,roundNumber:l.runde_nummer,roundName:l.runde_navn,allThrowerIds:t,newWinnerIds:c,newLoserIds:f}),await o()})};e.querySelectorAll(`[data-endre-score="${l.id}"]`).forEach(e=>e.addEventListener(`click`,a))}}}async function Fe(e,t,i,a){let o=i[0]??null,s=i[1]??null,{data:c}=await y(t.id),l=e=>e?.members.reduce((e,t)=>e+h(c.find(e=>e.id===t.id)??t),0)??0,u=l(o),d=l(s);if(u===0&&d===0&&!await n({title:`Ingen score registrert`,message:`Vil du bekrefte kampen likevel?`}))return!1;let f=u>=d?o:s,p=u>=d?s:o,m=i.flatMap(e=>e.members.map(e=>e.kasterid)),{error:g}=await x({kampId:t.id,stevneId:e,roundNumber:t.runde_nummer,roundName:t.runde_navn,allThrowerIds:m,eliminatedIds:p?.members.map(e=>e.kasterid)??[],advancingSides:f?[f.members.map(e=>e.kasterid)]:[]});return g?(r(`DB-feil ved bekreft`,`error`),!1):(await a(),!0)}export{De as render};