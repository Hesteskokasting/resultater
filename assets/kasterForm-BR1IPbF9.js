import{t as e}from"./logError-CB4-2Lin.js";import{L as t,Lt as n,R as r,c as i}from"./index-HV6oZghK.js";import{a,i as o,n as s,o as c,r as l,s as u,t as d}from"./_formButtons-3yhgsTJU.js";import{t as f}from"./LoadingState-C6NB62Ct.js";import{a as p}from"./klubbService-BuTqcngo.js";import{t as m}from"./buildDropdownOptions-Cb0G9Gy7.js";import{t as h}from"./formNum-HGeagI_O.js";import{a as g,m as _,n as v,s as y,t as b,u as x}from"./kasterService-CGoztUaG.js";async function S(S,C){let{container:w}=S;w.replaceChildren(f());let T=[],E=[],D=[];try{let e=await Promise.all([p(),g(),y()]);T=e[0].data,E=e[1].data,D=e[2].data}catch(t){e(`kasterForm.mount`,t),w.replaceChildren(n(`Kunne ikkje laste skjema.`));return}let O=null;if(C){let{data:e,error:i}=await x(C);if(i||!e){w.replaceChildren(n(`Utøvar ikkje funne.`));return}if(O=e,!await t()&&!await r(O.klubbid??void 0)){w.replaceChildren(n(`Ingen tilgang til denne utøvaren.`));return}}let k=O??{},A=T.map(e=>`<option value="${e.id}"${e.id===k.klubbid?` selected`:``}>${i(e.navn)}</option>`).join(``),{wrapper:j,headingHtml:M}=l(S);j.innerHTML=`
    ${M}
