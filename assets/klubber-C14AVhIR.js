import{t as e}from"./logError-CLfrcMax.js";import{S as t,b as n,dr as r,f as i,i as a,lr as o,ur as s,y as c}from"./index-B6btTGQ6.js";import{a as l,n as u,r as d}from"./klubbService-D9_HMteq.js";import{o as f,r as p}from"./kasterService-47iJbgKE.js";import{t as m}from"./SearchInput-CDoDGwhR.js";import{t as h}from"./AdminLinkBar-BUX2NIb2.js";import{t as g}from"./Table-B_UMcRWp.js";function _(e){let n=new Map;for(let r of e){if(!r.klubb?.id)continue;let e=t(r).toLowerCase(),i=n.get(r.klubb.id);i?i.push(e):n.set(r.klubb.id,[e])}return n}function v(e,t,n){let r=n.trim().toLowerCase();return r?e.filter(e=>e.navn.toLowerCase().includes(r)||(t.get(e.id)??[]).some(e=>e.includes(r))):e}function y(e,n){let r=n.trim().toLowerCase();return r?e.filter(e=>t(e).toLowerCase().includes(r)):e}var b={searchText:``};function x(e,t){return`
