import{t as e}from"./logError-CLfrcMax.js";import{Nt as t,O as n,dr as r,f as i,h as a,k as o,ur as s}from"./index-B6btTGQ6.js";import{a as c}from"./klubbService-D9_HMteq.js";import{a as l,i as u,n as d,r as f,t as p}from"./_formButtons-Db82UJcH.js";import{t as m}from"./dropdown-D1R0rX3D.js";import{t as h}from"./formNum-HGeagI_O.js";import{a as g,m as _,n as v,s as y,t as b,u as x}from"./kasterService-47iJbgKE.js";async function S(S,C){let{container:w}=S;w.replaceChildren(r());let T=[],E=[],D=[];try{let e=await Promise.all([c(),g(),y()]);T=e[0].data,E=e[1].data,D=e[2].data}catch(t){e(`kasterForm.mount`,t),w.replaceChildren(s(`Kunne ikkje laste skjema.`));return}let O=null;if(C){let{data:e,error:t}=await x(C);if(t||!e){w.replaceChildren(s(`Utøvar ikkje funne.`));return}if(O=e,!await n()&&!await o(O.klubbid??void 0)){w.replaceChildren(s(`Ingen tilgang til denne utøvaren.`));return}}let k=O??{},A=T.map(e=>`<option value="${e.id}"${e.id===k.klubbid?` selected`:``}>${i(e.navn)}</option>`).join(``),{wrapper:j,headingHtml:M}=u(S);j.innerHTML=`
    ${M}
