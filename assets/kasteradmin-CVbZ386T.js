import{t as e}from"./logError-Cjb5zwtM.js";import{a as t,i as n}from"./authService-BSCiMkAt.js";import{Q as r,S as i,Z as a}from"./index-CDZhvbt-.js";import{i as o,n as s,r as c,t as l}from"./adminForms-BC6ejmsk.js";import{r as u}from"./klubbService-CPrDwSKB.js";import{a as d,l as f,n as p,p as m,s as h,t as g}from"./kasterService-CGwZfLdY.js";import{t as _}from"./LoadingState-DU0ZcPlb.js";import{t as v}from"./buildDropdownOptions-VZU7mde3.js";import{t as y}from"./formNum-BTZ_qfFL.js";async function b(b,x={}){let S=x.id===void 0?void 0:Number(x.id);b.replaceChildren(_());let C=[],w=[],T=[];try{let e=await Promise.all([u(),d(),h()]);C=e[0].data,w=e[1].data,T=e[2].data}catch(t){e(`kasteradmin.render`,t),b.replaceChildren(r(`Kunne ikkje laste skjema.`));return}let E=null;if(S){let{data:e,error:i}=await f(S);if(i||!e){b.replaceChildren(r(`Utøvar ikkje funne.`));return}if(E=e,!await n()&&!await t(E.klubbid??void 0)){b.replaceChildren(r(`Ingen tilgang til denne utøvaren.`));return}}let D=S?`Rediger utøvar: ${E?`${a(E.fornavn)} ${a(E.etternavn)}`:``}`:`Ny utøvar`,O=E??{};b.innerHTML=`
