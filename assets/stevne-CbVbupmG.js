const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/gloppen-B13jJGFj.js","assets/index-Da1LWJ6B.js","assets/vendor-3yxEHqvy.js","assets/rolldown-runtime-lhHHWwHU.js","assets/index-BvF18F-H.css","assets/innledendeBase-DL69Q56a.js","assets/ConfirmDialog-3D8QuJxP.js","assets/LivePill-BTyzkGe4.js","assets/createEl-CcdmiJqp.js","assets/LoadingState-RVZNML7E.js","assets/resultatService-BQxi6Idy.js","assets/Table-DSqyRM9K.js","assets/kamp-Bpd8LcU6.js","assets/kampService-B2KGSocz.js","assets/testDataService-WybdN5T9.js","assets/realtime-DWfJe3XN.js","assets/nordhordland-C8Sp97GP.js","assets/kampGenereringInnledendeService-CJWjCFUI.js","assets/xkast-CR2opgQ6.js","assets/cup-Bp8BtnPb.js","assets/kampGenereringCupService-Bfn1jJzj.js","assets/pameldingService-BXBmx10T.js","assets/kongelag-BHDEXFhT.js","assets/nordhordland-rn_OZDFc.js"])))=>i.map(i=>d[i]);
import{$ as e,C as t,G as n,L as r,M as i,N as a,R as o,S as s,U as c,W as l,Y as u,Z as d,_ as f,ct as p,i as m,n as h,nt as g,r as _,rt as v,t as y,ut as b,y as x}from"./index-Da1LWJ6B.js";import{o as S}from"./kasterService-DnviXK0V.js";import{t as C}from"./LoadingState-RVZNML7E.js";import{t as w}from"./EmptyState-a5aDhc-8.js";import{t as T}from"./ConfirmDialog-3D8QuJxP.js";import{t as E}from"./realtime-DWfJe3XN.js";import{t as D}from"./Tabs-D6JHD9IR.js";import{a as O,f as k,i as A,l as ee,p as te,r as j,s as M,t as ne,u as N}from"./pameldingService-BXBmx10T.js";import{a as P,o as F}from"./resultatService-BQxi6Idy.js";import{t as I}from"./kampGenereringInnledendeService-CJWjCFUI.js";import{n as re}from"./testDataService-WybdN5T9.js";function L(e){if(e instanceof Error)return e.message;if(typeof e==`object`&&e&&`message`in e){let t=e.message;if(typeof t==`string`)return t}return String(e)}async function R(e,{id:t,isAdmin:i=!1},a=null){e.replaceChildren(C());try{let[o,c,f]=await Promise.all([s(t),A(t),m()]);if(o.error||!o.data){e.replaceChildren(n(`Stevne ikkje funne.`));return}let p=o.data,h=p.stevne_fase??null,g=h===null||h===`ikke_startet`,_=p.kastemetodeInnl?.navn??`—`,v=_.toLowerCase().includes(`gloppen`),b=p.kategori?.erlagbasert??!1;if(a&&g&&i){a.innerHTML=`<button id="start-stevne-btn" class="btn btn-sm btn-success">Start stevne</button>`;let e=a.querySelector(`#start-stevne-btn`);e.addEventListener(`click`,async()=>{if(b?c<4:c<2){y(b?`Stevnet treng minst 2 par (4 spelarar) for å startast.`:`Stevnet må ha minst 2 spelarar for å startast.`,`error`);return}if(v&&!p.antall_runder_innl){y(`Du må setje antal rundar for innledande fase. Gå til Innstillingar for å endre.`,`error`);return}let n=await O(t);if(n>0&&!await T({title:`Ubekrefta spelarar`,message:`${n} spelar(ar) er ikkje bekrefta. Vil du starte stevnet likevel?`}))return;e.disabled=!0,e.textContent=`Starter…`;try{await I(t,_,p.antall_runder_innl??1,b)}catch(t){y(`Feil ved kampgenerering: `+L(t),`error`),e.disabled=!1,e.textContent=`Start stevne`;return}let{error:i}=await r(t,`innledende`);if(i){y(`Feil ved oppdatering av fase.`,`error`),e.disabled=!1,e.textContent=`Start stevne`;return}location.hash=`#/stevne/${t}/innledende`})}e.innerHTML=`
