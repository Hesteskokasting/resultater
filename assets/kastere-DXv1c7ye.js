...
import{t as e}from"./logError-CB4-2Lin.js";import{Bt as t,Gt as n,Lt as r,Yt as i,c as a,i as o}from"./index-DXJSs_ua.js";import{t as s}from"./LoadingState-C6NB62Ct.js";import{i as c,l,r as u}from"./kasterService-D9jqvobU.js";import{t as d}from"./EmptyState-CCNgsnix.js";import{n as f,r as p}from"./kaster-2cwCS5i9.js";import{t as m}from"./SearchInput-BwD50MFz.js";import{t as h}from"./AdminLinkBar-DOUuCvRc.js";var g=24,_=`https://placehold.co/200x200/444/888?text=?`,v={showAll:!1,searchText:``,page:1};function y(e){let t=p(e);return`
    <a href="#/kastere/${f(e)}" class="thrower-card">
      <img src="${a(e.avatarurl||_)}" alt="${a(t)}" loading="lazy">
    ...
    </div>`}function R(e,t,n){return t==null?``:`<span class="kd-round-chip">${e} ${n==null?`${t}`:`${t} (${n})`}</span>`}function z(e,t){return`<span class="kd-sort-icon${e?` kd-sort-icon--active`:``}" aria-hidden="true">${e?t===`asc`?`↑`:`↓`:`↕`}</span>`}function B(e,t,n){let r=n.column===e,i=n.direction===`asc`?`stigande`:`synkande`,a=r?`Sortert etter ${t}, ${i}. Vel for å snu.`:`Sorter etter ${t}`;return`<button type="button" class="kd-sort-btn${r?` kd-sort-btn--active`:``}" data-sort="${e}" aria-pressed="${r}" aria-label="${a}">${t}${z(r,n.direction)}</button>`}function V(e,n,r,i){let o=e;n!==`alle`&&(o=o.filter(e=>String(T(e.stevne?.dato))===n)),r!==`alle`&&(o=o.filter(e=>String(e.stevne?.stevnetype?.id)===r));let s=o.length,c=`
    ...
    </div>`,u=D(o,i).map(e=>{let n=e.stevne,r=n?.id?`<a href="#/stevne/${n.id}/resultat" class="kd-res-row__name">${a(n.navn??``)}</a>`:`<span class="kd-res-row__name">${a(n?.navn??`–`)}</span>`,i=R(`X-kast`,e.poeng_xkast,e.antall_ring_xkast)+R(`Kongelag`,e.poeng_kongelag,e.antall_ring_kongelag),o=e.plassering==null?`<span class="kd-res-row__pl kd-res-row__pl--empty">–</span>`:`<span class="kd-res-row__pl">${e.plassering}</span>`;return`
