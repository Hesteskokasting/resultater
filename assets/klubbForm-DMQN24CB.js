import{Ft as e,O as t,f as n,fr as r,h as i,k as a,pr as o}from"./index-D8yR97w0.js";import{i as s,o as c,t as l}from"./klubbService-D9_HMteq.js";import{a as u,i as d,r as f,t as p}from"./_formButtons-DFghDa5F.js";async function m(m,h){let{container:g}=m;g.replaceChildren(o());let _=null;if(h){let{data:e,error:n}=await s(h);if(n||!e){g.replaceChildren(r(`Klubb ikkje funne.`));return}if(_=e,!await t()&&!await a(h)){g.replaceChildren(r(`Ingen tilgang til denne klubben.`));return}}else if(!await t()){g.replaceChildren(r(`Ingen tilgang.`));return}let{wrapper:v,headingHtml:y}=d(m);v.innerHTML=`
    ${y}
    <form id="club-form">
