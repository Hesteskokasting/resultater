import{a as e,i as t}from"./authService-BSCiMkAt.js";import{Q as n,Z as r}from"./index-CDZhvbt-.js";import{i,n as a,r as o,t as s}from"./adminForms-BC6ejmsk.js";import{i as c,n as l}from"./klubbService-CPrDwSKB.js";import{t as u}from"./LoadingState-DU0ZcPlb.js";async function d(d,f={}){let p=f.id===void 0?void 0:Number(f.id);if(!p){d.replaceChildren(n(`Manglande ID.`));return}d.replaceChildren(u());let{data:m,error:h}=await l(p);if(h||!m){d.replaceChildren(n(`Klubb ikkje funne.`));return}if(!await t()&&!await e(p)){d.replaceChildren(n(`Ingen tilgang til denne klubben.`));return}d.innerHTML=`
