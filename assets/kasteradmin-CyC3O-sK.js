import{t as e}from"./logError-D5z16FyH.js";import{O as t,St as n,k as r,w as i,xt as a}from"./index-BUGtasR_.js";import{i as o,n as s,r as c,t as l}from"./adminForms-92d8cGdz.js";import{r as u}from"./klubbService-CaXvOdL5.js";import{a as d,l as f,n as p,p as m,s as h,t as g}from"./kasterService-B3gLOC11.js";import{t as _}from"./LoadingState-BWi0wPLz.js";import{t as v}from"./buildDropdownOptions-B4GdhPJZ.js";import{t as y}from"./formNum-DDzUPdUs.js";async function b(b,x={}){let S=x.id===void 0?void 0:Number(x.id);b.replaceChildren(_());let C=[],w=[],T=[];try{let e=await Promise.all([u(),d(),h()]);C=e[0].data,w=e[1].data,T=e[2].data}catch(t){e(`kasteradmin.render`,t),b.replaceChildren(n(`Kunne ikkje laste skjema.`));return}let E=null;if(S){let{data:e,error:i}=await f(S);if(i||!e){b.replaceChildren(n(`Utøvar ikkje funne.`));return}if(E=e,!await t()&&!await r(E.klubbid??void 0)){b.replaceChildren(n(`Ingen tilgang til denne utøvaren.`));return}}let D=S?`Rediger utøvar: ${E?`${a(E.fornavn)} ${a(E.etternavn)}`:``}`:`Ny utøvar`,O=E??{};b.innerHTML=`
