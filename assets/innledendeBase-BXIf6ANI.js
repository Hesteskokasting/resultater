import{C as e,D as t,F as n,G as r,I as i,K as a,L as o,N as s,P as c,S as l,T as u,U as d,W as f,_ as p,a as m,b as h,d as g,f as _,g as v,i as y,j as b,k as x,l as S,m as C,p as w,q as T,s as E,u as D,v as O,x as k,y as A,z as j}from"./index-Zbekm5gX.js";import{t as M}from"./ScoreNumberpad-C-b3sWkY.js";var N=null,P=null,F=null,I=null;function L(){return N||(N=document.createElement(`div`),N.className=`modal`,N.style.display=`none`,N.setAttribute(`role`,`dialog`),N.setAttribute(`aria-modal`,`true`),N.setAttribute(`aria-labelledby`,`pd-title`),N.innerHTML=`
