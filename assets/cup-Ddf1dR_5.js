import{n as e,t}from"./logError-BO7RC_Nh.js";import{A as n,Et as r,It as i,Mt as a,O as o,Pt as s,_ as c,jt as l,k as u,s as d,ut as f}from"./index-DMdVkxcg.js";import{t as p}from"./LoadingState-C6NB62Ct.js";import{n as m}from"./kastemetode-BcDmg9po.js";import{C as h,F as g,N as _,O as v,T as y,a as b,c as x,i as S,t as C,v as w,y as T}from"./kampService-CVWol_ro.js";import{n as E}from"./navigation-CLFdaq7c.js";import{A as D,C as O,D as k,O as A,S as j,T as ee,_ as M,b as te,c as ne,g as re,h as N,k as ie,s as P,u as ae,v as oe,w as se,y as ce}from"./omgangValidation-mUWHqhOv.js";import{l as F}from"./xkastKongelagService-B-Jkw8nA.js";import{n as I}from"./ScoreNumberpad-BqTXeh5F.js";import{n as L,t as R}from"./scoreEditor-CBW4WmnB.js";function z(e){let t=[...e];for(let e=t.length-1;e>0;e--){let n=Math.floor(Math.random()*(e+1));[t[e],t[n]]=[t[n],t[e]]}return t}function B(e){return e===2||e===4?!0:e<2?!1:e%3==0?B(Math.floor(e/3)*2):e%2==0&&B(e/2)}function V(e){return e%3==0?{c3:e/3,c2:0}:e%2==0?{c3:0,c2:e/2}:{c3:0,c2:0}}function H(e){if(e<2)return[];let t=[],n=Math.floor(e/2);for(let r=e%3;r<=n&&r<=3&&t.filter(e=>e.c2===0).length<2;r+=3){let n=(e-r)/3;if(n<1)break;B(r+2*n)&&t.push({walkovers:r,c3:n,c2:0})}for(let r=e%2;r<=n&&r<=3&&t.filter(e=>e.c3===0).length<2;r+=2){let n=(e-r)/2;if(n<1)break;let i=r+n;!t.some(e=>e.walkovers===r&&e.c3===0&&e.c2===n)&&B(i)&&t.push({walkovers:r,c3:0,c2:n})}return t.sort((e,t)=>e.walkovers-t.walkovers||t.c3-e.c3),t}function U(e){return e===2||H(e).length>0}function le(e){let t=Math.ceil(e*.5),n=Math.round(e*.8),r=[];for(let i=n;i>=t;i--){let t=e-i;t>=2&&U(i)&&U(t)&&r.push({nA:i,nB:t})}return r}function ue(e,{runde1:t=null,walkovers1:n=null}={}){let r=[],i=e,a=1,o=!0;for(;i>2;){let e,s,c;if(o){let r=t;!r&&n!==null&&(r={walkovers:n,c3:Math.floor((i-n)/3),c2:0}),r||=H(i)[0]??{walkovers:i%3,c3:Math.floor(i/3),c2:0},c=r.walkovers,e=r.c3,s=r.c2,o=!1}else{let t=V(i);e=t.c3,s=t.c2,c=0}let l=e*2+s+c;r.push({runde:a,players:i,lanes:e+s,threePlayers:e>0,walkovers:c,advancing:l}),i=l,a++}return r}function W(e,{medSeeding:t=!0,isRunde1:n=!1,walkoverTall:r=null,runde1Oppsett:i=null,shuffleFn:a}={}){let o=a??z,s=[],c=[...e];if(n){let e=i?.walkovers??r??c.length%3;if(e>0){let t=c.slice(0,e);c=c.slice(e);for(let e of t)s.push({players:[e.kasterid],isWalkover:!0,isThreePlayers:!1})}}let l=c.length,u,d;if(i&&n)u=i.c3,d=i.c2;else if(n)u=Math.floor(l/3),d=0;else{let e=V(l);u=e.c3,d=e.c2}let f=u+d;if(t&&f>0){let e=o(c.slice(0,f)),t=o(c.slice(f,2*f)),n=o(c.slice(2*f)),r=0;for(let i=0;i<f;i++){let a=i<u,o=[e[i],t[i]].filter(e=>e!=null),c=a?n[r]:void 0;c&&(o.push(c),r++),s.push({players:o.map(e=>e.kasterid),isWalkover:!1,isThreePlayers:a})}}else{let e=o(c),t=0;for(let n=0;n<u;n++)s.push({players:e.slice(t,t+3).map(e=>e.kasterid),isWalkover:!1,isThreePlayers:!0}),t+=3;for(let n=0;n<d;n++)s.push({players:e.slice(t,t+2).map(e=>e.kasterid),isWalkover:!1,isThreePlayers:!1}),t+=2}return s}function G(e,{showPlayerList:t=!0,initNa:n=null,initFormat:r=null}={}){let i=typeof e==`number`?e:e.length,a=typeof e==`number`?[]:e.map((e,t)=>({...e,cupPlassering:t+1})),o=le(i),s=n===i?i:n!=null&&o.some(e=>e.nA===n)?n:o[0]?.nA??i,c=i-s,l=o.filter(e=>H(e.nA).some(e=>e.c3>0)),u=o.filter(e=>!H(e.nA).some(e=>e.c3>0)),d=H(i).length>0,f=(e,t)=>e.map((e,r)=>{let a=e.nA===s&&n!==i,o=t+r;return`
  ...
  `}function K(e,t,n=0,r=0){let i=e.slice(0,t),a=e.slice(t),o=e.some(e=>e.poeng_xkast!=null);function s(e,t=0){return e.map((e,n)=>{let r=n<t,i=o?e.antall_ring_xkast??0:e.kamp_poeng??0,a=o?e.poeng_xkast??0:e.score_poeng??0;return`
    ...
    </div>`}function de(e){let t=e.c3>0?3:2;return`${e.walkovers} walkover - ${t} deltakere per bane`}function fe(e,t,n,r=null){let i=H(t);return i.length<=1?``:`<div class="d-flex flex-column align-items-start gap-1 mb-2">${i.map((e,t)=>{let i=`${n}-${t}`,a=JSON.stringify(e),o=r?e.walkovers===r.walkovers&&e.c3===r.c3&&e.c2===r.c2:t===0,s=e.c3>0?`btn-outline-success`:`btn-outline-warning`;return`
      <input type="radio" class="btn-check" name="${n}" id="${i}"
        value='${a}' data-oppsett='${a}' autocomplete="off" ${o?`checked`:``}>
      <label class="btn btn-sm ${s}" for="${i}">${de(e)}</label>`}).join(``)}</div>`}function q(e,t,n){return`<div id="structure-${n}">
  ...
  </div>`}function J(e,t,n,r){let i=n.slice(-1),a=fe(e,t,n,r);return`
    <div class="card">
      <div class="card-body">
    ...
    `,o.querySelector(`#avbryt-tre-btn`).addEventListener(`click`,()=>o.remove()),o.querySelectorAll(`[data-kasterid]`).forEach(e=>{e.addEventListener(`click`,()=>{let t=Number(e.dataset.kasterid),n=a.indexOf(t);n===-1?a.length<2&&a.push(t):a.splice(n,1),s()})}),o.querySelector(`#bekreft-tre-btn`)?.addEventListener(`click`,async()=>{if(a.length!==2)return;let i=t.find(e=>!a.includes(e.rep.kasterid))??null,s=a.map(e=>t.find(t=>t.rep.kasterid===e)).filter(e=>e!=null).map(e=>e.members.map(e=>e.kasterid)),c=t.flatMap(e=>e.members.map(e=>e.kasterid));o.remove();let{error:l}=await C({kampId:e.id,stevneId:n,roundNumber:e.runde_nummer,roundName:e.runde_navn,allThrowerIds:c,eliminatedIds:i?.members.map(e=>e.kasterid)??[],advancingSides:s});if(l){u(`DB-feil ved bekreft`,`error`);return}await r()})}s()}function Se(e){return typeof e!=`object`||!e||Array.isArray(e)?null:e}function Ce(e){return e.map(e=>({er_bekreftet:e.er_bekreftet,er_walkover:e.er_walkover,runde_nummer:e.runde_nummer,bane_nummer:e.bane_nummer,spelarar:we(e.spelarar)}))}function we(e){return e.map(e=>({kasterid:e.kasterid??0,kamp_poeng:e.kamp_poeng??0,score_poeng:e.score_poeng??0,antall_ringer:e.antall_ringer,omgangar:e.omgangar,kaster:e.kaster}))}function Te(e){let o=null,s=null,l=!1,d=new Set,m=new Set;async function h(e,{id:t,isAdmin:n=!1},r=null){s=r,l=n,o&&=(await E(o),null),e.replaceChildren(p(`Laster…`)),await g(e,t)}async function g(o,p){try{let[{data:t},{data:h},{data:v},{data:y},{count:x}]=await Promise.all([f(p),b(p),ae(p),ne([`A`,`B`]),r(p)]);if(!t){o.replaceChildren(i(`Stevne ikkje funne.`));return}m.clear();for(let e of h)for(let t of e.spelarar)m.add(t.id);let S=v.filter(e=>e.kasterid!=null),C=h.filter(e=>e.fase===`innledende`),w=h.filter(e=>e.fase===`avsluttende`),T={},E={},D=new Map;for(let e of S)e.startnummer!=null&&(T[e.kasterid]=e.startnummer,D.set(e.startnummer,(D.get(e.startnummer)??0)+1)),e.posisjon!=null&&(E[e.kasterid]=e.posisjon);let O=[...D.values()].some(e=>e>1),j={};for(let e of h)for(let t of e.spelarar)t.kasterid&&t.kaster&&!j[t.kasterid]&&(j[t.kasterid]=`${t.kaster.fornavn} ${t.kaster.etternavn}`);for(let e of S)e.kaster&&!j[e.kasterid]&&(j[e.kasterid]=`${e.kaster.fornavn} ${e.kaster.etternavn}`);let M=Ce(C),N=te(M,S,j,T,E),P=C.length>0&&C.every(e=>e.er_bekreftet),F=w.length>0,I=(C.length>0||F)&&C.every(e=>e.er_bekreftet)&&w.every(e=>e.er_bekreftet),L=S.some(e=>e.gruppe!=null),R=Object.fromEntries(y.map(e=>[e.navn,e.id])),z=Se(t.runde1_format),B=x??0;if(t.kategori?.erlagbasert){let{data:e}=await c(p);B=e.length}let V={container:o,stevneid:p,stevne:t,standings:N,startNumberMap:T,positionMap:E,isTeam:O,nameMap:j,initialMatches:C,finalMatches:w,results:S,isAdmin:l,hasGroupAssignment:L,allInitialConfirmed:P,hasFinalMatches:F,round1Format:z,unitCount:B,groupNameMap:R,reload:()=>g(o,p)};l&&s&&(s.innerHTML=ee(t,{allMatchesConfirmed:I,hasFinalMatches:F,hasGroupAssignment:L,hasPreconfiguredFormat:z!=null&&t.stevne_fase!==`avsluttende`}));let H=se(o);if(L){let t=A(N,M,T,{tableId:`standing-final`,hasGroups:!0,hasElimination:!0,positionMap:E,unitLabel:O?`par`:`spelarar`});o.innerHTML=k(e.renderMatchesHtml(V),t),oe(o,`standing-final`,d),ce(o),H===`standing`&&ie(o,`standing`),e.bindMatchEvents(o,V),_(o,p)}else o.innerHTML=e.renderSetupHtml(V);s?.querySelector(`#complete-tournament-btn`)?.addEventListener(`click`,async()=>{if(!await n({title:`Fullfør turnering`,message:`Vil du fullføre turneringa? Dette kan ikkje angrast.`,danger:!0}))return;let{error:e}=await re(p,[...N.filter(e=>e.gruppe?.navn===`A`),...N.filter(e=>e.gruppe?.navn===`B`),...N.filter(e=>e.gruppe?.navn!==`A`&&e.gruppe?.navn!==`B`)]);if(e){u(`Feil ved lagring av plasseringar`,`error`);return}let{error:t}=await a(p);if(t){u(`Feil ved fullføring av turnering`,`error`);return}await g(o,p)}),e.bindHeaderEvents(s,V)}catch(e){t(`avsluttendeBase.loadAndRender`,e),o.replaceChildren(i(`Kunne ikkje laste avsluttande fase.`))}}function _(t,n){if(o)return;let r=O(n,[`avsluttende`],t,g,()=>{o&&=(E(o),null)});o=T(n,e.channelName(n),r,e=>m.has(e))}return h}function Ee(e,t,n){return v(e.spelarar.filter(e=>e.kasterid!=null),t,n)}function $(e,t){return g(e,t.er_bekreftet)}var De=Te({channelName:e=>`stevne-avsl-cup-${e}`,renderMatchesHtml:e=>{let{finalMatches:t,standings:n,startNumberMap:r,positionMap:i,isTeam:a,isAdmin:o}=e;return`<div class="d-flex gap-3 flex-wrap">${[...new Set(n.map(e=>e.gruppe?.navn).filter(e=>e!=null))].sort().map(e=>{let s=t.filter(t=>t.gruppe_navn===e),c=n.filter(t=>t.gruppe?.navn===e),l=c.filter(e=>e.runde_eliminert==null).length,u=c.length,d=s.length?Math.max(...s.map(e=>e.runde_nummer)):0,f=s.filter(e=>e.runde_nummer===d),p=f.length>0&&f.every(e=>e.er_bekreftet||e.er_walkover),m=s.some(e=>e.runde_navn===`Semifinale`),h=o&&(s.length===0||p)&&l>1&&!m,g=f.length>0&&f.every(e=>e.runde_navn===`Semifinale`),_=s.some(e=>e.runde_navn===`Finale`);return ke(e,s,l,u,d,h,o&&g&&p&&!_,r,i,a?`par`:`spelarar`,o)}).join(``)}</div>`},bindMatchEvents:(e,t)=>{!t.isAdmin&&t.finalMatches.length===0||Fe(e,t.stevneid,t.finalMatches,t.isAdmin,t.reload,t.startNumberMap,t.positionMap)},renderSetupHtml:e=>{let{stevne:t,isAdmin:n,round1Format:r,unitCount:i,standings:a}=e,o=r?.nA??null;if(t.stevne_fase===`avsluttende`)return n?G(a,{showPlayerList:!0,initNa:o,initFormat:r}):`<p class="text-muted fst-italic">Gruppefordeling er ikkje klar enno.</p>`;if(!n)return``;if(i<2)return`<p class="text-muted fst-italic">${t.kategori?.erlagbasert?`Minst 2 par må vere oppretta før gruppefordelinga kan setjast.`:`Minst 2 spelarar må vere påmelde før gruppefordelinga kan setjast.`}</p>`;let s=a.length>0;return G(s?a:i,{showPlayerList:s,initNa:o,initFormat:r})},bindHeaderEvents:(e,r)=>{let{container:i,stevneid:a,stevne:c,standings:d,results:f,round1Format:p,allInitialConfirmed:h,hasGroupAssignment:g,groupNameMap:_,reload:v}=r;if(e?.querySelector(`#start-final-btn`)?.addEventListener(`click`,async()=>{if(!h)return;let{error:e}=await s(a,`avsluttende`);if(e){u(`Feil ved oppstart av avsluttande fase`,`error`);return}if(p?.nA!=null){let e=p.nA,t=_.A??null,n=_.B??null,r=Oe(d,f,e,t,n),{error:i}=await N(a,r);if(i){u(`Feil ved lagring av gruppefordeling: `+o(i),`error`);return}}await v()}),!g){let e=parseInt(i.querySelector(`#group-assignment-wrapper`)?.dataset.n??`0`)||d.length;function t(e,t){let n=i.querySelector(`input[name="${e}"]:checked`);if(n?.dataset.oppsett)try{return JSON.parse(n.dataset.oppsett)}catch{}return H(t)[0]??null}function n(e,t,n){let r=i.querySelector(`#group-preview`);r&&(r.innerHTML=K(d.map((e,t)=>({...e,cupPlassering:t+1})),e,t?.walkovers??0,n?.walkovers??0))}let r=i.querySelector(`#group-panels`);r&&r.addEventListener(`change`,r=>{let a=r.target;if(!a.matches(`input[name^="round1-format"]`))return;let o=parseInt(i.querySelector(`input[name="group-split"]:checked`)?.value??String(e)),s=e-o,c=t(`round1-format-a`,o),l=t(`round1-format-b`,s);if(a.name===`round1-format-a`){let e=i.querySelector(`#structure-a`);e&&(e.outerHTML=q(o,c,`a`))}else{let e=i.querySelector(`#structure-b`);e&&(e.outerHTML=q(s,l,`b`))}n(o,c,l)}),i.querySelectorAll(`input[name="group-split"]`).forEach(t=>{t.addEventListener(`change`,()=>{let i=parseInt(t.value),a=e-i,o=H(i)[0]??null,s=a>=2?H(a)[0]??null:null;r&&(r.innerHTML=`<div id="group-panel-a" class="final-group-col">
                ${J(`Gruppe A`,i,`round1-format-a`,o)}
              </div>`+(a>=2?`<div id="group-panel-b" class="final-group-col">
                ${J(`Gruppe B`,a,`round1-format-b`,s)}
              </div>`:``)),n(i,o,s)})}),i.querySelector(`#confirm-group-btn`)?.addEventListener(`click`,async()=>{let n=i.querySelector(`input[name="group-split"]:checked`);if(!n)return;let r=parseInt(n.value),p=e-r,h=t(`round1-format-a`,r),g=p>=2?t(`round1-format-b`,p):null,{error:y}=await l(a,{A:h,B:g,nA:r});if(y){u(`Feil ved lagring av format: `+o(y),`error`);return}let b=c.stevne_fase;if(b!==`avsluttende`&&m(c.kastemetodeInnl?.navn??``)){let{data:e}=await F(a);if(!e){u(`Fullfør den innleiande fasen før cupen kan startast`,`error`);return}let{error:t}=await s(a,`avsluttende`);if(t){u(`Feil ved oppstart av avsluttande fase: `+o(t),`error`);return}b=`avsluttende`}if(b===`avsluttende`){let e=_.A??null,t=_.B??null,n=Oe(d,f,r,e,t),{error:i}=await N(a,n);if(i){u(`Feil ved lagring av gruppefordeling: `+o(i),`error`);return}}u(`Gruppefordeling lagra`,`success`),await v()})}e?.querySelector(`#edit-group-assignment-btn`)?.addEventListener(`click`,async()=>{await n({title:`Tilbakestill gruppeinndeling`,message:`Gruppefordeling og format vert fjerna.`,danger:!0})&&(await Promise.all([P(a),l(a,null)]),await v())}),g&&(i.querySelectorAll(`[data-generate-group]`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.dataset.generateGroup??``,n=parseInt(e.dataset.runde??`1`),r=d.filter(e=>e.gruppe?.navn===t);be(a,t,r,n,p,v)})}),i.querySelectorAll(`[data-generate-finale-group]`).forEach(e=>{e.addEventListener(`click`,async()=>{let n=e.dataset.generateFinaleGroup??``;e.disabled=!0,e.textContent=`Genererer…`;try{await ye(a,n),await v()}catch(n){t(`cup:genererFinale`,n),u(`Feil ved generering av finale`,`error`),e.disabled=!1,e.textContent=`Generer finale`}})}))}});function Oe(e,t,n,r,i){return e.flatMap((e,a)=>{let o=a<n?r:i??r,s=e.startnummer==null?[]:t.filter(t=>t.startnummer===e.startnummer).map(e=>e.kasterid);return(s.length?s:[e.kasterid]).map(e=>({kasterid:e,gruppeid:o}))})}function ke(e,t,n,r,i,a,o,s,c,l,u=!0){let f=new Map;for(let e of t)f.has(e.runde_nummer)||f.set(e.runde_nummer,[]),f.get(e.runde_nummer).push(e);let p=[...f.entries()].reverse().map(([e,t])=>{let n=t[0]?.runde_navn??`Runde ${e}`,r=t.filter(e=>!e.er_walkover);return r.length?`
      <h6 class="fw-bold text-center mb-1">${d(n)}</h6>
      <div class="d-flex flex-wrap gap-2 mb-2">
        ${r.map(e=>Pe(e,s,c,u)).join(``)}
    ...
    <div class="final-group-col">
      ...
      ${g}
      ${p}
    </div>`}function Ae(e,t,n,r){let i=$(t,e),a=i>0||r.isConfirmed&&!r.isThreeSides||r.hasRounds?i:`—`,o=t.rep.kamp_plassering,s=e.er_bekreftet&&o!=null&&o>=n,c=e.er_bekreftet&&o!=null&&o<n,l=s?`match-eliminated`:c?`match-advancing`:``,u=`text-center fw-semibold final-score-cell${r.canEditScore?` score-editable`:``}`,d=r.canEditScore?` data-endre-score="${e.id}"`:``;return`<tr${l?` class="${l}"`:``}>
    <td>${D(t,!1)}</td>
    <td class="${u}"${d}>${a}</td>
  </tr>`}function je(e,t,n){return e.er_walkover?`<tr>
        <td colspan="2">${D(t[0]??null,!1)} <span class="badge bg-secondary">Walkover</span></td>
      </tr>`:t.map(r=>Ae(e,r,t.length,n)).join(``)}function Me(e,t,n,r){if(e.er_tre_spelarar)return{css:r?`btn-secondary`:`btn-outline-secondary`,text:r?`Endre plassering`:`Sett plassering`,disabled:!1,extraCss:``};let i=j(e,we(t.map(e=>e.rep)),n);return{css:r?`btn-secondary`:i?`btn-success`:`btn-outline-secondary`,text:r?`Bekreftet`:`Bekreft`,disabled:r||!i,extraCss:` btn-confirm`}}function Ne(e,t,n){return`<tr>
          ...
          </tr>`}function Pe(e,t,n,r=!0){let i=Ee(e,t,n),a=e.er_bekreftet||e.er_walkover,o=e.spelarar.some(e=>(e.omgangar?.length??0)>0),s={isConfirmed:a,hasRounds:o,canEditScore:r&&e.er_bekreftet&&!e.er_tre_spelarar&&!o,isThreeSides:e.er_tre_spelarar},c=r?Ne(e,a,Me(e,i,o,a)):``;return`
    ...
    </div>`}function Fe(e,n,r,i,a,o,s){M(e);for(let c of r){let r=Ee(c,o,s),l=r[0]??null,d=r[1]??null,f=l?.rep??null,p=d?.rep??null,m=D(l,!1),g=D(d,!1),_=r.flatMap(e=>e.members.map(e=>e.id)),v=async(e,n)=>{let r=[];f?.id&&r.push(h(f.id,e)),p?.id&&r.push(h(p.id,n));for(let e of[l,d])for(let t of e?.members.slice(1)??[])r.push(h(t.id,0));try{return(await Promise.all(r)).find(e=>e.error)??null}catch(e){return t(`cup:writeSideScore`,e),{error:e}}};if(e.querySelector(`#plus-${c.id}`)?.addEventListener(`click`,()=>{R({side1Name:m,side2Name:g,currentS1:$(l,c),currentS2:$(d,c),playerIds:_,hasRounds:c.spelarar.some(e=>(e.omgangar?.length??0)>0),logPrefix:`cup`,onSave:v,onSaved:a})}),e.querySelector(`#bekrft-${c.id}`)?.addEventListener(`click`,async e=>{if(c.er_tre_spelarar)xe(c,r,n,a);else{let t=e.currentTarget;t.disabled=!0,t.textContent=`Lagrer…`;try{await Ie(n,c,r,a)||(t.disabled=!1,t.textContent=`Bekreft`)}catch{t.disabled=!1,t.textContent=`Bekreft`}}}),i&&c.er_bekreftet&&!c.er_tre_spelarar){let t=r.flatMap(e=>e.members.map(e=>e.kasterid)),i=()=>{I([{name:m,score:$(l,c)},{name:g,score:$(d,c)}],async([e=0,r=0])=>{if(_.length){let{error:e}=await S(_);if(e){u(`DB-feil ved sletting av omgangar`,`error`);return}}if(await v(e,r)){u(`DB-feil ved oppdatering av score`,`error`);return}let i=e>=r?l:d,o=e>=r?d:l,s=i?.members.map(e=>e.kasterid)??[],f=o?.members.map(e=>e.kasterid)??[],p=[...s.map(e=>({kasterid:e,plassering:1})),...f.map(e=>({kasterid:e,plassering:2}))],{error:m}=await w(c.id,p);if(m){u(`DB-feil ved oppdatering av plassering`,`error`);return}await y({stevneId:n,roundNumber:c.runde_nummer,roundName:c.runde_navn,allThrowerIds:t,newWinnerIds:s,newLoserIds:f}),await a()})};e.querySelectorAll(`[data-endre-score="${c.id}"]`).forEach(e=>e.addEventListener(`click`,i))}}}async function Ie(e,t,r,i){let a=r[0]??null,o=r[1]??null,{data:s}=await x(t.id),c=e=>e?.members.reduce((e,t)=>e+_(s.find(e=>e.id===t.id)??t,!1),0)??0,l=c(a),d=c(o);if(l===0&&d===0&&!await n({title:`Ingen score registrert`,message:`Vil du bekrefte kampen likevel?`}))return!1;let f=l>=d?a:o,p=l>=d?o:a,m=r.flatMap(e=>e.members.map(e=>e.kasterid)),{error:h}=await C({kampId:t.id,stevneId:e,roundNumber:t.runde_nummer,roundName:t.runde_navn,allThrowerIds:m,eliminatedIds:p?.members.map(e=>e.kasterid)??[],advancingSides:f?[f.members.map(e=>e.kasterid)]:[]});return h?(u(`DB-feil ved bekreft`,`error`),!1):(await i(),!0)}export{De as render};