import{t as e}from"./escHtml-CfOHO0aD.js";import{D as t,Mt as n,O as r,m as i,mr as a,pr as o}from"./index-36jj8hv1.js";import{i as s,o as c,t as l}from"./klubbService-3zTTaX6v.js";import{a as u,i as d,r as f,t as p}from"./_formButtons-CSUIxA5b.js";async function m(m,h){let{container:g}=m;g.replaceChildren(a());let _=null;if(h){let{data:e,error:n}=await s(h);if(n||!e){g.replaceChildren(o(`Klubb ikkje funne.`));return}if(_=e,!await t()&&!await r(h)){g.replaceChildren(o(`Ingen tilgang til denne klubben.`));return}}else if(!await t()){g.replaceChildren(o(`Ingen tilgang.`));return}let{wrapper:v,headingHtml:y}=d(m);v.innerHTML=`
    ${y}
    <form id="club-form">
