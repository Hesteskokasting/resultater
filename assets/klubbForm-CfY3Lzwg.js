import{Nt as e,O as t,dr as n,f as r,h as i,k as a,ur as o}from"./index-BvGIsWRi.js";import{i as s,o as c,t as l}from"./klubbService-pPakrKDt.js";import{a as u,i as d,r as f,t as p}from"./_formButtons-DvWb_msY.js";async function m(m,h){let{container:g}=m;g.replaceChildren(n());let _=null;if(h){let{data:e,error:n}=await s(h);if(n||!e){g.replaceChildren(o(`Klubb ikkje funne.`));return}if(_=e,!await t()&&!await a(h)){g.replaceChildren(o(`Ingen tilgang til denne klubben.`));return}}else if(!await t()){g.replaceChildren(o(`Ingen tilgang.`));return}let{wrapper:v,headingHtml:y}=d(m);v.innerHTML=`
    ${y}
    <form id="club-form">
