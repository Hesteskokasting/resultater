import{B as e,D as t,G as n,L as r,V as i,W as a,b as o,nt as s,t as c}from"./index-Da1LWJ6B.js";import{t as l}from"./LoadingState-RVZNML7E.js";import{t as u}from"./ConfirmDialog-3D8QuJxP.js";import{r as d,s as f}from"./kamp-Bpd8LcU6.js";import{C as p,S as m,a as h,b as g,f as _,n as v,s as y,x as b,y as x}from"./kampService-B2KGSocz.js";import{t as S}from"./realtime-DWfJe3XN.js";import{a as C,i as w,n as T,o as E,r as D,s as O}from"./kampGenereringCupService-Bfn1jJzj.js";import{l as k}from"./pameldingService-BXBmx10T.js";import{S as A,_ as j,b as M,c as N,d as ee,f as P,g as F,h as I,l as L,n as R,p as te,r as ne,t as z,u as B,v as V,x as H}from"./resultatService-BQxi6Idy.js";import{n as U,t as W}from"./LivePill-BTyzkGe4.js";function G(e,{visSpelarliste:t=!0,initNa:n=null,initFormat:r=null}={}){let i=typeof e==`number`?e:e.length,a=typeof e==`number`?[]:e.map((e,t)=>({...e,cupPlassering:t+1})),o=E(i),s=n===i?i:n!=null&&o.some(e=>e.nA===n)?n:o[0]?.nA??i,c=i-s,l=o.filter(e=>O(e.nA).some(e=>e.c3>0)),u=o.filter(e=>!O(e.nA).some(e=>e.c3>0)),d=O(i).length>0,f=(e,t)=>e.map((e,r)=>{let a=e.nA===s&&n!==i,o=t+r;return`
