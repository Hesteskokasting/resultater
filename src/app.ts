...
const routes: Route[] = [
  ...
  },
  {
    ...
    page: authGuard(
      "bruker",
      lazy(() => import("./pages/minside")),
    ),
    params: (m) => ({ tab: m[1] ?? "kampar" }),
    title: "Min side",
  },
  {
    pattern: /^\/admin(?:\/([^/]*))?$/,
  ...
  },
  {
    ...
    page: authGuard(
      "klubbadmin",
      lazy(() => import("./admin/stevneadmin")),
    ),
    params: () => ({}),
    title: "Nytt stevne",
  },
  {
    pattern: /^\/stevne\/(\d+)\/rediger$/,
    page: authGuard(
      "klubbadmin",
      lazy(() => import("./admin/stevneadmin")),
    ),
    params: (m) => ({ id: Number(m[1]) }),
    title: "Rediger stevne",
  },
  {
    pattern: /^\/kamp\/(\d+)$/,
    page: lazy(() => import("./pages/kamp")),
    params: (m) => ({ id: Number(m[1]) }),
  },
  {
    pattern: /^\/stevne\/(\d+)\/pamelding$/,
    page: lazy(() => import("./pages/pamelding")),
    params: (m) => ({ id: m[1] }),
  },
  {
    pattern: /^\/stevne\/(\d+)(?:\/([^/]*))?$/,
    page: lazy(() => import("./pages/stevne")),
    params: (m) => ({ id: Number(m[1]), tab: m[2] ?? "info" }),
  },
  {
    pattern: /^\/kaster\/ny$/,
    page: authGuard(
      "klubbadmin",
      lazy(() => import("./admin/kasteradmin")),
    ),
    params: () => ({}),
    title: "Ny utøvar",
  },
  {
    pattern: /^\/kaster\/(\d+)\/admin$/,
    page: authGuard(
      "klubbadmin",
      lazy(() => import("./admin/kasteradmin")),
    ),
  ...
  {
    pattern: /^\/norgescupen$/,
    page: lazy(() => import("./pages/norgescupen")),
    params: () => ({}),
    title: "Norgescupen",
  },
  {
    pattern: /^\/norgesranking$/,
    page: lazy(() => import("./pages/norgesranking")),
    params: () => ({}),
    title: "Norgesranking",
  },
  {
    pattern: /^\/rekorder$/,
    page: lazy(() => import("./pages/rekorder")),
    params: () => ({}),
    title: "Rekorder",
  },
  {
    pattern: /^\/nmvinnere$/,
    page: lazy(() => import("./pages/nmvinnere")),
    params: () => ({}),
    title: "NM-vinnere",
  },
  {
    pattern: /^\/kastere\/(\d+)(-[^/]*)?$/,
    page: lazy(() => import("./pages/kastere")),
    params: (m) => ({ id: m[1] }),
  },
  {
    pattern: /^\/kastere$/,
  ...
  {
    pattern: /^\/klubber\/(\d+)(-[^/]*)?$/,
    page: lazy(() => import("./pages/klubber")),
    params: (m) => ({ id: m[1] }),
  },
  {
    pattern: /^\/klubber$/,
...
document.addEventListener("authStateChanged", (e) => {
  const { event, intentional, hadSession } = (
