export interface SearchState { searchText: string }
...
export function createSearchInput({ placeholder = 'Søk...', variant = 'filter', slot, state, onInput }: SearchInputProps = {}): HTMLInputElement {
